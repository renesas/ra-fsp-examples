...
*       Objects
*/
#define ID_IMAGE_BRG         (GUI_ID_USER + 0)
#define ID_TEXT_APP_EVENT    (GUI_ID_USER + 1)
#define ID_BUTTON_BACK       (GUI_ID_USER + 2)
#define ID_TEXT_0GO_BACK     (GUI_ID_USER + 3)
#define ID_WINDOW_CONTROL    (GUI_ID_USER + 4)
#define ID_BOX_CONTROL       (GUI_ID_USER + 5)
#define ID_SLIDER_BACKLIGHT  (GUI_ID_USER + 6)
#define ID_SWITCH_DARKMODE   (GUI_ID_USER + 7)
#define ID_TEXT_TEXT_COLOR   (GUI_ID_USER + 8)
#define ID_TEXT_BACKLIGHT    (GUI_ID_USER + 9)
#define ID_TEXT_DARKMODE     (GUI_ID_USER + 10)
#define ID_ROTARY_TEXT_COLOR (GUI_ID_USER + 11)
...
void ID_SCREEN_LOG__WM_NOTIFICATION_VALUE_CHANGED_0                                     (APPW_ACTION_ITEM * pAction, WM_HWIN hScreen, WM_MESSAGE * pMsg, int * pResult);
