 ...
 * Macro definitions
 **********************************************************************************************************************/
#define LED2_ON                                 (R_PORT3->PCNTR3_b.POSR = (1 << 3))
#define LED2_OFF                                (R_PORT3->PCNTR3_b.PORR = (1 << 3))
...
static const uint8_t *p_encryption_key = (uint8_t*)(BSP_PARTITION_DOTF_KEY_CPU1_S_START);

uint8_t encryption_key[ENCRYPTION_KEY_LENGTH] BSP_ALIGN_VARIABLE(4) = {RESET_VALUE};
const uint32_t encryption_iv[] BSP_ALIGN_VARIABLE(4) = {0x00000000, 0x00000000, 0x00000000, 0x09000400};

void app_main(void)
{
    fsp_err_t err = FSP_SUCCESS;

    memcpy(encryption_key, (void*)p_encryption_key, ENCRYPTION_KEY_LENGTH);
