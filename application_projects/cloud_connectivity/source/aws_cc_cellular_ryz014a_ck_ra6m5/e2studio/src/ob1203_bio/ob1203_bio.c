 ...
 * @retval              None
 ***********************************************************************************************************************/
void ob1203_comms_i2c_callback(rm_ob1203_callback_args_t *p_args) // @suppress("8.2a Function declaration")
{
 ...
 * @retval              None
 ***********************************************************************************************************************/
void ob1203_irq_callback(rm_ob1203_callback_args_t *p_args) // @suppress("8.2a Function declaration")
{
#if OB1203_BIO_IRQ_ENABLE
