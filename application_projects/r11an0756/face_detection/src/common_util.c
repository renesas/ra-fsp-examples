...
void handle_error (face_det_err_t err)
{
	...
	switch (err)
	{
	   ...
	   case FACE_DET_APP_GLCDC_LAYER_CHANGE:
	   {
		   /*Suggest valid the input and output buffer.  */
	   ...
	   case FACE_DET_APP_GRAPHICS_INIT:
	   {
		   /*Suggest valid the input and output buffer.  */
	   ...
	   case FACE_DET_APP_IIC_MASTER_OPEN:
	   {
		   /*Suggest valid the input and output buffer.  */
	   ...
	   case FACE_DET_APP_WRITE_OV3640_REG:
	   {
		   /*Suggest valid the input and output buffer.  */
	   ...
	   case FACE_DET_APP_WRITE_SENSOR_ARRAY:
	   {
		   /*Suggest valid the input and output buffer.  */
	   ...
	   case FACE_DET_APP_JLINK_CONSOLE_OPEN:
	   {
		   /*Suggest valid the input and output buffer.  */
	   ...
	   case FACE_DET_APP_IIC_MASTER_WRITE:
	   {
		   /*Suggest valid the input and output buffer.  */
	   ...
	   case FACE_DET_APP_IIC_MASTER_READ:
	   {
		   /*Suggest valid the input and output buffer.  */
	   ...
	   case FACE_DET_APP_JLINK_SONSOLE_WRITE:
	   {
		   /*Suggest valid the input and output buffer.  */
	   ...
	   case FACE_DET_APP_JLINK_SONSOLE_READ:
	   {
		   /*Suggest valid the input and output buffer.  */
