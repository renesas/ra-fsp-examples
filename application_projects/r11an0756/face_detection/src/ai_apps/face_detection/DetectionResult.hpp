...
namespace object_detection {
    ...
    public:
         ...
         * @param[in]   x0              The x coordinate of the inference result bounding box bottom right corner
         * @param[in]   y0              The y coordinate of the inference result bounding box bottom right corner
