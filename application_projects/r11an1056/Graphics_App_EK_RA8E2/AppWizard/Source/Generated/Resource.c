...
static GUI_CONST_STORAGE APPW_ANIM_ITEM _aID_ANIM_CLOUDY_MOTION_Items[] = {
  { ANIM_LINEAR,
    { 0x0000, 0x2aaa },
    { { 0x18000000, -245, ATOM_SCREEN_GEO, ATOM_DETAIL_X0 },
      { 0x18000000, 345, ATOM_SCREEN_GEO, ATOM_DETAIL_X0 },
      { 0x1800084c, 0, ATOM_OBJECT_GEO, ATOM_DETAIL_X0 }
    }
  }
};
...
*/
GUI_CONST_STORAGE APPW_ANIM_DATA ID_ANIM_CLOUDY_MOTION_Data = { ID_ANIM_CLOUDY_MOTION, 15000, 0, -1, GUI_COUNTOF(_aID_ANIM_CLOUDY_MOTION_Items), _aID_ANIM_CLOUDY_MOTION_Items };
