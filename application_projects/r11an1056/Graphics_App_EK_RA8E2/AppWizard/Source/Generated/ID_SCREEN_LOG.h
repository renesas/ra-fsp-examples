...
*       Objects
*/
#define ID_IMAGE_BGD                (GUI_ID_USER + 1)
#define ID_BUTTON_LOGO_BACK         (GUI_ID_USER + 2)
#define ID_TEXT_GO_BACK             (GUI_ID_USER + 3)
#define ID_TEXT_APP_EVENT           (GUI_ID_USER + 4)
#define ID_BUTTON_APP_EVENT_OUTLINE (GUI_ID_USER + 13)
...
#define ID_TEXT_TEXT_COLOR          (GUI_ID_USER + 11)
...
void ID_SCREEN_LOG__WM_NOTIFICATION_VALUE_CHANGED_TEXT_COLOR                            (APPW_ACTION_ITEM * pAction, WM_HWIN hScreen, WM_MESSAGE * pMsg, int * pResult);
...
void ID_SCREEN_LOG__ID_BUTTON_LOGO_BACK__WM_NOTIFICATION_CLICKED                        (APPW_ACTION_ITEM * pAction, WM_HWIN hScreen, WM_MESSAGE * pMsg, int * pResult);
