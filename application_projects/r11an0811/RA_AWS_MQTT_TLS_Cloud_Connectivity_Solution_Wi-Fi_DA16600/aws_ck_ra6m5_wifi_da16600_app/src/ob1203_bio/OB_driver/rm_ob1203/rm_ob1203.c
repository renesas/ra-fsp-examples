 ...
 * Global variables
 **********************************************************************************************************************/
rm_ob1203_ctrl_t * g_ob1203_ctrl;
...
fsp_err_t RM_OB1203_Open (rm_ob1203_ctrl_t * const p_api_ctrl, rm_ob1203_cfg_t const * const p_cfg)
{
    ...
    /* Save the value of g_sensor_ctrl */
    g_ob1203_ctrl =  p_api_ctrl;
...
void rm_ob1203_comms_i2c_callback (rm_comms_callback_args_t * p_args)
{
    ...
    fsp_err_t err = FSP_SUCCESS;
#endif
    rm_ob1203_instance_ctrl_t * p_ctrl = (rm_ob1203_instance_ctrl_t *) g_ob1203_ctrl;
