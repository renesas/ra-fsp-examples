...
def communication_setting():
    ...
    while loopcount != 0:
        ...
        # Reference the Section "Command setting phase" in R01AN5562 for details".
...
if loopcount > 0:
    ...
    match h:
        case b'\xc6':
            print("CM33/CM85 boot code received")
            bootcode = 0xc6
        case b'\xc3':
...
if deviceSignature != 0x01 and deviceSignature != 0x02 and deviceSignature != 0x05 and deviceSignature != 0x08:
    print("The device is not supported by this demonstration")
    terminate_execution()
elif deviceSignature == 0x05:
    print("DLM and Initialize commands are not supported in this device. Please refer to Boot firmware user guide for details.")
    terminate_execution()
