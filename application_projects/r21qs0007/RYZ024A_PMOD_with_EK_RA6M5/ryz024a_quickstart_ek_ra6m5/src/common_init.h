...
#define FULL_NAME       ("EK-RA6M5 (with RYZ024A PMOD)")
...
#define MENU_ACTIVATION_ERROR_INFO  "\r\n\n **Run Menu 2 CAT-M Module Information before Validate SIM activation** \r\n"
...
// ------------------------------
#define         MAX_SYS_CONFIG_ENTRY_LENGTH     40

EXTERN char     gMqttServerHostStr[MAX_SYS_CONFIG_ENTRY_LENGTH]
#ifdef ONE_FLASH_C
                = { 0 }
#endif
;
EXTERN int      gMqttServerPortNum
#ifdef ONE_FLASH_C
                = 0
#endif
;
