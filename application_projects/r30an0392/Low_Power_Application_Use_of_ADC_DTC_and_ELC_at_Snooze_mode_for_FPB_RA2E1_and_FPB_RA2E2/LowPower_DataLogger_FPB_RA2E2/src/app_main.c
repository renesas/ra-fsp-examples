...
volatile bool g_timer_lpm_cancel_flag;
...
void app_main(void)
{
    ...
    g_timer_lpm_cancel_flag = CLEAR_FLAG;
    ...
    while(1){
        ...
        /* Level Judgment Result Output function */
        ...
        /* AGT0 Timer Output function (24 H periodic) */
        if(g_timer_lpm_cancel_flag == SET_FLAG)
        {
            /* Clear the flag */
            g_timer_lpm_cancel_flag = CLEAR_FLAG;
