...
void adc_initialize(void)
{
    ...
    // See Note 10 on Table "Operating conditions of each low power mode" of the RA2E1 manual R01UH0852
...
void rtc_initialize(void)
{
	...
	if (R_RTC->RCR4_b.RCKSEL == 0)
	{
		 ...
		 * on-board sub-clock oscillator of FPB-RA2E1 is provided 32,768 Hz.
		 * So it is not necessary to perform the adjustment.
		 * (See section 22.3.8 "Time Error Adjustment Function" of the RA2E1 manual R01UH0852)
		 */
	}
