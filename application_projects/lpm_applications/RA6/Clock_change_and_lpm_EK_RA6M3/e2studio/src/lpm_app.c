...
void preffered_ra6m_clock_setting(cgc_pll_cfg_t *lnew_clk, cgc_clocks_cfg_t *lsys_clk_cfg)
{
	...
	lsys_clk_cfg->divider_cfg.iclk_div = CGC_SYS_CLOCK_DIV_2;
	lsys_clk_cfg->divider_cfg.bclk_div = CGC_SYS_CLOCK_DIV_2;
	lsys_clk_cfg->divider_cfg.fclk_div = CGC_SYS_CLOCK_DIV_4;
	lsys_clk_cfg->divider_cfg.pclka_div = CGC_SYS_CLOCK_DIV_2;
	lsys_clk_cfg->divider_cfg.pclkb_div = CGC_SYS_CLOCK_DIV_4;
	lsys_clk_cfg->divider_cfg.pclkc_div = CGC_SYS_CLOCK_DIV_4;
	lsys_clk_cfg->divider_cfg.pclkd_div = CGC_SYS_CLOCK_DIV_2;
}
/**********************************************************************************************************************
