...
extern const clock_state_trans_t  clock_transition_table[6][2];
...
extern void preffered_ra6m_clock_setting(cgc_pll_cfg_t *lnew_clk, cgc_clocks_cfg_t *lsys_clk_cfg);
