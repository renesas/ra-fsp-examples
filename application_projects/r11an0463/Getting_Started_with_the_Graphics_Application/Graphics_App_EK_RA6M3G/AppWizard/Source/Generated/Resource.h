...
#define ID_TEXT_TEXT_COLOR_TXT 14
...
*       Images
*/
extern GUI_CONST_STORAGE unsigned char acbg_sunny[];
extern GUI_CONST_STORAGE unsigned char acbg_partlycloudy[];
extern GUI_CONST_STORAGE unsigned char acbg_rainy[];
extern GUI_CONST_STORAGE unsigned char acbg_thermostat[];
extern GUI_CONST_STORAGE unsigned char acbox_thermostat[];
...
extern GUI_CONST_STORAGE unsigned char acanime_raining_2[];
...
extern GUI_CONST_STORAGE unsigned char acSimple_blue_green_gradient_480x272[];
...
extern GUI_CONST_STORAGE unsigned char acDARK_Slider_Thumb_Down_22x22[];
...
*       Animations
*/
#define ID_ANIM_CLOUDY_MOTION (GUI_ID_USER + 2)
