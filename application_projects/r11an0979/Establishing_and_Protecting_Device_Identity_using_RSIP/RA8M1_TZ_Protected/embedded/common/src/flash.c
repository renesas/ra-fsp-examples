...
/*****************************************************************************************************************
 *  @brief      write_file
 *  @param[in]  lfs: Pointer to the LittleFS file system object.
...
{
    lfs_file_t file;
    int res = lfs_file_open(lfs, &file, path, LFS_O_WRONLY | LFS_O_CREAT | LFS_O_TRUNC);
 ...
 *  @param[in]  data_size: Size of the buffer to store the read data.
 *  @retval     Number of bytes read if successful, negative error code otherwise.
 ****************************************************************************************************************/
