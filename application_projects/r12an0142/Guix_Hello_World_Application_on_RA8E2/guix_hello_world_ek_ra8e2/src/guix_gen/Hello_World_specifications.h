...
#ifndef _HELLO_WORLD_SPECIFICATIONS_H_
#define _HELLO_WORLD_SPECIFICATIONS_H_
...
typedef struct WINDOW2_CONTROL_BLOCK_STRUCT
{
    ...
    GX_TEXT_BUTTON Window2_window2changer;
...
typedef struct WINDOW1_CONTROL_BLOCK_STRUCT
{
    ...
    GX_PROMPT Window1_windowchangertext;
    GX_BUTTON Window1_window1changer;
