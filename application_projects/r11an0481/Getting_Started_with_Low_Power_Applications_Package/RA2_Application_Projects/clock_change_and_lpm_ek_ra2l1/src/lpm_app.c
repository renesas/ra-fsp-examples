...
const lpm_state_tran_t lpm_transition_table[6][3] =
{
/*************************************************************************************************************************************************************************************************/
...
/*ST_LPM_SNZ            */{ { ST_LPM_NORM,           no_action                     }, { ST_LPM_NORM,           no_action                    }, { ST_LPM_NORM,           lpm_snz_timer_action   } },
};
 ...
 * @retval      None.
 **********************************************************************************************************************/
void preffered_ra_clock_setting(void)
{
...
void change_system_clock(void)
{
	...
	switch (clk_currentState)
	{
		case ST_HOCO_NORM:
		{
			...
			sys_clk_cfg.pll_cfg.source_clock = CGC_CLOCK_HOCO;
			sys_clk_cfg.pll_cfg.divider = CGC_PLL_DIV_1;
			sys_clk_cfg.pll_cfg.multiplier = 0;

			sys_clk_cfg.pll2_cfg.source_clock = CGC_CLOCK_HOCO;
			...
			sys_clk_cfg.divider_cfg.sckdivcr_b.bclk_div = CGC_SYS_CLOCK_DIV_1;
		...
		case ST_MOCO_NORM:
		{
			...
			sys_clk_cfg.pll_cfg.source_clock = CGC_CLOCK_MOCO;
			sys_clk_cfg.pll_cfg.divider = CGC_PLL_DIV_1;
			sys_clk_cfg.pll_cfg.multiplier = 0;

			sys_clk_cfg.pll2_cfg.source_clock = CGC_CLOCK_MOCO;
			sys_clk_cfg.pll2_cfg.divider = CGC_PLL_DIV_1;
			sys_clk_cfg.pll2_cfg.multiplier = 0;
	    ...
	    case ST_LOCO_NORM:
	    {
			...
			sys_clk_cfg.pll_cfg.source_clock = CGC_CLOCK_LOCO;
			sys_clk_cfg.pll_cfg.divider = CGC_PLL_DIV_1;
			sys_clk_cfg.pll_cfg.multiplier = 0;

			sys_clk_cfg.pll2_cfg.source_clock = CGC_CLOCK_LOCO;
			sys_clk_cfg.pll2_cfg.divider = CGC_PLL_DIV_1;
			sys_clk_cfg.pll2_cfg.multiplier = 0;
	...
	if (CGC_CLOCK_LOCO == sys_clock_source)
	{
