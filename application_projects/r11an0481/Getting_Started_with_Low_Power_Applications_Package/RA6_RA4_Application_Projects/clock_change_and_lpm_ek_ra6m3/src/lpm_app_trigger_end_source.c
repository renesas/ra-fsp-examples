...
void preffered_ra6m_initial_clock_setting(cgc_clocks_cfg_t *lsys_clk_cfg)
{
#if defined (BOARD_RA6M3_EK) || defined (BOARD_RA6M3G_EK) /* || defined (BOARD_RA6M2_EK) || defined (BOARD_RA6M1_EK) */
    lsys_clk_cfg->mainosc_state        = CGC_CLOCK_CHANGE_START;
...
fsp_err_t init_cgc(void)
{
	...
	preffered_ra6m_initial_clock_setting(&sys_clk_cfg);
