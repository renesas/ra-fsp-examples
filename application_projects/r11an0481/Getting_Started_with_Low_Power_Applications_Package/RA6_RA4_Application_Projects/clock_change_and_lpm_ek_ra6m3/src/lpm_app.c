 ...
 */
clk_state_t  clk_currentState = ST_MOSC_NORM;
 ...
 */
const clock_state_trans_t  clock_transition_table[6][2] =
{
/********************************************************************************************/
...
/********************************************************************************************/
/*ST_MOSC_NORM */    { { ST_MOSC_NORM,  enter_lpm_sm}, { ST_HOCO_NORM, change_system_clock} },
...
/*ST_LOCO_NORM */    { { ST_LOCO_NORM,  enter_lpm_sm}, { ST_SOSC_NORM, change_system_clock} },
/*ST_SOSC_NORM */    { { ST_SOSC_NORM,  enter_lpm_sm}, { ST_MOSC_NORM, change_system_clock} },
/*ST_CLK_NORM  */    { { ST_MOSC_NORM,  enter_lpm_sm}, { ST_MOSC_NORM, change_system_clock} }
};
...
/**********************************************************************************************************************
 * @brief       This function changes the System Clock divider  settings as applicable to the MCU and various peripherals
 * @param[IN]   void
 * @retval      None.
 **********************************************************************************************************************/
void preffered_ra6m_clock_setting(cgc_pll_cfg_t *lnew_clk, cgc_clocks_cfg_t *lsys_clk_cfg)
{
	lnew_clk->divider = CGC_PLL_DIV_2;
	lnew_clk->multiplier = CGC_PLL_MUL_20_0;

	lsys_clk_cfg->system_clock = CGC_CLOCK_MAIN_OSC;

	lsys_clk_cfg->pll_cfg.divider = CGC_PLL_DIV_2;
	lsys_clk_cfg->pll_cfg.source_clock = CGC_CLOCK_MAIN_OSC;
	lsys_clk_cfg->pll_cfg.multiplier = CGC_PLL_MUL_20_0;

	lsys_clk_cfg->divider_cfg.sckdivcr_b.iclk_div = CGC_SYS_CLOCK_DIV_2;
	lsys_clk_cfg->divider_cfg.sckdivcr_b.bclk_div = CGC_SYS_CLOCK_DIV_2;
	lsys_clk_cfg->divider_cfg.sckdivcr_b.fclk_div = CGC_SYS_CLOCK_DIV_4;
	lsys_clk_cfg->divider_cfg.sckdivcr_b.pclka_div = CGC_SYS_CLOCK_DIV_2;
	lsys_clk_cfg->divider_cfg.sckdivcr_b.pclkb_div = CGC_SYS_CLOCK_DIV_4;
	lsys_clk_cfg->divider_cfg.sckdivcr_b.pclkc_div = CGC_SYS_CLOCK_DIV_4;
	lsys_clk_cfg->divider_cfg.sckdivcr_b.pclkd_div = CGC_SYS_CLOCK_DIV_2;
}
/**********************************************************************************************************************
...
void change_system_clock(void)
{
	...
	preffered_ra6m_clock_setting(&new_clk, &sys_clk_cfg);
	...
	switch (clk_currentState)
	{
		...
		case ST_SOSC_NORM:
		{
			sys_clock_source = CGC_CLOCK_SUBCLOCK;
			sys_clk_cfg.divider_cfg.sckdivcr_b.iclk_div = CGC_SYS_CLOCK_DIV_1;
			sys_clk_cfg.divider_cfg.sckdivcr_b.fclk_div = CGC_SYS_CLOCK_DIV_1;
			break;
		}
		case ST_MOSC_NORM:
		{
			sys_clock_source = CGC_CLOCK_MAIN_OSC;
			sys_clk_cfg.mainosc_state = CGC_CLOCK_CHANGE_START;
			break;
		}
		case ST_CLK_NORM:
		default:
