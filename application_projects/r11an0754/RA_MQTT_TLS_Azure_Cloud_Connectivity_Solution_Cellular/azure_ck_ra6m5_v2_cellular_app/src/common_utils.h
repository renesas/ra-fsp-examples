...
#define MODULE_NAME             "Azure RTOS NetX Duo IoT Middleware"
#define BANNER_INFO             "\r\n********************************************************************************"\
...
#define AP_INFO                 "\r\nThis Application project demonstrates the IOT functionalities of Azure IOT SDK"\
                                "\r\nClient using Azure RTOS and NetX Duo with Cellular Interface Module running on"\
                                "\r\nRenesas RA MCU's" \
							    "\r\n********************************************************************************\r\n"\
                                "\r\n\r\n"
