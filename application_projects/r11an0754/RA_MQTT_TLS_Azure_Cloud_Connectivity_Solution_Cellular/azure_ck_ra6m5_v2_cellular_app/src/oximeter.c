...
float r_p2p;
usr_ob1203_data_t g_ob1203_data_s;
bool result;
...
void ob1203_spo2_main(void)
{
    ...
    g_ob1203_data_s.r_p2p = r_p2p;
    g_ob1203_data_s.spo2_val = spo2_val;
    g_ob1203_data_s.heart_rate_Val = heart_Rate_Val;
    g_ob1203_data_s.breathing_rate = breathing_rate;

    /* Send OB1203 sensor data to the Ob1203 queue */
    status = send_data_to_queue(&g_ob1203_queue, &g_ob1203_data_s);
