...
extern const uint32_t Image$$__ddsc_QSPI_FLASH_START$$Base;
BSP_DONT_REMOVE uint32_t const * const gp_ddsc_QSPI_FLASH_START = &Image$$__ddsc_QSPI_FLASH_START$$Base;
extern const uint32_t Image$$__ddsc_QSPI_FLASH_END$$Base;
BSP_DONT_REMOVE uint32_t const * const gp_ddsc_QSPI_FLASH_END = &Image$$__ddsc_QSPI_FLASH_END$$Base;
...
extern uint32_t Image$$__ospi0_cs0_from_qspi_flash$$Base;
extern uint32_t Image$$__ospi0_cs0_from_qspi_flash$$Limit;
extern uint32_t Load$$__ospi0_cs0_from_qspi_flash$$Base;
...
extern uint32_t Image$$__ram_from_qspi_flash$$Base;
extern uint32_t Image$$__ram_from_qspi_flash$$Limit;
extern uint32_t Load$$__ram_from_qspi_flash$$Base;
...
{
  {.p_base = &Image$$__ospi0_cs0_from_qspi_flash$$Base, .p_limit = &Image$$__ospi0_cs0_from_qspi_flash$$Limit, .p_load = &Load$$__ospi0_cs0_from_qspi_flash$$Base,.type={.copy_64 = 0, .external = 1, .source_type = INIT_MEM_QSPI_FLASH, .destination_type = INIT_MEM_OSPI0_CS0}},
  ...
  {.p_base = &Image$$__ram_from_qspi_flash$$Base, .p_limit = &Image$$__ram_from_qspi_flash$$Limit, .p_load = &Load$$__ram_from_qspi_flash$$Base,.type={.copy_64 = 0, .external = 1, .source_type = INIT_MEM_QSPI_FLASH, .destination_type = INIT_MEM_RAM}},
