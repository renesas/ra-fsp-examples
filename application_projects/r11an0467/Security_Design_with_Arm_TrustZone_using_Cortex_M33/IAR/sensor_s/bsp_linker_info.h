...
#pragma section="__ddsc_DATA_FLASH_START"
BSP_DONT_REMOVE uint32_t const * const gp_ddsc_DATA_FLASH_START = (uint32_t const *) __section_begin("__ddsc_DATA_FLASH_START");
#pragma section="__ddsc_DATA_FLASH_END"
BSP_DONT_REMOVE uint32_t const * const gp_ddsc_DATA_FLASH_END = (uint32_t const *) __section_begin("__ddsc_DATA_FLASH_END");
#pragma section="__ddsc_FLASH_START"
BSP_DONT_REMOVE uint32_t const * const gp_ddsc_FLASH_START = (uint32_t const *) __section_begin("__ddsc_FLASH_START");
#pragma section="__ddsc_FLASH_END"
BSP_DONT_REMOVE uint32_t const * const gp_ddsc_FLASH_END = (uint32_t const *) __section_begin("__ddsc_FLASH_END");
#pragma section="__ddsc_FLASH_NSC"
BSP_DONT_REMOVE uint32_t const * const gp_ddsc_FLASH_NSC = (uint32_t const *) __section_begin("__ddsc_FLASH_NSC");
#pragma section="__ddsc_RAM_START"
BSP_DONT_REMOVE uint32_t const * const gp_ddsc_RAM_START = (uint32_t const *) __section_begin("__ddsc_RAM_START");
#pragma section="__ddsc_RAM_END"
BSP_DONT_REMOVE uint32_t const * const gp_ddsc_RAM_END = (uint32_t const *) __section_begin("__ddsc_RAM_END");
#pragma section="__ddsc_RAM_NSC"
BSP_DONT_REMOVE uint32_t const * const gp_ddsc_RAM_NSC = (uint32_t const *) __section_begin("__ddsc_RAM_NSC");
