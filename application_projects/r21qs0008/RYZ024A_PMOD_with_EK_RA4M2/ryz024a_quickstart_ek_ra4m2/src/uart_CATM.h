...
// Define one SIM Card Provider to set the Access Point Name
#define TRUPHONE_SIM_APN
#undef  IBASIS_SIM_APN

#if defined(TRUPHONE_SIM_APN)
#define CELLULAR_CFG_AP_NAME        "AT+CGDCONT=1,\"IP\",\"iot.truphone.com\"\r\n"      /* Access point name : Truphone SIM Card */
#elif defined(IBASIS_SIM_APN)
#define CELLULAR_CFG_AP_NAME        "AT+CGDCONT=1,\"IPV4V6\",\"globaldata.iot\"\r\n"    /* Access point name : iBasis SIM Card */
#else
#define CELLULAR_CFG_AP_NAME        "AT+CGDCONT=1,\"IP\",\"iot.truphone.com\"\r\n"      /* Access point name : No SIM Card Provider selected so use APN default */
#endif
