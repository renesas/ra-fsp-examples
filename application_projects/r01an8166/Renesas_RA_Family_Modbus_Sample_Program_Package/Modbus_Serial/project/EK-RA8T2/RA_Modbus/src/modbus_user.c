...
static modbus_err_t mb_reg_exp_addr_p8 (uint8_t * data);
static modbus_err_t mb_reg_exp_addr_p16 (uint16_t * data);
static modbus_err_t mb_reg_exp_addr_16 (uint16_t data);

/************************************************
 READ_COILS(0x01) functions
 */
static modbus_err_t mb_coil_read_00001 (uint8_t * data);
static modbus_err_t mb_coil_read_00002 (uint8_t * data);
static modbus_err_t mb_coil_read_00003 (uint8_t * data);
static modbus_err_t mb_coil_read_00004 (uint8_t * data);
static modbus_err_t mb_coil_read_00005 (uint8_t * data);
static modbus_err_t mb_coil_read_00006 (uint8_t * data);
static modbus_err_t mb_coil_read_00007 (uint8_t * data);
static modbus_err_t mb_coil_read_00008 (uint8_t * data);

/************************************************
 WRITE_SINGLE_COIL(0x05) functions
 */
static modbus_err_t mb_coil_write_00001 (uint8_t data);
static modbus_err_t mb_coil_write_00002 (uint8_t data);
static modbus_err_t mb_coil_write_00003 (uint8_t data);
static modbus_err_t mb_coil_write_00004 (uint8_t data);
static modbus_err_t mb_coil_write_00005 (uint8_t data);
static modbus_err_t mb_coil_write_00006 (uint8_t data);
static modbus_err_t mb_coil_write_00007 (uint8_t data);
static modbus_err_t mb_coil_write_00008 (uint8_t data);

/************************************************
 READ DISCRETE INPUTS(0x02) functions
 */
static modbus_err_t mb_d_read_10001 (uint8_t * data);
static modbus_err_t mb_d_read_10002 (uint8_t * data);
static modbus_err_t mb_d_read_10003 (uint8_t * data);
static modbus_err_t mb_d_read_10004 (uint8_t * data);
static modbus_err_t mb_d_read_10005 (uint8_t * data);
static modbus_err_t mb_d_read_10006 (uint8_t * data);
static modbus_err_t mb_d_read_10007 (uint8_t * data);
static modbus_err_t mb_d_read_10008 (uint8_t * data);
static modbus_err_t mb_d_read_10009 (uint8_t * data);

/* Generate exception at 10010 by MB_Reg_Exp_Addr() */

static modbus_err_t mb_d_read_10011 (uint8_t * data);
static modbus_err_t mb_d_read_10012 (uint8_t * data);

/************************************************
 READ_INPUT_REGISTERS(0x04) functions
 */
static modbus_err_t mb_ireg_read_30001 (uint16_t * data);
static modbus_err_t mb_ireg_read_30002 (uint16_t * data);
static modbus_err_t mb_ireg_read_30003 (uint16_t * data);
...
static modbus_err_t mb_ireg_read_30008 (uint16_t * data);

/************************************************
 READ_HOLDING_REGISTERS(0x03) functions
 */
static modbus_err_t mb_reg_read_40001 (uint16_t * data);
static modbus_err_t mb_reg_read_40002 (uint16_t * data);
static modbus_err_t mb_reg_read_40003 (uint16_t * data);
...
static modbus_err_t mb_reg_read_40007 (uint16_t * data);

/************************************************
 WRITE_SINGLE_REGISTER(0x06) functions
 */
static modbus_err_t mb_reg_write_40001 (uint16_t data);
static modbus_err_t mb_reg_write_40002 (uint16_t data);
static modbus_err_t mb_reg_write_40003 (uint16_t data);

/* Generate exception at 40004 by MB_Reg_Exp_Addr() */
/* Generate exception at 40005 by MB_Reg_Exp_Addr() */
/* Generate exception at 40006 by MB_Reg_Exp_Addr()*/

static modbus_err_t mb_reg_write_40007 (uint16_t data);
...
/************************************************
 READ_COILS(0x01) functions
 */
modbus_err_t (*MB_Coils_Read[])(uint8_t *data)=
{
...
/************************************************
 WRITE_SINGLE_COIL(0x05) functions
 */
modbus_err_t (*MB_Coils_Write[])(uint8_t data)=
{
...
/************************************************
 READ DISCRETE INPUTS(0x02) functions
 */
modbus_err_t (*MB_Discretes_Input[])(uint8_t *data)=
{
...
/************************************************
 READ_INPUT_REGISTERS(0x04) functions
 */
modbus_err_t (*MB_Input_Regs[])(uint16_t *data)=
{
...
/************************************************
 READ_HOLDING_REGISTERS(0x03) functions
 */
modbus_err_t (*MB_HoldingRegs_Read[])(uint16_t *data)=
{
...
/************************************************
 WRITE_SINGLE_REGISTER(0x06) functions
 */
modbus_err_t (*MB_HoldingRegs_Write[])(uint16_t data)=
{
...
/* MODBUS_ERR_ILLEGAL_DATA_ADDRESS is changed to ERR_SLAVE_DEVICE_FAILURE in MB_Func_Exp_Execution() */
/**********************************************************************************************************************
 * Function Name: mb_reg_exp_addr_p8
 * Description  : Returns MODBUS_ERR_ILLEGAL_DATA_ADDRESS
 * Argument     : uint8_t *data
 * Return Value : MODBUS_ERR_ILLEGAL_DATA_ADDRESS
 *********************************************************************************************************************/
static modbus_err_t mb_reg_exp_addr_p8(uint8_t *data)
{
    (void) data;
 ...
 *********************************************************************************************************************/
static modbus_err_t mb_coil_read_00001(uint8_t *coil)
{
    uint8_t index = 0;
 ...
 * Return Value : MODBUS_ERR_OK
 *********************************************************************************************************************/
static modbus_err_t mb_coil_read_00002(uint8_t *coil)
{
    uint8_t index = 1;
 ...
 * Return Value : MODBUS_ERR_OK
 *********************************************************************************************************************/
static modbus_err_t mb_coil_read_00003(uint8_t *coil)
{
    uint8_t index = 2;
 ...
 * Return Value : MODBUS_ERR_OK
 *********************************************************************************************************************/
static modbus_err_t mb_coil_read_00004(uint8_t *coil)
{
    uint8_t index = 3;
 ...
 * Return Value : MODBUS_ERR_OK
 *********************************************************************************************************************/
static modbus_err_t mb_coil_read_00005(uint8_t *coil)
{
    uint8_t index = 4;
 ...
 * Return Value : MODBUS_ERR_OK
 *********************************************************************************************************************/
static modbus_err_t mb_coil_read_00006(uint8_t *coil)
{
    uint8_t index = 5;
 ...
 * Return Value : MODBUS_ERR_OK
 *********************************************************************************************************************/
static modbus_err_t mb_coil_read_00007(uint8_t *coil)
{
    uint8_t index = 6;
 ...
 * Return Value : MODBUS_ERR_OK
 *********************************************************************************************************************/
static modbus_err_t mb_coil_read_00008(uint8_t *coil)
{
    uint8_t index = 7;
 ...
 * Return Value : MODBUS_ERR_OK
 *********************************************************************************************************************/
static modbus_err_t mb_d_read_10001(uint8_t *state)
{
    uint8_t index = 0;
 ...
 * Return Value : MODBUS_ERR_OK
 *********************************************************************************************************************/
static modbus_err_t mb_d_read_10002(uint8_t *state)
{
    uint8_t index = 1;
 ...
 * Return Value : MODBUS_ERR_OK
 *********************************************************************************************************************/
static modbus_err_t mb_d_read_10003(uint8_t *state)
{
    uint8_t index = 2;
 ...
 * Return Value : MODBUS_ERR_OK
 *********************************************************************************************************************/
static modbus_err_t mb_d_read_10004(uint8_t *state)
{
    uint8_t index = 3;
 ...
 * Return Value : MODBUS_ERR_OK
 *********************************************************************************************************************/
static modbus_err_t mb_d_read_10005(uint8_t *state)
{
    uint8_t index = 4;
 ...
 * Return Value : MODBUS_ERR_OK
 *********************************************************************************************************************/
static modbus_err_t mb_d_read_10006(uint8_t *state)
{
 ...
 * Return Value : MODBUS_ERR_OK
 *********************************************************************************************************************/
static modbus_err_t mb_d_read_10007(uint8_t *state)
{
 ...
 * Return Value : MODBUS_ERR_OK
 *********************************************************************************************************************/
static modbus_err_t mb_d_read_10008(uint8_t *state)
{
    uint8_t index = 7;
 ...
 * Return Value : MODBUS_ERR_OK
 *********************************************************************************************************************/
static modbus_err_t mb_d_read_10009(uint8_t *state)
{
    uint8_t index = 8;
 ...
 * Return Value : MODBUS_ERR_OK
 *********************************************************************************************************************/
static modbus_err_t mb_d_read_10011(uint8_t *state)
{
    uint8_t index = 10;
 ...
 * Return Value : MODBUS_ERR_OK
 *********************************************************************************************************************/
static modbus_err_t mb_d_read_10012(uint8_t *state)
{
    uint8_t index = 11;
