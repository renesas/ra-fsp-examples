                                 ...
                                 const uint8_t *pBuffer, const uint32_t numBytes)
{
    ...
    else
    {
        ...
        {
            #ifdef SWO_PRINTF
                        printf("Device Cert: flash write error %d  \n\r", (int)fsp_status);
            #endif
            status = UNSPECIFIED_ERROR;
        }
        else
        {
            #ifdef SWO_PRINTF
                        printf("Successfully wrote the Device Cert in the flash\r\n");
            #endif
        }
    }
    ...
    {
        #ifdef SWO_PRINTF
                 printf("WRAPPED_KEY_CERT_PROGRAM failed!!! \r ");
        #endif
    ...
    {
        #ifdef SWO_PRINTF
                  printf("Flash write validation of Device Cert succeeded\n\r");
        #endif
    }
    else
    {
        #ifdef SWO_PRINTF
                    printf("Failed flash write validation of Device Cert\n\r");
        #endif
    }
                                       ...
                                       const uint32_t numBytes)
{
    ...
    {
        #ifdef SWO_PRINTF
                printf("ChallengeResp successful. Responding with signed Hashed data\r\n ");
        #endif
