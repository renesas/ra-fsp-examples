...
static void print_inf_time(void)
{
    ...
    print_bg_font_18(d2_handle, 210, 260, DISPLAY_FONT_SCALING, (char*)time_str);
}
...
void do_image_classification_screen(bool ai_result_new)
{
    ...
    if(!(xEventGroupGetBits(g_ai_app_event) & DISPLAY_PAUSE))
    {
		 ...
		 d2_framebuffer(d2_handle, gp_next_buffer, 640, 640, 480, DISPLAY_SCREEN_BUFF_D2_COLOR_CODE);
		...
		if (!overlay_drawn)
        {
            ...
            print_bg_font_18(d2_handle, 20,  40, IMAGE_CLASSIFICATION_FONT_SCALING, (char*)"Image Classification");

            print_bg_font_18(d2_handle, 20,  110, DISPLAY_FONT_SCALING, (char*)"Model:");
            print_bg_font_18(d2_handle, 20,  150, 1.0, (char*)"MobileNet V1 0.25 int8");


            print_bg_font_18(d2_handle, 20,  210, DISPLAY_FONT_SCALING, (char*)"Dataset: ImageNet");

            /*show inference time in ms*/
            print_bg_font_18(d2_handle, 20, 260, DISPLAY_FONT_SCALING, (char*)"CPU Inference Time:");


            print_bg_font_18(d2_handle, 20, 310, DISPLAY_FONT_SCALING, (char*)"Inference Result: ");
