...
static int8_t model_input[IMAGE_DATA_SIZE];

/* Use the SRAM for TensorArena area for improvement performance. */
static uint8_t compute_buffer[kBufferSize_sub_0000_net1 ];

extern int8_t output_buffer[1000];
...
bool main_loop_image_classification()
{
    ...
    create_int8_tensor(&outputTensor, output_buffer, 0.00390625, -128);
