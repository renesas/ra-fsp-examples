...
enum BufferSize_sub_0000_net1 {
  ...
  kBufferSize_sub_0000_net1 = 610177
#elif defined(ARM_MATH_DSP)
  kBufferSize_sub_0000_net1 = 605825
#else
  kBufferSize_sub_0000_net1 = 605825
#endif
...
void compute_sub_0000_net1(
  ...
  uint8_t* main_storage, // should provide at least 605712 bytes of storage

  // inputs
  
  const int8_t serving_default_input_1_0[150528], // 1,224,224,3
  

  // outputs
  
  int8_t StatefulPartitionedCall_0_70098[1000]  // 1,1000
