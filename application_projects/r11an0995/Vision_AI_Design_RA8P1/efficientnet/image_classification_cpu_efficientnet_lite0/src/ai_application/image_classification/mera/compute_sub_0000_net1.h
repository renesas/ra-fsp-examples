...
enum BufferSize_sub_0000_net1 {
  ...
  kBufferSize_sub_0000_net1 = 1718385
#elif defined(ARM_MATH_DSP)
  kBufferSize_sub_0000_net1 = 1763585
#else
  kBufferSize_sub_0000_net1 = 1706097
#endif
...
void compute_sub_0000_net1(
  ...
  uint8_t* main_storage, // should provide at least 1706097 bytes of storage

  // inputs
  
  const uint8_t images[150528], // 1,224,224,3
  

  // outputs
  
  uint8_t Softmax_70164[1000]  // 1,1000
