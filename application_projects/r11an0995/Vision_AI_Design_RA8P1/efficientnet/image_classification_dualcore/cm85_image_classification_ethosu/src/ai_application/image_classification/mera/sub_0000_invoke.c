...
__attribute__((aligned(16), section(".sdram"))) uint8_t sub_0000_arena[1505280];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0000_fast_scratch[1505280];
...
int sub_0000_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0000_model with size 4672224 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0000_model_data;
  base_addrs_size[0] = sub_0000_model_data_size;
  // Buffer sub_0000_arena with size 1505280 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0000_arena+0);
  base_addrs_size[1] = 1505280;

  // Buffer sub_0000_fast_scratch with size 1505280 and address: 0
  base_addrs[2] = (uint64_t)(uintptr_t) (sub_0000_arena+0);
  base_addrs_size[2] = 1505280;

  // Buffer input_tensor_0 with size 150528 and address: 802816
  base_addrs[3] = (uint64_t)(uintptr_t) (sub_0000_arena+802816);
  base_addrs_size[3] = 150528;

  // Buffer output_tensor_0 with size 1000 and address: 1008
  if (clean_outputs) {
    memset(sub_0000_arena + 1008, 0, 1000);
  }
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0000_arena+1008);
