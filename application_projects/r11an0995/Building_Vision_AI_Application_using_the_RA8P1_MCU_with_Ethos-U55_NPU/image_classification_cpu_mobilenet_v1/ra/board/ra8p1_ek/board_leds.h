...
/*******************************************************************************************************************//**
 * @ingroup BOARD_RA8P1_EK
 * @defgroup BOARD_RA8P1_EK_LEDS Board LEDs
 * @brief LED information for this board.
 *
 * This is code specific to the RA8P1_EK board. It includes info on the number of LEDs and which pins are they
 * are on.
 *
 * @{
 **********************************************************************************************************************/
...
/** @} (end defgroup BOARD_RA8P1_EK_LEDS) */
