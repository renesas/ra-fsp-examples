...
#define BSP_FEATURE_ADC_B_UNIT_0_CHANNELS                         (0x00770373007F503FULL)   // Mask of channels available to ADC_B Unit 0.
#define BSP_FEATURE_ADC_B_UNIT_1_CHANNELS                         (0x00770373007FAFC0ULL)   // Mask of channels available to ADC_B Unit 1.
...
#define BSP_FEATURE_BSP_CODE_CACHE_VERSION                        (2UL)             // Version of C-Cache implemented in a CM33 core.
...
#define BSP_FEATURE_BSP_HAS_ESW_CLOCK                             (1UL)             // Flag indicating an extra peripheral clock is present.
#define BSP_FEATURE_BSP_HAS_ESWM_DOMAIN                           (1UL)             // Indicates that the MCU has a power domain specifically for ESWM peripherals.
#define BSP_FEATURE_BSP_HAS_ESWPHY_CLOCK                          (1UL)             // Flag indicating an extra peripheral clock is present.
...
#define BSP_FEATURE_BSP_HAS_LCD_CLOCK                             (1UL)             // Indicates there is a separate clock for the LCD.
...
#define BSP_FEATURE_BSP_SYS_CLOCK_FREQ_FIVE_ROM_WAITS             (240000000UL)     // Maximum frequency allowed before requiring five wait cycles.
#define BSP_FEATURE_BSP_SYS_CLOCK_FREQ_FOUR_ROM_WAITS             (192000000UL)     // The maximum frequency allowed without having four ROM wait cycles.
...
#define BSP_FEATURE_BSP_SYS_CLOCK_FREQ_ONE_ROM_WAITS              (48000000UL)      // Maximum frequency allowed before requiring one wait cycle.
#define BSP_FEATURE_BSP_SYS_CLOCK_FREQ_THREE_ROM_WAITS            (144000000UL)     // Maximum frequency allowed before requiring three wait cycles.
#define BSP_FEATURE_BSP_SYS_CLOCK_FREQ_TWO_ROM_WAITS              (96000000UL)      // Maximum frequency allowed before requiring two wait cycles.
...
#define BSP_FEATURE_ETHER_MAX_CHANNELS                            (2UL)             // Number of available ethernet PHYs.
...
#define BSP_FEATURE_IIC_FAST_MODE_PLUS                            (7UL)             // Mask of channels which support "Fast Mode Plus": up to 1 Mbps bit rates.
...
#define BSP_FEATURE_SCI_LIN_CHANNELS                              (0x03FFUL)        // Mask of channels that can support LIN.
#define BSP_FEATURE_SCI_SPI_SCKSEL_VALUE                          (1UL)             // Mask indicating CCR4.SCKSEL is available.
#define BSP_FEATURE_SCI_UART_ABCSE_RESTRICTED_CHANNELS            (0x00UL)          // List of channels that do not support ABCSE functionality.
#define BSP_FEATURE_SCI_UART_CSTPEN_CHANNELS                      (0x03FFUL)        // Mask of channels which support CTS external pins.
...
#define BSP_FEATURE_SCI_UART_FIFO_CHANNELS                        (0x03FFUL)        // Mask of channels which support the UART FIFO.
...
#define BSP_FEATURE_ULPT_MAX_CHANNEL_NUM                          (2UL)             // Number of channels available for ULPT (this is NOT the maximum value for channel).
