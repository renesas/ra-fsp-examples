/***********************************************************************************************************************
 * File Name    : touch_ft5x06.c
 * Description  : Contains data structures and functions used in touch_ft5x06.c
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
void ft5x06_init(i2c_master_instance_t const * p_i2c_instance, SemaphoreHandle_t * i2c_semaphore, bsp_io_port_pin_t reset_pin)
{
    ...
    /*
     * There is not need to reset FT5X06 controller. This has been taken care of by the cortex-m85.
     */
