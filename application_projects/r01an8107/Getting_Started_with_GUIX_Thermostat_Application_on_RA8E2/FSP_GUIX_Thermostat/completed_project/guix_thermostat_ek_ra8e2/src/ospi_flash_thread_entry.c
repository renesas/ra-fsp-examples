...
/* Ospi Flash Thread entry function */
void ospi_flash_thread_entry(void)
{
...
fsp_err_t ospi_b_init (void)
{
    ...
    FSP_HARDWARE_REGISTER_WAIT((R_XSPI0->COMSTT & OSPI_B_PRV_COMSTT_MEMACCCH_MASK_AP), 0);
    R_XSPI0->BMCTL1 = OSPI_B_PRV_BMCTL1_CLEAR_PREFETCH_MASK_AP;
#endif
