...
usr_icm_acc_gyr_data_t g_icm_acc_gyr_data_s;
 ...
 * @param[in]   float *gyVal : Pointer the ICM gyrometer Sensor Data
...
int8_t icm42605_loop()
{
    ...
    /* Update value for ICM variables */
    g_icm_acc_gyr_data_s.acc_data.x = g_corraccraw.x;
    g_icm_acc_gyr_data_s.acc_data.y = g_corraccraw.y;
    g_icm_acc_gyr_data_s.acc_data.z = g_corraccraw.z;
    g_icm_acc_gyr_data_s.gyr_data.x = g_gyrosval.x;
    g_icm_acc_gyr_data_s.gyr_data.y = g_gyrosval.y;
    g_icm_acc_gyr_data_s.gyr_data.z = g_gyrosval.z;

    /* Send ICM sensor data to the ICM queue */
    status = send_data_to_queue(&g_icm_queue, &g_icm_acc_gyr_data_s);
