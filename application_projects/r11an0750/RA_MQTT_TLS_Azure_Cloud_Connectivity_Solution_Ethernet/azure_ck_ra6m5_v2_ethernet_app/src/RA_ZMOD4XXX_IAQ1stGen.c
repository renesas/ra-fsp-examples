...
void start_iaq_1st_gen(void)
{
    ...
    switch (sequence)
    {
        ...
        case DEMO_SEQUENCE_7:
        {
            ...
            if (FSP_SUCCESS == err)
            {
                ...
                /* Set data */
                g_iaq_data_s.gs_etoh = zmod4xxx_data.etoh;
                g_iaq_data_s.gs_eco2 = zmod4xxx_data.eco2;
                g_iaq_data_s.gs_tvoc = zmod4xxx_data.tvoc;
            }
    ...
    /* Send ZMOD4410 sensor data to the IAQ queue */
    status = send_data_to_queue(&g_iaq_queue, &g_iaq_data_s);
