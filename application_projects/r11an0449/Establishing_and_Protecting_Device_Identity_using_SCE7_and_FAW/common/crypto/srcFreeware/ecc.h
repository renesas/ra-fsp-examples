...
#ifndef COMMON_API_ECC_H_
#define COMMON_API_ECC_H_


// Configure the ECC code :-
...
/* make an ECC key based on the random number created by a Pseduo-random-function (PRF) */
