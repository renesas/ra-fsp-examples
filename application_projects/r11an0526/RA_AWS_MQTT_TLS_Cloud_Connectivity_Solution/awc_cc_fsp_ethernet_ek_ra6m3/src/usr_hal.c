...
fsp_err_t usr_hal_init(void)
{
    ...
    {
        APP_ERR_PRINT("** R_ELC_Open failed **\r\n");
        return status;
    }
    ...
    if (FSP_SUCCESS != status)
    {
        APP_ERR_PRINT("** R_ADC_Open failed **\r\n");
        return status;
    }
    ...
    if (FSP_SUCCESS != status)
    {
        APP_ERR_PRINT("** R_ADC_ScanCfg failed **\r\n");
        return status;
    }
    ...
    if (FSP_SUCCESS != status)
    {
        APP_ERR_PRINT("** R_ICU_ExternalIrqOpen (S1) failed **\r\n");
        return status;
    }
    ...
    if (FSP_SUCCESS != status)
    {
        APP_ERR_PRINT("** R_ICU_ExternalIrqEnable (S1) failed **\r\n");
        return status;
    }
    ...
    if (FSP_SUCCESS != status)
    {
        APP_ERR_PRINT("** R_ICU_ExternalIrqOpen (S2) failed **\r\n");
        return status;
    }
    ...
    if (FSP_SUCCESS != status)
    {
        APP_ERR_PRINT("** R_ICU_ExternalIrqEnable (S2) failed **\r\n");
        return status;
    }
    return status;
}
