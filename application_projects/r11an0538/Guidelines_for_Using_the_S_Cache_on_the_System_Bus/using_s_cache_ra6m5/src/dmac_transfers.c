...
const int32_t g_source_sine_cosine_data_code_flash[DATA_SIZE] =
{
...
void dma_transfer_sine_cosine_operation(void)
{
     ...
     */
    set_transfer_dst_src_address(&g_transfer_sine_wave_cfg, (void *)g_source_sine_cosine_data_code_flash , (void *) g_dest_sine_cosine_data);
