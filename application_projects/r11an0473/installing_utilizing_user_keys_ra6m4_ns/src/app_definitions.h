...
#define MENUOPTION1       "Press 1 to use NIST AES test key as plaintext key, wrap and install this key\r\n"
#define MENUOPTION2       "Press 2 to use the installed key to encrypt the NIST plaintext message. Compare the encrypted data with NIST cipher text.\r\n"
#define MENUOPTION3       "Press 3 to use the installed key to decrypt the NIST cipher text. Compare the decrypted data with the NIST plaintext message.\r\n"
#define MENUOPTION4		  "Press 4 to destroy the wrapped AES key last created\r\n"


#define MENUEVENT1       	"perform plaintext NIST AES key wrap and install.\r\n"
#define MENUEVENT2       	"encrypt NIST plaintext message using installed wrapped key.\r\n"
#define MENUEVENT3       	"decrypt NIST cipher data using installed wrapped key.\r\n"
