...
static fsp_err_t app_ecc_operation(void)
{
    fsp_err_t err = FSP_SUCCESS;
    ...
    err = psacrypto_ECC256_example_NIST();
    if (FSP_SUCCESS == err)
    {
        APP_PRINT( "\r\nRSIP-E50D ECC key injection operation is successful.\r\n");
    }
    else
    {
        APP_ERR_PRINT( "\r\nRSIP-E50D ECC key injection operation failed.\r\n");
    }
...
void hal_entry(void)
{
    ...
    /* Jump to CPU 1 to run AES operation */
