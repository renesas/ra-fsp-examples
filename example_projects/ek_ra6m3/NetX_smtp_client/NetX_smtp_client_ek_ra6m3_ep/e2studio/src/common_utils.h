...
#define MODULE_NAME             "NetX_dhcpv6_client"
#define BANNER_INFO             "\r\n********************************************************************************"\
...
typedef enum event_id
{
    ...
    RTT_OUTPUT_MESSAGE_APP_PRINT_CLIENT_DATA,
    RTT_OUTPUT_MESSAGE_APP_PRINT_SERVER_DATA,
    RTT_OUTPUT_MESSAGE_APP_PRINT_CONFIGURED_DATA
}event_id_t;
