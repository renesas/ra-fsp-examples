...
/*******************************************************************************************************************//**
 * @brief       This function takes user input for WiFi AP's SSID, security type and
...
WIFIReturnCode_t manual_connect(void)
{
    ...
    }while((MIN_ZERO > input_buff[INDEX_ZERO]) || (MAX_TWO < input_buff[INDEX_ZERO]) || (NULL_CHAR != input_buff[INDEX_ONE]));
 ...
 **********************************************************************************************************************/
fsp_err_t udp_send_data(uint8_t * p_data)
{
 ...
 **********************************************************************************************************************/
fsp_err_t udp_recv_data(uint8_t * p_data)
{
