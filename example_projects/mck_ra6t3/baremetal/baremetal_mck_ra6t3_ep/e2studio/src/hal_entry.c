...
void hal_entry(void)
{
    ...
    APP_PRINT("\r\nLED 1 and LED 2 turns ON if there is an expected error encountered during operation.");
    APP_PRINT("\r\nLED 1 is turned ON only while program control waits for the User Defined ISR to execute.");
    APP_PRINT("\r\nLED 2 turns ON only to indicate the successful conclusion of application execution.");
