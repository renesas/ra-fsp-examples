...
#if !(defined (BOARD_RA6M5_EK) || defined (BOARD_RA6M4_EK) || defined(BOARD_RA4M3_EK)||defined(BOARD_RA4M2_EK)||defined(BOARD_RA6E1_FPB)||defined(BOARD_RA6T2_MCK)||defined(BOARD_RA6T3_MCK)||defined(BOARD_RA4T1_MCK)||defined(BOARD_RA4E1_FPB)) //Not supported for this MCU
    /* Set Access window.
