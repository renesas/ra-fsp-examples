...
extern "C" {
            ...
            #include "../../../ra/fsp/src/bsp/mcu/ra6t3/bsp_mcu_info.h"
            #include "bsp_clock_cfg.h"
            #define BSP_MCU_GROUP_RA6T3 (1)
...
#define BSP_TZ_CFG_DPFSAR ((RA_NOT_DEFINED > 0) ? 0xFAECA00CU : 0xFFFFFFFFU)
#endif
...
#define BSP_TZ_CFG_CGFSAR (0xFFFAF602U)
#else
...
#define BSP_TZ_CFG_ICUSARE ((RA_NOT_DEFINED > 0) ? 0x87F2FFFFU : 0xFFFFFFFFU)
#endif
