...
/* LED port pin control register for port*/
#if defined (BOARD_RA6M4_EK) || defined (BOARD_RA6T1_RSSK) || defined (BOARD_RA4M3_EK) || defined (BOARD_RA4M2_EK)||defined(BOARD_RA6E1_FPB)
    ...
    static volatile uint32_t *p_ioport_pnctrl_register = &R_PORT13->PCNTR1;
#else
...
/* GPT counter register */
    ...
    static volatile uint32_t *p_gpt_counter_register = &R_GPT1->GTCNT;
#else
