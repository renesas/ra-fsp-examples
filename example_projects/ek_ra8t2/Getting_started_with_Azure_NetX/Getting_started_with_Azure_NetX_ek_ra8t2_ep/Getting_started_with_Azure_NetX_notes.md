...
* RA boards supported for J-Link OB VCOM: EK-RA8D1, EK-RA8M1, EK-RA8T2.
...
* Supported RA boards: EK-RA8D1, EK-RA8M1, EK-RA8T2.
...
| configuration.xml > Stacks > Threads > Net App Thread > Net App Thread Stacks > g_ospi0 OSPI (r_ospi_b) > Properties > Settings > Property > Module g_ospi0 OSPI (r_ospi_b) > Command Sets > Erase Sizes > Block Erase | 262144 | 131072 | Block size of the flash device. |
| configuration.xml > Stacks > Threads > Net App Thread > Net App Thread Stacks > g_ospi0 OSPI (r_ospi_b) > Properties > Settings > Property > Module g_ospi0 OSPI (r_ospi_b) > Command Sets > Initial Mode > Address Length | 1 byte | 3 bytes | Set for the specific number of address length by default for the external flash. |
| configuration.xml > Stacks > Threads > Net App Thread > Net App Thread Stacks > g_rmac_phy0 Ethernet (r_rmac_phy) > Properties > Settings > Property > Module g_rmac_phy0 Ethernet (r_rmac_phy) > Select MII type | RMII | GMII | Specify whether to use MII or GMII. |
