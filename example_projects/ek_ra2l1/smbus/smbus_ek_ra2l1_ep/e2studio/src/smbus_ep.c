...
/***********************************************************************************************************************
 *  Function Name: smbus_entry
 *  Description  : This function is used to start the SMBus example operation.
 *  Arguments    : None
 *  Return Value : None
 **********************************************************************************************************************/
 ...
 *  Description  : This function initializes the essential hardware components required for SMBus.
 *  Arguments    : None
...
static fsp_err_t smbus_init(void)
{
    ...
    APP_ERR_RETURN(err, "**R_IIC_B_MASTER_Open API failed**\r\n");
#endif
...
/***********************************************************************************************************************
 *  Function Name: sensor_write_reg
 *  Description  : This function writes data to sensor register via SMBus.
 *  Arguments    : value1, value 2    values to write to register
 *  Return Value : FSP_SUCCESS    Upon successful operation
 *                 Any Other Error code apart from FSP_SUCCESS
 **********************************************************************************************************************/
static fsp_err_t sensor_write_reg(uint8_t value1, uint8_t value2)
...
/***********************************************************************************************************************
 *  Function Name: sensor_read_reg
 *  Description  : This function reads data from a sensor register via SMBUS.
 *  Arguments    : adr            address of the selected register
 *               : p_value        pointer to store register value
 *  Return Value : FSP_SUCCESS    Upon successful operation
 *                 Any Other Error code apart from FSP_SUCCESS
 **********************************************************************************************************************/
static fsp_err_t sensor_read_reg(uint8_t adr , uint8_t * p_value)
...
/***********************************************************************************************************************
 *  Function Name: smbus_wait_event
 *  Description  : This function waits until SMBus transmission is complete, then filters and displays any SMBus
 *                 specific error.
 *  Arguments    : None
 *  Return Value : FSP_SUCCESS    Upon successful operation
 *                 Any Other Error code apart from FSP_SUCCESS
...
/***********************************************************************************************************************
 *  Function Name: sensor_set_reg
 *  Description  : This function sets data to a sensor register via SMBus.
 *  Arguments    : None
 *  Return Value : FSP_SUCCESS    Upon successful operation
 *                 Any Other Error code apart from FSP_SUCCESS
 **********************************************************************************************************************/
 ...
 *  Description  : This function initializes necessary hardwares and configures sensor register.
 *  Arguments    : None
 *  Return Value : FSP_SUCCESS    Upon successful operation
 *                 Any Other Error code apart from FSP_SUCCESS
 **********************************************************************************************************************/
 ...
 *  Description  : This function gets SMBus events.
...
/***********************************************************************************************************************
 *  Function Name: sensor_deinit
 *  Description  : This function de-initializes SMBus and dependency modules.
 *  Arguments    : None
 *  Return Value : None
 **********************************************************************************************************************/
static void sensor_deinit(void)
 ...
 *  Description  : This function handles error if error occurred, closes all opened modules, print and traps error.
