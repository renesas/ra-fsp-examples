...
#define SHORT_NAME      ("RA2L1")
#define FULL_NAME       ("EK-RA2L1")
#define PART_NUMBER     ("RTK7EKA2L1S00001BE")
#define DEVICE_NUMBER   ("R7FA2L1AB2DFP")

#define LED_INTENSITY_10      (10)            /* 10 percent */
#define LED_INTENSITY_50      (50)            /* 50 percent */
#define LED_INTENSITY_90      (90)            /* 90 percent */

#define BLINK_FREQ_1HZ        (24000000)      /*  1MHZ */
#define BLINK_FREQ_5HZ        (4800000)       /*  5MHZ */
#define BLINK_FREQ_10HZ       (2400000)       /* 10MHZ */
...
/*  Function-like MACRO to access internal events */
...
/* Function-like MACRO MIN - determines the minimum of two values */
...
extern bool_t check_for_input_from_console (void);
