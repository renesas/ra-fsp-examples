...
#define BANNER_7                "\r\nThe project initializes AGT module."\
                                "\r\nUser is given option to enable external interrupt for User Push Button via ICU module"\
                                "\r\nOn pressing the button, AGT timers are enabled in one-shot and periodic mode."\
