...
#define SMCI_VCC                               (BSP_IO_PORT_09_PIN_15)
#define SMCI_RST                               (BSP_IO_PORT_09_PIN_14)
#define SMCI_DETECT                            (BSP_IO_PORT_00_PIN_15)
...
#define SMCI_VCC                               (BSP_IO_PORT_06_PIN_01)
#define SMCI_RST                               (BSP_IO_PORT_02_PIN_05)
#define SMCI_DETECT                            (BSP_IO_PORT_05_PIN_13)
#else
