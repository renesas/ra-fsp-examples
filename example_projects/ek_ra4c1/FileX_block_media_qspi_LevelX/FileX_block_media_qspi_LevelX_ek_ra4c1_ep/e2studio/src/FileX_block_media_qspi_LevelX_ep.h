...
#define EP_INFO                       "\r\nThis Example project demonstrates how user can use FileX block media QSPI"\
                                      "\r\nwith LevelX on RA MCU."\
		                              "\r\nThe project will perform various file operations (Open, Close, Read,"\
		                              "\r\nWrite, Format, adding time stamp to the file) on the QSPI Flash to"\
		                              "\r\ndisplay the FileX with LevelX functionality using QSPI driver, based on"\
		                              "\r\nuser input in RTT Viewer."

#define FILEX_LEVELX_BLOCKMEDIA_MENU  "\r\n\nFileX block media QSPI with LevelX Main Menu options:"\
		                              "\r\n1. Enter 1 to erase QSPI Flash device before using LevelX for"\
                                      " the first time."\
		                              "\r\n   It may take several minutes to complete."\
                                      "\r\n2. Enter 2 to format media."\
		                              "\r\n3. Enter 3 to create a text file on QSPI Flash and write pre-defined data."\
		                              "\r\n4. Enter 4 to create another text file on QSPI Flash, "\
		                              "write and read pre-defined data."\
