...
#define MODULE_NAME        "FileX Blockmedia QSPI with LevelX"
#define BANNER_INFO        "\r\n********************************************************************************"\
 ...
 * For example - 256 bytes  is pool allocated and SEGGER defined BUFFER_SIZE_UP macro is 1024
...
#endif /* RTOS aware RTT data structure and functions */
