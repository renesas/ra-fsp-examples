...
1. Project Overview:
	The example project demonstrates the typical use of the SPI HAL module APIs using SPI and DMAC modules. The project
	configure DMA support SPI channels (Channel 0 and Channel 2) in Master and Slave mode. Once the modules are
	initialized and the SPI channels are configured, Master and Slave can transmit and receive data based on commands
	from user sent through J-Link RTT Viewer. SPI data transmit and receive are done via DMAC module.

2. Hardware Requirements:
	Supported RA boards: EK-RA4M1, EK-RA4W1, EK-RA6M1, EK-RA6M2, EK-RA6M3, EK-RA6M3G, EK-RA6M4, EK-RA6M5,
	                     FPB-RA6E1, RSSK-RA6T1, EK-RA4C1
