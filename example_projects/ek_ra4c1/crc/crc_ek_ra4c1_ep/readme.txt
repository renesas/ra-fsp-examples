...
1. Project Overview:
	...
	data transmission in normal mode and reception in snoop mode through SCI interface. If the board does not support
	snoop mode (EK-RA4E2, EK-RA6E2, MCK-RA4T1, MCK-RA6T3, EK-RA4L1, EK-RA4C1), reception is performed in normal mode
