...
| :-------------------------------------: | :---------------: | :------------: | :--------: |
| configuration.xml -> Stacks -> g_adc ADC (r_adc) -> Properties > Settings > Property > Module g_adc ADC (r_adc) > Input > Channel Scan Mask (channel availability varies by MCU) > Channel 2 | ☐ | ☑ | ADC input voltage supplied at available ADC channel (varies by MCU). |
| configuration.xml -> Stacks -> g_adc ADC (r_adc) -> Properties > Settings > Property > Module g_adc ADC (r_adc) > Input > Window Compare > Window A > Channels to compare (channel availability varies by MCU and unit) > Channel 2 | ☐ | ☑ | ADC Compares the input voltage supplied at the ADC input channel with upper and lower boundaries of the Window. |
...
| configuration.xml -> Stacks -> g_adc ADC (r_adc) -> Properties > Settings > Property > Pins > AN002 | None | P004 | ADC input voltage supplied at available ADC channel (varies by MCU). |
## API Usage ##
