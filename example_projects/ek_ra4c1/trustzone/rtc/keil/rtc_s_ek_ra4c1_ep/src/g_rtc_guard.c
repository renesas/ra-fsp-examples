...
BSP_CMSE_NONSECURE_ENTRY fsp_err_t g_rtc_calendar_alarm_set_guard(rtc_ctrl_t *const p_ctrl,
...
BSP_CMSE_NONSECURE_ENTRY fsp_err_t g_rtc_calendar_alarm_get_guard(rtc_ctrl_t *const p_ctrl,
        rtc_alarm_time_t *const p_alarm)
{
    /* Verify all pointers are in non-secure memory. */
    rtc_alarm_time_t *const p_alarm_checked = cmse_check_pointed_object (p_alarm, CMSE_AU_NONSECURE);
...
BSP_CMSE_NONSECURE_ENTRY fsp_err_t g_rtc_periodic_irq_rate_set_guard(rtc_ctrl_t *const p_ctrl,
...
BSP_CMSE_NONSECURE_ENTRY fsp_err_t g_rtc_error_adjustment_set_guard(rtc_ctrl_t *const p_ctrl,
        rtc_error_adjustment_cfg_t const *const err_adj_cfg)
{
    /* Verify all pointers are in non-secure memory. */
    rtc_error_adjustment_cfg_t const *const err_adj_cfg_checked = cmse_check_pointed_object (
            (rtc_error_adjustment_cfg_t*) err_adj_cfg, CMSE_AU_NONSECURE);
...
BSP_CMSE_NONSECURE_ENTRY fsp_err_t g_rtc_callback_set_guard(rtc_ctrl_t *const p_ctrl,
        void (*p_callback)(rtc_callback_args_t*), void *const p_context, rtc_callback_args_t *const p_callback_memory)
{
    /* Verify all pointers are in non-secure memory. */
    void (*p_callback_checked)(
            rtc_callback_args_t*) = (void(*)(rtc_callback_args_t *)) cmse_check_address_range((void *) p_callback, \
			                        sizeof(void *), CMSE_AU_NONSECURE);
