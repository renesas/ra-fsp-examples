    ...
    do
    {
        ...
        if (err == UX_SUCCESS)
        {
            ...
            switch (rtt_op_data->msg_id)
            {
                ...
                {
                    /* Prints data from printer buffer to RTT/printer one by one */
...
/*******************************************************************************************************************//**
 * @brief     This function is called by the user/application thread. It can be invoked from any user thread when
 *            the user wants to print a message to the RTT interface (e.g., RTT Viewer).
...
/*******************************************************************************************************************//**
 * @brief      Waits for the RTT thread to initialize and sleeps briefly before sending data to it.
 *             This function must be called from a user thread.
 * @param[in]  None
 * @retval     None
 **********************************************************************************************************************/
