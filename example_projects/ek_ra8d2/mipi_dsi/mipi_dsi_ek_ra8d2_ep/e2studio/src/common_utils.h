...
#define EP_INFO   "\r\nThis example project demonstrates the basic functionalities of the MIPI DSI device driver\r\n"\
                  ...
                  "the graphics and MIPI-DSI modules in FSP. A user menu will be provided over the RTT Viewer.\r\n"\
                  "The user can select the time to enter Ultra-Low-Power State (ULPS) and touch the screen to exit\r\n"\
                  "this mode. Status information and error messages will be printed on J-Link RTT Viewer during\r\n"\
