 ...
 * Description  : Contains declarations of data structures and functions used in NetX_wifi_ep.c.
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
#define EP_INFO             "\r\nThe example project demonstrates the functionalities of Wifi using Azure" \
		                    "\r\nRTOS NetX Duo running on Renesas RA MCUs using Renesas Silex UART Pmod hardware." \
...
#define USER_LED (BSP_IO_PORT_02_PIN_07)
