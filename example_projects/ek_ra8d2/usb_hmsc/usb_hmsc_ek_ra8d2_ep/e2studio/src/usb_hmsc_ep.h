...
void process_usb_operation(uint8_t p_input_buffer);     /* Process USB operations */
void usb_write_operation(void);                         /* Perform USB write operation */
void usb_read_operation(void);                          /* Perform USB read operation */
void format_usb_device(void);                           /* Perform USB format operation */
bool check_usb_connection(void);                        /* Check the USB connection status */
void usb_safely_eject(void);                            /* Perform USB Safely disconnect operation */
...
void fat_clean_up(void);                                /* Close FreeRTOS+FAT */
