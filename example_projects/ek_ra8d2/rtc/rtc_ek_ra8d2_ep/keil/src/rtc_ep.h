...
#define EP_INFO             "\r\nThe example project demonstrates the typical use of the RTC HAL module APIs."\
                            "\r\nThe project initializes the RTC module and allows the user to set RTC calendar time"\
                            "\r\nand calendar alarm. The user can enable periodic interrupt and can also view"\
                            "\r\nthe current RTC calendar time. On enabling periodic interrupt, on-board LED toggles"\
                            "\r\nevery 1 second and on occurrence of calendar alarm, LED is turned ON.\r\n"
