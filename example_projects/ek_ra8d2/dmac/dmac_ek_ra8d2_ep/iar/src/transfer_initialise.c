...
#elif defined(BOARD_RA6M4_EK) || defined (BOARD_RA4M3_EK) || defined (BOARD_RA8P1_EK) || defined (BOARD_RA8D2_EK)
/* LED Port data array for EK-RA6M4, EK-RA4M3, EK-RA8P1 and EK-RA8D2 */
uint32_t g_source_data[SOURCE_DATA_SIZE]=
{
...
/*******************************************************************************************************************//**
 *  @brief      Initialize DMAC transfer instance based on transfer unit and enable for transfer.
 ...
 *  @retval     Any other error code apart from FSP_SUCCESS     Failed to open or enable.
 **********************************************************************************************************************/
...
/*******************************************************************************************************************//**
 *  @brief      De-initialize DMAC transfer instance based on transfer unit and enable for transfer.
 *  @param[in]  p_transfer_ctl       Transfer instance control structure.
 *  @param[in]  transfer_unit        DMAC transfer unit.
 *  @retval     None
 **********************************************************************************************************************/
 ...
 *  @param[in]  p_transfer_ctrl     Transfer control block.
 *  @retval     FSP_SUCCESS         Upon successful start of DMAC.
 *  @retval     Any other error code apart from FSP_SUCCESS    Failed to start.
 **********************************************************************************************************************/
