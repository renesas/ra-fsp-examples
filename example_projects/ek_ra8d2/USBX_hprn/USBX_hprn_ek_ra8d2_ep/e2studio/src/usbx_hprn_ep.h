...
#define EP_INFO        "\r\nThis project demonstrates the basic functionality of USBX HPRN Module running on\r\n"\
                       "Renesas RA MCUs based on Renesas FSP using AzureRTOS. The user will be able to\r\n"\
                       "use the RA board as a Host device by connecting it to the printer device. Status\r\n"\
                       "of application (printer information and error messages) will be displayed on\r\n"\
                       "J-Link RTT Viewer.\r\n"\
