...
#define PRINT_VOLUME_INFO(info)         (send_data_to_rtt(RTT_OUTPUT_APP_MEDIA_VOLUME_INFO, sizeof(volume_info_t),\
                                                          &(info)))
#define PRINT_ENTRY_INFO(info)          (send_data_to_rtt(RTT_OUTPUT_APP_ENTRY_INFO, sizeof(entry_info_t), &(info)))
#define PRINT_DIR_PROPERTY(property)    (send_data_to_rtt(RTT_OUTPUT_APP_DIR_PROPERTY, sizeof(dir_property_t),\
                                                          &(property)))
