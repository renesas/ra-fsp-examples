...
1) Timer period range in millisecond as per EP configuration:
   ...
   h. EK-RA8P1, MCK-RA8T2, EK-RA8D2 (GPT Src: PCLKD (250 MHz))                  -- (0 to 17179) ms
   i. FPB-RA2T1, EK-RA4C1                                                       -- (0 to 1048)  ms
   k. EK-RA8D2 (GPT Src: GPTCLK (300 MHz))                                      -- (0 to 14316) ms

2) For EK-RA8D2, the user can select GPT Clock Source as GTPCLK or PCLKD through:
