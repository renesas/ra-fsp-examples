...
#define USB_WRITE              (1u)              /* RTT input selection for re-initialization of USB */
#define USB_READ               (2u)              /* RTT input selection for read operation */
...
#define MENU                   "\r\n USB HMSC Menu options\r\n"\
                               "\r\n 1. Write the content to file\r\n"\
                               "\r\n 2. Read the content from file\r\n"\
