...
extern const sensor_reg_t g_ov3640_qvga[];
#else
...
#if defined (BOARD_RA8E1_FPB)
extern const uint32_t g_ov3640_qvga_color_one_line[];
#else
...
static fsp_err_t ceu_check_image (uint8_t * const p_buffer, uint32_t width, uint32_t height)
{
    ...
    {
        p_one_line = (uint32_t *)g_ov3640_qvga_color_one_line;
    }
#else
...
void selection_menu (void)
{
    ...
    while(true)
    {
        if(APP_CHECK_DATA)
        {
            ...
            gp_ov3640_resolution = g_ov3640_qvga;
