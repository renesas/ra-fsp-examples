...
void hal_entry(void)
{
    ...
    {
        APP_PRINT("\r\nPOEG1 initialized successfully for GTETRG pin trigger, software api and acmphs mode\r\n");
    }
    ...
    if (FSP_SUCCESS != err)
    {
        ...
        /* De-initialize the POEG0, POEG1 */
        deinit_poeg_module();
        /* De-initialize the GPT timer1, GPT timer2, GPT timer3 */
        deinit_gpt_timer(&g_timer_pwm1_ctrl);
        deinit_gpt_timer(&g_timer_pwm2_ctrl);
...
void channel0_user_callback (poeg_callback_args_t * p_args)
{
    ...
    #if defined(BOARD_RA4T1_MCK) || defined(BOARD_RA6T1_RSSK) || defined(BOARD_RA6T2_MCK) || defined(BOARD_RA6T3_MCK) \
