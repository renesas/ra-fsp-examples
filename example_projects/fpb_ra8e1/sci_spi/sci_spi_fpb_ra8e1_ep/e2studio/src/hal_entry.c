...
#if defined(BOARD_RA6M2_EK) || defined(BOARD_RA6M1_EK) || defined(BOARD_RA4M1_EK) || defined(BOARD_RA6T1_RSSK) || defined (BOARD_RA2L1_EK) || defined (BOARD_RA4W1_EK) || defined (BOARD_RA2E2_EK) || defined(BOARD_RA2E3_FPB) || defined(BOARD_RA4E1_FPB)
