...
void hal_entry(void) {
    ...
    APP_PRINT("\r\n In this project Internal Reference Voltage (Vref) is used as reference voltage source"
            ...
            "\r\n User can enter DAC0 value within permitted range to provide an analog signal input for AN000."
...
#if defined (BOARD_RA6T1_RSSK) || defined (BOARD_RA4T1_MCK) || defined (BOARD_RA6T2_MCK) || defined (BOARD_RA6T3_MCK) || defined (BOARD_RA8T1_MCK)
