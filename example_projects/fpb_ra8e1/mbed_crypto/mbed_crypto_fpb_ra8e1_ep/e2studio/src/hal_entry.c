...
psa_status_t sha_operation(void)
{
    ...
    psa_hash_operation_t operation;     // operation object to set up for Hash operation.
...
{
    psa_status_t             status         = (psa_status_t)RESET_VALUE;
    psa_hash_operation_t     hash_operation; // operation object to set up for Hash operation.
