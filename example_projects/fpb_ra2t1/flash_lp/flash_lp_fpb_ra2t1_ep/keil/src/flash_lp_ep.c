...
/*******************************************************************************************************************//**
 * @brief       Close the Flash_LP module.
...
/*******************************************************************************************************************//**
 * @brief       Take block number input from the user for access windows operations.
 * @param[IN]  	None.
...
static uint8_t block_num_input(void)
{
    ...
    APP_PRINT("\r\nEnter block number greater than 9 for Access Window operations\r\n");
    while ((FLASH_CF_BLOCK10 > FLASH_CF_BLOCK(block_num)) || (FLASH_CF_BLOCK_PRE_END < FLASH_CF_BLOCK(block_num)))
    {
        ...
        {
            APP_PRINT("\r\nEntered code flash block number is not valid \r\n");
            APP_PRINT("Please enter valid block number must be greater than 9 \r\n");
            num_bytes = RESET_VALUE;
            continue;
        }

        /* Code flash block number validation */
        /* Code flash block end number should be than 1 block from the block end */
...
/*******************************************************************************************************************//**
 *  @brief      Flash LP callback function
 *  @param[in]  p_args
 *  @retval     None
 **********************************************************************************************************************/
