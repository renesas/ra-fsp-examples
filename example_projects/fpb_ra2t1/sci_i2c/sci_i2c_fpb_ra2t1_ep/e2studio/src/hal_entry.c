...
void hal_entry(void)
{
    ...
    if(FSP_SUCCESS != err)
    {
        /* SCI_I2C Master and IIC Slave initialize failed */
        APP_ERR_PRINT("\r\n ** init_i2c_driver failed ** \r\n");
    ...
    while(true)
    {
        ...
        if (FSP_SUCCESS != err)
        {
            ...
            /* Print RTT message */
            APP_ERR_PRINT ("\r\n **"SCI_TYPE"_I2C Master transaction failed, closing opened modules ** \r\n");
		...
		/* 1 second wait time to recognize LED toggling between successive write and read operations */
