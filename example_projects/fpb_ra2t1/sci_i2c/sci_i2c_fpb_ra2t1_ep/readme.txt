...
1. Project Overview:
	...
	The transmitted data is compared with the received data. If the data matches, on-board LEDs start blinking.
	On a data mismatch, the LEDs stay ON.
	Failure messages and status are displayed on RTT Viewer.

2. Hardware Requirements:
	1 x Renesas RA board.
	1 x Type-C USB cable for debugging and programing.
	2 x Jumper wires.
...
3. Hardware Connections:
	...
	For EK-RA8E2:
	-----------
		Channel 1 has been used by SCI_I2C Master and IIC Slave.
		1) SCI_I2C Master pins
			SCI1 P401 (J2:3)   ----> SCL
			SCI1 P400 (J2:2)   ----> SDA
		2) Slave IIC pins
	...
	-----------
		...
		1) SCI_I2C Master pins
			...
			SCI0 P101 (J4:11) ----> SDA
		2) Slave IIC pins
			Close E6 and Cut E5 to pull up the SDA0 P401 and SCL0 P400 pins
			IIC0 P400 (J3:1)  ----> SCL
			IIC0 P401 (J3:2)  ----> SDA

Note:
1) a. For the functioning of SCI_I2C Master and IIC Slave on all the boards except for EK-RA6M3, EK-RA6M3G, FPB-RA6E1,
      FPB-RA4E1, FPB-RA2E3, MCK-RA8T1, EK-RA2A2, FPB-RA8E1, EK-RA4L1, EK-RA8E2, FPB-RA2T1 external pull up resistors of 
