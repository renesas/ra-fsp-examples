...
1. Project Overview:
	...
	any input on the RTT Viewer, AGT channel 0 starts in One-Shot mode. AGT channel 1 starts in Periodic mode
	when AGT channel 0 expires. Timer in Periodic mode expires periodically at a time period specified by the
	user and toggles the on-board LED.
