...
#else
#define EP_INFO                "\r\nThis Example Project demonstrates the basic usage of ELC driver."\
                               "\r\nELC Software Event, GPT0 and GPT2 events are linked using ELC."\
                               "\r\nThe start source for GPT0 and GPT2 is ELC Software Event and the "\
                               "\r\nstop source for GPT0 is GPT2 counter overflow."\
                               "\r\nGPT0 runs in PWM mode and GPT2 runs in One-Shot mode."\
                               "\r\nOn giving valid RTT Viewer input, an ELC Software Event is generated that triggers"\
                               "\r\nLED blinking. LED stops blinking after 5 seconds when GPT2 expires.\r\n"
