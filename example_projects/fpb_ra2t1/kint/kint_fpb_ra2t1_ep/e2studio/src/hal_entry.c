...
void hal_entry(void)
{
    ...
    APP_PRINT("\r\n ** KINT is open and enabled now. Press a key on the keypad attached to the MCU. ** \r\n");
    ...
    while (true)
    {
        if (RESET_VALUE != g_kint_signal)
        {
             ...
             * routine where the keypad signal was being processed and continue with the previous
             * KINT event without losing it. */
            ...
            {
#if defined (BOARD_RA6T1_RSSK) || defined (BOARD_RA2E2_EK) || defined (BOARD_RA2E3_FPB) || defined(BOARD_RA6T2_MCK) ||\
...
#elif defined (BOARD_RA2E2_EK) || defined (BOARD_RA2E3_FPB) || defined(BOARD_RA6T2_MCK) || defined (BOARD_RA2T1_FPB)
                case CH_MASK_1:
...
/*******************************************************************************************************************//**
 *  @brief       Scan rows when channel mask received from KINT user callback
