...
typedef enum
{
    COL_DISP_A_ = 0x41, COL_DISP_B_ = 0x42
} col_identifier_t;
...
/* Keypad pin details */
#define ROW_A                       ((bsp_io_port_pin_t) BSP_IO_PORT_01_PIN_11)
#define ROW_B                       ((bsp_io_port_pin_t) BSP_IO_PORT_01_PIN_12)
#define COL_A                       ((bsp_io_port_pin_t) BSP_IO_PORT_01_PIN_10)
#define COL_B                       ((bsp_io_port_pin_t) BSP_IO_PORT_01_PIN_09)

/* Row and column bit position */
#define COL_A_BIT                   (10U) /* P110 */
#define COL_B_BIT                   (9U)  /* P109 */
#define ROW_A_BIT                   (11U) /* P111 */
#define ROW_B_BIT                   (12U) /* P112 */

#elif defined (BOARD_RA6T2_MCK)
#define KEYPAD_PORT                 ((bsp_io_port_t) BSP_IO_PORT_10)

/* Keypad pin details */
#define ROW_A                       ((bsp_io_port_pin_t) BSP_IO_PORT_10_PIN_10)
#define ROW_B                       ((bsp_io_port_pin_t) BSP_IO_PORT_10_PIN_11)
#define COL_A                       ((bsp_io_port_pin_t) BSP_IO_PORT_10_PIN_08)
#define COL_B                       ((bsp_io_port_pin_t) BSP_IO_PORT_10_PIN_09)

/* Row and column bit position */
#define COL_A_BIT                   (8U)  /* PA08 */
#define COL_B_BIT                   (9U)  /* PA09 */
#define ROW_A_BIT                   (10U) /* PA10 */
#define ROW_B_BIT                   (11U) /* PA11 */

#elif defined (BOARD_RA2E3_FPB) || defined (BOARD_RA2T1_FPB)
#define KEYPAD_PORT                 ((bsp_io_port_t) BSP_IO_PORT_01)

/* Keypad pin details */
#define ROW_A                       ((bsp_io_port_pin_t) BSP_IO_PORT_01_PIN_02)
#define ROW_B                       ((bsp_io_port_pin_t) BSP_IO_PORT_01_PIN_03)
#define COL_A                       ((bsp_io_port_pin_t) BSP_IO_PORT_01_PIN_00)
#define COL_B                       ((bsp_io_port_pin_t) BSP_IO_PORT_01_PIN_01)

/* Row and column bit position */
#define COL_A_BIT                   (0U)  /* P100 */
#define COL_B_BIT                   (1U)  /* P101 */
#define ROW_A_BIT                   (2U)  /* P102 */
#define ROW_B_BIT                   (3U)  /* P103 */
...
#define ROW_A                       ((bsp_io_port_pin_t) BSP_IO_PORT_01_PIN_01)
#define ROW_B                       ((bsp_io_port_pin_t) BSP_IO_PORT_01_PIN_02)
#define COL_A                       ((bsp_io_port_pin_t) BSP_IO_PORT_01_PIN_03)
#define COL_B                       ((bsp_io_port_pin_t) BSP_IO_PORT_01_PIN_06)

/* Row and column bit position */
#define COL_A_BIT                   (3U)  /* P103 */
#define COL_B_BIT                   (6U)  /* P106 */
#define ROW_A_BIT                   (1U)  /* P101 */
#define ROW_B_BIT                   (2U)  /* P102 */
...
#define EP_INFO                "\r\n\r\nThe Project demonstrates KINT module functionality for processing \r\n"\
                               ...
                               " is detected and displayed on J-Link RTT Viewer\r\n\r\n\r\n"
