...
/*******************************************************************************************************************//**
 * @brief       This function closes the ADC driver and handles the return closing API error
 * @param[IN]   None
 * @retval      None
 **********************************************************************************************************************/
 ...
 *              deviation is observed continuously and exceeds set limit, triggers calibration again
 * @param[IN]   None
