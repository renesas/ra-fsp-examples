...
static void read_operation(void)
{
    ...
    switch (read_data)
    {
        case WRITE_READ_ID_1:
        {
            ...
            {
                handle_error(err, "\r\n** vee_read_operation failed for Record_ID1 **\r\n");
            }
            break;
        }
        ...
        case WRITE_READ_ID_2:
        {
            ...
            if ((FSP_SUCCESS != err) && (FSP_ERR_NOT_FOUND != err))
            {
                handle_error(err, "\r\n** vee_read_operation failed for Record_ID2 **\r\n");
            }
            break;
        }
        ...
        case WRITE_READ_ID_3:
        {
            ...
            if ((FSP_SUCCESS != err) && (FSP_ERR_NOT_FOUND != err))
            {
                handle_error(err, "\r\n** vee_read_operation failed for Record_ID3 **\r\n");
            }
            break;
        }
        ...
        case WRITE_READ_ID_4:
        {
            ...
            if ((FSP_SUCCESS != err) && (FSP_ERR_NOT_FOUND != err))
            {
                handle_error(err, "\r\n** vee_read_operation failed for Record_ID4 **\r\n");
            }
            break;
        }
