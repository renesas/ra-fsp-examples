...
/*******************************************************************************************************************//**
 *  @brief      Performs CRC calculation in normal and snoop mode and toggles LED on successful operation
 *              else turns LED ON on failure. Also displays failure messages in RTT.
 *  @param[IN]  None
...
static fsp_err_t crc_operation (void)
{
	...
	/* Board not support CRC snoop mode */
        ...
        /* Perform SCI UART (EK-RA4E2, EK-RA6E2, MCK-RA4T1, MCK-RA6T3, EK-RA4L1) loop-back
...
#if defined (BSP_PERIPHERAL_SAU_PRESENT)
