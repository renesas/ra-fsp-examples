...
2. Hardware Requirement:
	...
	1. RA MCU board
	2. 2x Micro USB cables (One for programming and debugging, one for connect between RA board and camera)
...
3. Hardware Connections:
    ...
    Supported Board (USB High Speed Required)
	- EK-RA6M3, EK-RA6M5, EK-RA8M1 and EK-RA8D1:		
...
4. Hardware settings for the project:
    ...
    Jumper Settings:
	- EK-RA6M3, EK-RA6M5, EK-RA8M1 and EK-RA8D1 (USB High Speed Required)
