...
namespace tflite {
    namespace reference_integer_ops {
        ...
        inline void ElementWise (int size,
        ...
        inline void BroadcastBinaryFunction4DSlow (const ArithmeticParams &params,
                    ...
                    for (int x = 0; x < extended_output_shape.Dims(2); ++x)
                    {
                        for (int c = 0; c < extended_output_shape.Dims(3); ++c)
                        {
                            output_data[Offset(extended_output_shape, b, y, x, c)] =
                                binary_func(input1_data[SubscriptToIndex(desc1, b, y, x, c)],
...
// well as the non-broadcast add.
        inline void AddElementwise (int                     size,
                                    ...
                                    const int8_t          * input2_data,
                                    int8_t                * output_data) {
            ElementWise(size, params, input1_data, input2_data, output_data, CheckArithmeticParams, AddFunc);
        }
        ...
        inline void BroadcastAdd4DSlow (const ArithmeticParams &params,
                                        ...
                                        const RuntimeShape     &output_shape,
                                        int8_t                * output_data) {
            BroadcastBinaryFunction4DSlow(params,
                                          input1_shape,
                                          input1_data,
                                          input2_shape,
                                          input2_data,
