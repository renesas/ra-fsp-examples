...
#include <ai_apps/common/tensorflow/lite/micro/tflite_bridge/op_resolver_bridge.h>
...
public:
        ...
        const TfLiteRegistration * FindOp (BuiltinOperator op, int version) const final {
            return FindOp(op);
        }
