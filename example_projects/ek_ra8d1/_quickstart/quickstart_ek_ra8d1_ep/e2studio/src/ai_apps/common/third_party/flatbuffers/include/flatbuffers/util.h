...
public:
 ...
 #define __strtof_impl(s, pe)          static_cast < float > (strtod(s, pe))
  ...
  #define __strtoll_impl(s, pe, b)     strtoll(s, pe, b)
    ...
    inline void strtoval_impl (int64_t * val, const char * str, char ** endptr, int base) {
        *val = __strtoll_impl(str, endptr, base);
    }

    inline void strtoval_impl (uint64_t * val, const char * str, char ** endptr, int base) {
...
// range error occurs. In this case value MAX(T)/MIN(T) is returned.
    template < typename T >
    inline bool StringToIntegerImpl (T * val, const char * const str, const int base=0, const bool check_errno=true) {
...
// line, respectively.
    inline std::string WordWrap (const std::string in,
                                 size_t            max_length,
    ...
    inline std::string BufferToHexText (const void       * buffer,
                                        size_t             buffer_size,
                                        size_t             max_length,
                                        const std::string &wrapped_line_prefix,
                                        const std::string &wrapped_line_suffix) {
