...
// namespace to expose them for testing
    namespace lstm_internal {
        void CalculateLstmGateFloat(const float               * input,
        ...
        void UpdateLstmCellFloat(int           n_batch,
                                 int           n_cell,
                                 float       * cell_state,
        ...
        void CalculateLstmOutputFloat(int                   n_batch,
                                      int                   n_cell,
                                      int                   n_output,
                                      const float         * cell_state,
        ...
        void CalculateLstmGateInteger8x8_16(
            ...
            const int16_t * cell_to_gate_weights,
            const int32_t   cell_to_gate_scale_a,
            const int32_t   cell_to_gate_scale_b,
            // Layer normalization parameters (layer norm LSTM)
            const int16_t * layer_norm_coefficients,
            const int32_t * layer_norm_bias,
        ...
        void UpdateLstmCellInteger(int             n_batch,
                                   int             n_cell,
                                   int16_t       * cell_state,
                                   int32_t         cell_state_scale,
        ...
        void CalculateLstmOutputInteger8x8_16(int             n_batch,
                                              int             n_cell,
                                              int             n_output,
                                              int16_t       * cell_state,
                                              int32_t         cell_state_scale,
                                              const int16_t * output_gate,
                                              int32_t         hidden_scale_a,
                                              int32_t         hidden_scale_b,
                                              int32_t         hidden_zp,
                                              const int8_t  * projection_weights,
                                              int32_t         proj_scale_a,
                                              int32_t         proj_scale_b,
        ...
        void LstmStepFloat(const float            * input_ptr,
        ...
        void LstmStepInteger8x8_16(const int8_t  * input_ptr,
                                   ...
                                   const int32_t * input_gate_bias_ptr,
                                   const int32_t * forget_gate_bias_ptr,
                                   const int32_t * cell_gate_bias_ptr,
...
// Consider split this into two Integer Parameters if more fields are added.
    ...
    TfLiteStatus EvalFloatLstm(const TfLiteEvalTensor * input,
    ...
    TfLiteStatus EvalInteger8x8_16Lstm(const TfLiteEvalTensor     * input,
                                       const TfLiteEvalTensor     * input_to_input_weights,
                                       const TfLiteEvalTensor     * input_to_forget_weights,
                                       const TfLiteEvalTensor     * input_to_cell_weights,
                                       const TfLiteEvalTensor     * input_to_output_weights,
