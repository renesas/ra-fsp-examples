...
#include <ai_apps/common/tensorflow/lite/micro/arena_allocator/single_arena_buffer_allocator.h>
...
#include <ai_apps/common/tensorflow/lite/micro/tflite_bridge/flatbuffer_conversions_bridge.h>
...
public:
        ...
        static MicroAllocator * Create(uint8_t * tensor_arena, size_t arena_size, MicroMemoryPlanner * memory_planner);
...
protected:
        MicroAllocator(SingleArenaBufferAllocator * memory_allocator, MicroMemoryPlanner * memory_planner);
        ...
        // model.
        virtual TfLiteStatus AllocateNodeAndRegistrations(const Model         * model,
                                                          SubgraphAllocations * subgraph_allocations);
        ...
        virtual TfLiteStatus AllocateTfLiteEvalTensors(const Model * model, SubgraphAllocations * subgraph_allocations);
...
private:
        ...
        virtual TfLiteStatus AllocateScratchBufferHandles(ScratchBufferHandle ** scratch_buffer_handles,
                                                          size_t                 handle_count);
