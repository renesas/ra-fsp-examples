...
#include <ai_apps/common/tensorflow/lite/micro/arena_allocator/recording_single_arena_buffer_allocator.h>
...
protected:
        TfLiteStatus AllocateNodeAndRegistrations(const Model         * model,
                                                  SubgraphAllocations * subgraph_allocations) override;
        TfLiteStatus AllocateTfLiteEvalTensors(const Model         * model,
                                               SubgraphAllocations * subgraph_allocations) override;
