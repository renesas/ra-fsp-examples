...
// type.
    ...
    template < >
    inline __m128i SelectUsingMask (__m128i if_mask, __m128i then_val, __m128i else_val) {
    ...
    template < >
    inline int16x8_m128i SelectUsingMask (int16x8_m128i if_mask, int16x8_m128i then_val, int16x8_m128i else_val) {
        // borrowed from Intel's arm_neon_sse.h header.
    ...
    template < >
    inline int16x8_m128i MaskIfGreaterThanOrEqual (int16x8_m128i a, int16x8_m128i b) {
        return BitNot(MaskIfLessThan(a, b));
    }
