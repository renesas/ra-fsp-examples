...
namespace tflite {
    namespace reference_ops {
        template < typename T >
        inline void CumSum (const T           * input_data,
...
//
        inline void CumSum (const ArithmeticParams &params,
            ...
            for (size_t outer_index = 0; outer_index < outer; outer_index++)
            {
                ...
                for (size_t inner_index = 0; inner_index < inner; inner_index++)
                {
                    ...
                    accumulator  = MultiplyByQuantizedMultiplierSmallerThanOneExp(accumulator,
                    ...
                    for (size_t depth_index = 0; depth_index < depth; depth_index++)
                    {
                        ...
                        const int32_t scaled_y  = MultiplyByQuantizedMultiplierSmallerThanOneExp(shifted_y,
                                                                                                 params.input1_multiplier,
                                                                                                 params.input1_shift);
                        ...
                        const int32_t raw_output =
                            MultiplyByQuantizedMultiplierSmallerThanOneExp(scaled_output,
