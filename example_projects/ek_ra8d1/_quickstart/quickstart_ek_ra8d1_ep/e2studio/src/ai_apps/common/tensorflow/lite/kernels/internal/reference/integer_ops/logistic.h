...
namespace tflite {
    namespace reference_integer_ops {
        inline void Logistic (int32_t        input_zero_point,
            ...
            for (int i = 0; i < input_size; ++i)
            {
                ...
                else
                {
                    ...
                    output_in_q23 =
                        std::min(std::max(output_in_q23 + kOutputZeroPoint, static_cast < int32_t > (kMinInt8)),
        ...
        inline void Logistic (int32_t         input_multiplier,
                              int32_t         input_left_shift,
                              int32_t         input_size,
