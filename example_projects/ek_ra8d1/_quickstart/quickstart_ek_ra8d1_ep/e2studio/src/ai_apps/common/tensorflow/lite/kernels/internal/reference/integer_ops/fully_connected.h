...
// backward compatibility.
        ...
        inline void FullyConnectedPerChannel (const FullyConnectedParams &params,
            ...
            for (int b = 0; b < batches; ++b)
            {
                for (int out_c = 0; out_c < output_depth; ++out_c)
                {
                    ...
                    acc  = MultiplyByQuantizedMultiplier(acc, output_multiplier[out_c], output_shift[out_c]);
                    acc += output_offset;
        ...
        inline void FullyConnectedPerChannel (const FullyConnectedParams &params,
            ...
            for (int b = 0; b < batches; ++b)
            {
                for (int out_c = 0; out_c < output_depth; ++out_c)
                {
                    ...
                    int32_t acc_scaled = MultiplyByQuantizedMultiplier(acc,
        ...
        inline void FullyConnectedWithPackedInt4Weights (const FullyConnectedParams &params,
                                                         const RuntimeShape         &input_shape,
                                                         const int8_t              * input_data,
                                                         const RuntimeShape         &filter_shape,
                                                         const int8_t              * filter_data,
            ...
            tflite::tensor_utils::UnpackDenseInt4IntoInt8(filter_data, filter_shape.FlatSize(), unpacked_filter_data);
