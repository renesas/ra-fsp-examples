...
// well as the non-broadcast Div.
        template < typename T >
        inline void DivElementwise (int                     size,
            ...
            for (int i = 0; i < size; ++i)
            {
                ...
                const int32_t unclamped_result =
                    ...
                    MultiplyByQuantizedMultiplierSmallerThanOneExp(unscaled_quotient,
        ...
        template < typename T, int N = 5 >
                                       inline void BroadcastDivSlowQuantized (const ArithmeticParams &params,
