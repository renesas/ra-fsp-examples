...
#include <ai_apps/common/tensorflow/lite/kernels/kernel_util.h>

namespace tflite {
    namespace reference_ops {
        template < int N >
        void BroadcastImpl (const NdArrayDesc < N > &input_desc,
        ...
        inline void BroadcastTo (const RuntimeShape &unextended_input_shape,
            ...
            {
                memcpy(output_data, input_data, unextended_input_shape.FlatSize() * TfLiteTypeGetSize(data_type));
