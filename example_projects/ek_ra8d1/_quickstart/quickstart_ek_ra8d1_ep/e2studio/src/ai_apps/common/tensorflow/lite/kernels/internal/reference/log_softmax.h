...
namespace tflite {
    namespace reference_ops {
                ...
                for (int c = 0; c < depth; ++c)
                {
                    ...
                    if (input_diff >= diff_min)
                    {
                        const int32_t input_diff_rescaled =
                            MultiplyByQuantizedMultiplierGreaterThanOne(input_diff, input_multiplier, input_left_shift);
                ...
                for (int c = 0; c < depth; ++c)
                {
                    ...
                    if (input_diff > adjusted_diff_min)
                    {
                        ...
                        int32_t unsat_output =
                            gemmlowp::RoundingDivideByPOT((input_diff_rescaled - fixed_log_sum_of_exps),
        ...
        inline void LogSoftmaxQuantized (const SoftmaxParams &params,
            ...
            for (size_t outer_index = 0; outer_index < outer_size; ++outer_index)
            {
                ...
                for (size_t inner_index = 0; inner_index < depth; ++inner_index)
                {
                    ...
                    if (input_diff >= diff_min)
                    {
                        const int32_t input_diff_in_q5 = MultiplyByQuantizedMultiplier(input_diff,
                                                                                       input_multiplier,
                                                                                       input_left_shift);
                        sum_of_exps_in_q12 =
                            sum_of_exps_in_q12 +
                ...
                const int32_t adjusted_diff_min =
                    std::max(static_cast < int32_t > (diff_min - 1),
                             MultiplyByQuantizedMultiplier(shifted_log_sum_of_exps_in_q5, reverse_scaling_divisor,
                                                           -reverse_scaling_right_shift));
                ...
                for (size_t inner_index = 0; inner_index < depth; ++inner_index)
                {
                    ...
                    if (input_diff > adjusted_diff_min)
                    {
                        ...
                        int32_t output_in_q27 =
                            gemmlowp::RoundingDivideByPOT((input_diff_in_q5 - log_sum_of_exps_in_q5),
        ...
        inline void LogSoftmax (const SoftmaxParams &params,
                                ...
                                const RuntimeShape  &output_shape,
                                int8_t             * output_data) {
            LogSoftmaxQuantized(params, outer_size, depth, input_shape, input_data, output_shape, output_data);
        }
    }                                  // namespace reference_ops
}                                      // namespace tflite
