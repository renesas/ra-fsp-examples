...
// Single-rounding MultiplyByQuantizedMultiplier
            ...
            inline int32_t DepthwiseConvRound < DepthwiseConvOutputRounding::kAwayFromZero > (
                ...
                return RoundingDivideByPOT(SaturatingRoundingDoublingHighMul(x * (1 << left_shift),
...
// Double-rounding MultiplyByQuantizedMultiplier
            ...
            struct DepthwiseConvBasicKernel
            {
                ...
                static inline void RunPerChannel (const DepthwiseParams &params,
                                                  const RuntimeShape    &input_shape,
        ...
        inline void DepthwiseConv (const DepthwiseParams &params,
            ...
            return depthwise_conv::DepthwiseConvBasicKernel <
                   DepthwiseConvOutputRounding::kAwayFromZero > ::Run(params,
                                                                      input_shape,
                                                                      input_data,
                                                                      filter_shape,
                                                                      filter_data,
