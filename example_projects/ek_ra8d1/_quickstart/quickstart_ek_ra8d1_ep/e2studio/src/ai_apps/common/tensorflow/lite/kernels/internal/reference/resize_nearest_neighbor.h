...
namespace tflite {
    namespace reference_ops {
        inline int32_t GetNearestNeighbor (const int     input_value,
            ...
            int32_t     output_value = std::min(align_corners ?
        ...
        template < typename T >
        inline void ResizeNearestNeighbor (const tflite::ResizeNearestNeighborParams &op_params,
            ...
            for (int b = 0; b < batches; ++b)
            {
                ...
                {
                    int32_t in_y = GetNearestNeighbor(y,
                                                      input_height,
                                                      output_height,
                    ...
                    {
                        int32_t in_x = GetNearestNeighbor(x,
                                                          input_width,
                                                          output_width,
                                                          op_params.align_corners,
                                                          op_params.half_pixel_centers);
