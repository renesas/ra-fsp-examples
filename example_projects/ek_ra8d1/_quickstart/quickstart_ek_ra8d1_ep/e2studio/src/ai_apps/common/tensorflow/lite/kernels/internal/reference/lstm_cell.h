...
#include <ai_apps/common/tensorflow/lite/kernels/internal/reference/concatenation.h>
#include <ai_apps/common/tensorflow/lite/kernels/internal/reference/fully_connected.h>
    ...
    namespace reference_ops {
        inline void LstmCell (const LstmCellParams &params,
            ...
            const int output_depth =
                MatchingDim(prev_state_shape, 3, prev_activ_shape, 3, output_state_shape, 3, output_activ_shape, 3);
            TFLITE_DCHECK_EQ(output_depth, intern_activ_depth / 4);

            // Concatenate prev_activ and input data together
            float const        * concat_input_arrays_data[2]   = {input_data, prev_activ_data};
            const RuntimeShape * concat_input_arrays_shapes[2] =
            {
                &input_shape,
                &prev_activ_shape
            };
            ...
            Concatenation(concat_params,
                          concat_input_arrays_shapes,
...
//
        ...
        inline void LstmCell (const LstmCellParams &params,
            ...
            const int weights_dim_count = weights_shape.DimensionsCount();
            const int outer_size        = MatchingFlatSizeSkipDim(input_shape,
                                                                  3,
                                                                  prev_activ_shape,
                                                                  prev_state_shape,
                                                                  output_state_shape,
            ...
            uint8_t const * concat_input_arrays_data[2] =
            {
                input_data_uint8,
