...
namespace tflite {
    namespace reference_ops {
        ...
        inline void ComputeInterpolationValuesInteger (const int32_t value,
...
// Same as above but doesn't use any floating-point for the resize
        template < typename T >
        inline void ResizeBilinearInteger (const tflite::ResizeBilinearParams &op_params,
                                           const RuntimeShape                 &unextended_input_shape,
                                           const T                           * input_data,
                                           const RuntimeShape                 &unextended_output_size_shape,
                                           const int32_t                     * output_size_data,
            ...
            for (int b = 0; b < batches; ++b)
            {
                for (int y = 0; y < output_height; ++y)
                {
                    ...
                    ComputeInterpolationValuesInteger(y,
                                                      height_scale_10,
                                                      op_params.half_pixel_centers,
                                                      input_height,
                                                      &input_y,
                    ...
                    for (int x = 0; x < output_width; ++x)
                    {
                        ...
                        ComputeInterpolationValuesInteger(x,
                                                          width_scale_10,
                                                          op_params.half_pixel_centers,
                                                          input_width,
                                                          &input_x,
