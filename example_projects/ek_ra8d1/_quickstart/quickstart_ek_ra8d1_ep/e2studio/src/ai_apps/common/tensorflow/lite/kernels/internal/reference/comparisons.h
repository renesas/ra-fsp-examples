...
namespace tflite {
    namespace reference_ops {
        ...
        inline void ComparisonImpl (const ComparisonParams &op_params,
        ...
        inline void ComparisonWithScaling (const ComparisonParams &op_params,
                                           const RuntimeShape     &input1_shape,
                                           const T               * input1_data,
                                           const RuntimeShape     &input2_shape,
                                           const T               * input2_data,
            ...
            for (int64_t i = 0; i < flatsize; ++i)
            {
                ...
                const int32_t scaled_input1_val  =
                    MultiplyByQuantizedMultiplierSmallerThanOneExp(shifted_input1_val, input1_multiplier, input1_shift);
                const int32_t scaled_input2_val =
                    MultiplyByQuantizedMultiplierSmallerThanOneExp(shifted_input2_val, input2_multiplier, input2_shift);
        ...
        inline BroadcastComparison4DSlowCommon BroadcastComparison4DSlowPreprocess (
            ...
            return {
                       RuntimeShape::ExtendedShape(4, unextended_output_shape), desc1,
                       desc2
            };
        }

        template < typename T, ComparisonFn < T > F >
        inline void BroadcastComparison4DSlowImpl (const ComparisonParams &op_params,
                                                   const RuntimeShape     &unextended_input1_shape,
                                                   const T               * input1_data,
                                                   const RuntimeShape     &unextended_input2_shape,
                                                   const T               * input2_data,
        ...
        template < typename T, ComparisonFn < int32_t > F >
        inline void BroadcastComparison4DSlowWithScaling (const ComparisonParams &op_params,
                                                          const RuntimeShape     &unextended_input1_shape,
                                                          const T               * input1_data,
                                                          const RuntimeShape     &unextended_input2_shape,
                                                          const T               * input2_data,
...
#define TFLITE_COMPARISON_OP(name)                                                        \
    ...
    template < typename T >                                                               \
    inline void name ## NoScaling(const ComparisonParams &op_params,                      \
                                  const RuntimeShape &input1_shape,                       \
                                  const T * input1_data,                                  \
                                  const RuntimeShape &input2_shape,                       \
                                  const T * input2_data,                                  \
    ...
    template < typename T >                                                               \
    inline void name ## WithScaling(const ComparisonParams &op_params,                    \
                                    const RuntimeShape &input1_shape,                     \
                                    const T * input1_data,                                \
                                    const RuntimeShape &input2_shape,                     \
                                    const T * input2_data,                                \
    ...
    template < typename T >                                                               \
    inline void Broadcast4DSlow ## name ## NoScaling(const ComparisonParams &op_params,   \
                                                     const RuntimeShape &input1_shape,    \
                                                     const T * input1_data,               \
                                                     const RuntimeShape &input2_shape,    \
                                                     const T * input2_data,               \
    ...
    inline void Broadcast4DSlow ## name(const ComparisonParams &op_params,                \
                                        const RuntimeShape &input1_shape,                 \
                                        const float * input1_data,                        \
                                        const RuntimeShape &input2_shape,                 \
                                        const float * input2_data,                        \
    ...
    template < typename T >                                                               \
    inline void Broadcast4DSlow ## name ## WithScaling(const ComparisonParams &op_params, \
                                                       const RuntimeShape &input1_shape,  \
                                                       const T * input1_data,             \
                                                       const RuntimeShape &input2_shape,  \
                                                       const T * input2_data,             \
