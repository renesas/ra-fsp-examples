        ...
        template < int N = 5 >
            ...
            auto sub_func = [&](int indexes[N]) {
                output_data[SubscriptToIndex(output_desc, indexes)] =
                    ActivationFunctionWithMinMax(input1_data[SubscriptToIndex(desc1, indexes)] -
        ...
        template < typename T, int N = 5 >
            ...
            auto sub_func = [&](int indexes[N]) {
                ...
                const int32_t raw_output =
                    MultiplyByQuantizedMultiplierSmallerThanOneExp(raw_sub,
...
// well as the non-broadcast add.
        template < typename T >
        inline void SubElementwise (int                     size,
        ...
        template < typename T >
        void Sub (const ArithmeticParams &params,
                  const RuntimeShape     &input1_shape,
                  const T               * input1_data,
                  const RuntimeShape     &input2_shape,
                  const T               * input2_data,
        ...
        inline void SetActivationMinMax (const ArithmeticParams &params, float * activation_min,
