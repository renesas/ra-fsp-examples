...
#include <ai_apps/common/third_party/flatbuffers/include/flatbuffers/array.h>
#include <ai_apps/common/third_party/flatbuffers/include/flatbuffers/base.h>
#include <ai_apps/common/third_party/flatbuffers/include/flatbuffers/buffer_ref.h>
#include <ai_apps/common/third_party/flatbuffers/include/flatbuffers/default_allocator.h>
#include <ai_apps/common/third_party/flatbuffers/include/flatbuffers/detached_buffer.h>
#include <ai_apps/common/third_party/flatbuffers/include/flatbuffers/stl_emulation.h>
#include <ai_apps/common/third_party/flatbuffers/include/flatbuffers/string.h>
#include <ai_apps/common/third_party/flatbuffers/include/flatbuffers/struct.h>
#include <ai_apps/common/third_party/flatbuffers/include/flatbuffers/table.h>
#include <ai_apps/common/third_party/flatbuffers/include/flatbuffers/vector.h>
#include <ai_apps/common/third_party/flatbuffers/include/flatbuffers/vector_downward.h>
#include <ai_apps/common/third_party/flatbuffers/include/flatbuffers/verifier.h>
#include <functional>
...
public:
        ...
        Offset < Vector <
        const T * >> CreateVectorOfNativeStructs(const S * v, size_t len, T(*const pack_func) (const S &))
        {
        ...
        template < typename T >
        Offset < Vector <
        const T * >> CreateVectorOfStructs(size_t vector_size, const std::function < void(size_t i, T *) > &filler)
        {
        ...
        template < typename T, typename S, typename Alloc = std::allocator < T >>
                                                            Offset < Vector <
                                                            const T * >> CreateVectorOfSortedNativeStructs(
            std::vector < S,
            Alloc > *v)
        {
