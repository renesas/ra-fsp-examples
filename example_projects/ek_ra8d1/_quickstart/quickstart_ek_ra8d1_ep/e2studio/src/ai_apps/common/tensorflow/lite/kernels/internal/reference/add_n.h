...
// T is expected to be either float or int.
        template < typename T >
        inline void AddN (const RuntimeShape &input_shape,
        ...
        inline void AddN (const ArithmeticParams &params,
            ...
            for (size_t i = 0; i < size; ++i)
            {
                ...
                int32_t       scaled_x  = MultiplyByQuantizedMultiplierSmallerThanOneExp(shifted_x,
                ...
                for (size_t j = 0; j < num_inputs; ++j)
                {
                    ...
                    int32_t       scaled_y  = MultiplyByQuantizedMultiplierSmallerThanOneExp(shifted_y,
                                                                                             params.input1_multiplier,
                                                                                             params.input1_shift);
                    scaled_x += scaled_y;
                }
                ...
                const int32_t raw_output =
                    MultiplyByQuantizedMultiplierSmallerThanOneExp(scaled_x,
