...
#include <ai_apps/common/tensorflow/lite/micro/fake_micro_context.h>
#include <ai_apps/common/tensorflow/lite/micro/mock_micro_graph.h>
...
// output provided during construction.
        class KernelRunner {
public:
            KernelRunner(const TfLiteRegistration &registration,
