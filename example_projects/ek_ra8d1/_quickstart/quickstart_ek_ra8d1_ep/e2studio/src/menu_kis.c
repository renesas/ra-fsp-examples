...
extern void enable_temprature_update(void);
extern void disable_temprature_update(void);
...
test_fn kis_display_menu (void)
{
    ...
    sprintf(s_print_buffer,
            ...
            PART_NUMBER,
            DEVICE_NUMBER,
            (int_t) p_uid->unique_id_words[0],
            (int_t) p_uid->unique_id_words[1], // typedef uint_t in stdint.h
            (int_t) p_uid->unique_id_words[2],
            (int_t) p_uid->unique_id_words[3], // as signed long long int64_t;
            wn_mcu_temp_f,
            fr_mcu_temp_f,
            wn_mcu_temp_c,
            fr_mcu_temp_c,
