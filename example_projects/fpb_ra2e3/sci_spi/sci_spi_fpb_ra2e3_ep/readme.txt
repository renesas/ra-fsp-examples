...
1. Project Overview:
     	...
     	The project writes commands to the temperature module MAX31723PMB1 and reads the temperature value using 
	SCI_SPI bus which is configured as master.
...
2. Hardware settings for the project:
        ...
        EK-RA4M3/ EK-RA4M2/ EK-RA6M4/ EK-RA6M5/ EK-RA2E1/ EK-RA2E2/ EK-RA8M1:
