...
#define EP_INFO                 "\r\nThe example project shows the operation of the FileX file system on block media via the"\
                                "\r\nSDHI driver on the RA MCU. The FileX file system with exFAT format enabled, the project will"\
                                "\r\nperform various file system operations based on the user's selection from the menu"\
