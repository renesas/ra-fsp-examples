            ...
            switch(rtt_op_data->msg_id)
            {
                ...
                case RTT_OUTPUT_MESSAGE_APP_PRINT_FILE_ENTRIES:
                {
                    ...
                    APP_PRINT("\n%s          %s        %d Bytes      %d/%d/%d %d:%d:%d\r\n", file_info_print.directory_name, file_info_print.attributes, file_info_print.size,
                            file_info_print.time_stamp.date,file_info_print.time_stamp.month,file_info_print.time_stamp.year,file_info_print.time_stamp.hour,file_info_print.time_stamp.min,file_info_print.time_stamp.sec);
                }
                break;
                default:
                {
