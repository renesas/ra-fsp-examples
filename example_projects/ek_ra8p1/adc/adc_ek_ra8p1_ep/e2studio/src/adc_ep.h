...
#define BANNER_7    "\r\nThe project initializes the ADC in One-shot or Sequential mode\
                    ...
                    \r\ncan startthe ADC scan and also stop the scan (in the case of Sequential mode)\
...
#elif defined(BOARD_RA6T1_RSSK) || defined(BOARD_RA8T1_MCK) || defined(BOARD_RA4L1_EK)
