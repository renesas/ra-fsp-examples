/***********************************************************************************************************************
 * File Name    : g_i2c_master_guard.c
 * Description  : Contains data structures and functions used in g_i2c_master_guard.c.
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
BSP_CMSE_NONSECURE_ENTRY fsp_err_t g_i2c_master_open_guard(i2c_master_ctrl_t *const p_api_ctrl,
...
BSP_CMSE_NONSECURE_ENTRY fsp_err_t g_i2c_master_read_guard(i2c_master_ctrl_t *const p_api_ctrl, uint8_t *const p_dest,
...
BSP_CMSE_NONSECURE_ENTRY fsp_err_t g_i2c_master_write_guard(i2c_master_ctrl_t *const p_api_ctrl, uint8_t *const p_src,
                                                            uint32_t const bytes, bool const restart)
{
    /* Verify all pointers are in non-secure memory. */
...
BSP_CMSE_NONSECURE_ENTRY fsp_err_t g_i2c_master_slave_address_set_guard(i2c_master_ctrl_t *const p_api_ctrl,
...
{
    /* Verify all pointers are in non-secure memory. */
    void (*p_callback_checked)(i2c_master_callback_args_t*) = (void(*)(i2c_master_callback_args_t *))
                                                              cmse_check_address_range((void *) p_callback,
                                                                                       sizeof(void *),
                                                                                       CMSE_AU_NONSECURE);
...
BSP_CMSE_NONSECURE_ENTRY fsp_err_t g_i2c_master_status_get_guard(i2c_master_ctrl_t *const p_api_ctrl,
