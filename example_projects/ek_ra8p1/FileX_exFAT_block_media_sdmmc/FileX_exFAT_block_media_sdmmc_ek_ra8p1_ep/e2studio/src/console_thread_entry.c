 ...
 * Description  : Contains macros, data structures and functions used in console_thread_entry.c
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
void console_thread_entry(void)
{
    ...
    while(true)
    {
        ...
        if(RESET_VALUE != (request & FILE_SYSTEM_REQUEST_MASK))
        {
            ...
            if(TX_SUCCESS != status)
            {
                PRINT_ERR_STR("tx_event_flags_get for REQUEST_COMPLETED failed\r\n");
                ERROR_TRAP(status);
            }
        }
...
/*******************************************************************************************************************//**
 * @brief       This function takes input data to process the menu state and returns the user request.
