...
1. Project Overview:
	...
	Note: EK-RA8D1, EK-RA8P1 boards support I3C HDR-DDR mode. The Master EP can perform write/read operations 
	      both in the SDR mode and HDR-DDR mode.
...
Note:
1) On slave side the user can perform IBI transfer request using onboard Push button (S2).
