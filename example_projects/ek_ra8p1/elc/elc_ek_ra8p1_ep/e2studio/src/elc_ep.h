...
#else
#define EP_INFO                 "\r\nThis example project demonstrates the basic usage of ELC driver."\
		                        "\r\nELC Software Event, GPT6 and GPT0 events are linked using ELC."\
                                "\r\nThe start source for GPT6 and GPT0 is ELC Software Event, and the"\
                                "\r\nstop source for GPT6 is GPT0 counter overflow."\
                                "\r\nGPT6 runs in PWM mode, and GPT0 runs in One-Shot mode."\
