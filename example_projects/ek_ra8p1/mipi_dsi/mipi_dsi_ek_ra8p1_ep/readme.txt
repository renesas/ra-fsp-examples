...
1. Project Overview:
	...
	the MIPI LCD (external LCD connected to RA MCU) using the graphics and MPI-DSI modules in FSP. A user menu will
...
3. Hardware Connections:
    	...
    	For EK-RA8P1:
		1. Connect the USB Debug port on EK-RA8P1 to the PC using a Type-C USB cable.
		2. Connect the MIPI Graphics Expansion Board to J32 of EK-RA8P1.
		3. Set the configuration switches (SW4) on the EK-RA8P1 board as below:
		+------------------+------------------+------------+---------------+-----------+------------+------------------+------------------+
