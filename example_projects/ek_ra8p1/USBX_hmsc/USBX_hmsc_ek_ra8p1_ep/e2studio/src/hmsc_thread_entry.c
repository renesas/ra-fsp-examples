...
void hmsc_thread_entry(void)
{
    ...
    /* Extract date and time from complier and add the time stamp to the files on USB flash drive */
    time_stamping();
...
static UINT usbx_display_working_directory(void)
{
    ...
    else
    {
        ...
        /* Check and print the file and directory details until the last entry */
        do
        {
...
static UINT usbx_safely_eject(void)
{
    ...
    /* Waiting for USB flash drive to be plugged out */
