...
#define EP_INFO         "\r\nThe Example Project demonstrates the basic functionality of CEU driver on Renesas\r\n"\
                        ...
                        "the user is requested to provide the input key to save image.\r\n"\
...
#define EP_INFO         "\r\nThe Example Project demonstrates the basic functionality of CEU driver on Renesas\r\n"\
                        ...
                        "Type '1' and enter to select 'SDRAM' to choose SXGA (1280 x 960) format and store "\
                        "the image in SDRAM.\r\n"\
                        "Type '2' and enter to select 'SRAM' to choose VGA (640 x 480) format and store the "\
                        "image in SRAM.\r\n"\
                        "The captured image can be viewed in e2studio using the 'image viewer'.\r\n\n"
#endif
