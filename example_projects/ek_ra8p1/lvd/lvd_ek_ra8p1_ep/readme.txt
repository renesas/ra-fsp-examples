...
1. Project Overview:
	...
	LVD0 is configured in OFS1_SEC register via the properties dialog of BSP tab of FSP configurator.
...
3) For EK-RA8M1, EK-RA8D1, MCK-RA8T1, FPB-RA8E1, EK-RA8E2, EK-RA8P1, after changing input voltage values from below
   low threshold (ex: 2.8V) to above high threshold (ex: 3.3V), re-connect J-Link RTT Viewer to show log.
