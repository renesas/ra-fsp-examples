...
1. Project Overview:
	...
	mode. The EP log will print to the Host PC via the UART interface at a baud rate of 115200 bps. The LED2
...
2. Hardware Requirements:
	...
	1 x Micro USB cable or 1 x Type-C USB cable (For MCK-RA6T2, MCK-RA4T1, MCK-RA6T3, MCK-RA8T1, FPB-RA0E1,
            FPB-RA8E1, EK-RA4L1, EK-RA8E2, EK-RA8P1) or 1 x Mini USB cable (For RSSK-RA6T1) + Additional 1 x Micro USB
            cable for boards have to use Pmod USBUART.
