...
|   configuration.xml -> Host Thread > Settings > Property > Common > Total Heap Size  |   0   |   40000   |   This is changed because Dynamic Allocation support is enabled, so application makes use of amount of RAM available in the FreeRTOS heap.   |
