...
* (Don't use the R_ADC_InfoGet .slope_microvolts, as this is inaccurate according to data supplied. use slope=4.1mV/DegC)
*/
...
extern char g_pwm_dcs_data [];
extern char g_pwm_rates_data [];

extern uint32_t pwm_dcs[3];
extern uint32_t pwm_rates[3];


extern int g_selected_menu;
