...
1. Project Overview:
	...
	RA Board, and printing data will be transferred from the host device to the printer. RA MCU will display the 
	printer information, error and info messages will be printed on J-Link RTT Viewer.
