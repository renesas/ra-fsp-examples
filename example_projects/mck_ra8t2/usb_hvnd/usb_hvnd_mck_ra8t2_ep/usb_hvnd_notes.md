...
### Hardware ###
* Supported RA boards: EK-RA4M2, EK-RA4M3, EK-RA6M3, EK-RA6M3G, EK-RA6M4, EK-RA6M5, EK-RA8D1, EK-RA8M1, MCK-RA8T1, EK-RA4L1, EK-RA8E2, EK-RA8P1, EK-RA8M2, MCK-RA8T2.
...
* For MCK-RA8T2 (Full-Speed):
	* Jumper J6 placement is pins 1-2.
	* Remove the jumper JP7 pins.
...
## Verifying Operation ##
**Note:** By default, the USB HVND example project runs in High-Speed mode (If the RA board supports High-Speed mode).
