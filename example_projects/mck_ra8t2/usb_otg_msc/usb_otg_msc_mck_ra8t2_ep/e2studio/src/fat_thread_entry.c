...
/*******************************************************************************************************************//**
 * @brief      This function handles media insertion and removal events for USB storage.
...
/*******************************************************************************************************************//**
 * @brief      This function handles media insertion and removal events for internal storage.
 *             Depending on the event, it sends a notification to the `fat_thread` task.
 * @param[in]  p_args Pointer to callback argument structure containing the event type.
 * @retval     None.
 **********************************************************************************************************************/
...
/*******************************************************************************************************************//**
 * @brief      This function initializes Internal and USB disks for the FAT file system and handles commands and events
