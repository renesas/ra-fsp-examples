...
1. Project Overview:
	...
	perform file operations on the SD Card (except for MCK-RA8T1, MCK-RA8T2 which use MicroSD Card).
...
2. Hardware Requirements:
	Supported RA boards: EK-RA6M1, EK-RA6M2, EK-RA6M3, EK-RA6M3G, EK-RA6M4, EK-RA6M5, FPB-RA6E1, EK-RA8M1,
	                     EK-RA8D1, MCK-RA8T1, EK-RA8P1, MCK-RA8T2.
...
5) The user is expected to execute option 3 (Safely Remove SD/MicroSD Card) before removing SD/MicroSD Card else further file
   operations may fail and SD/MicroSD Card data may get corrupted.

6) The user must remove the SD/MicroSD Card after executing option 3 (Safely Remove SD/MicroSD Card), and re-insert
   it after executing option 4 (Initialize FreeRTOS+FAT).
