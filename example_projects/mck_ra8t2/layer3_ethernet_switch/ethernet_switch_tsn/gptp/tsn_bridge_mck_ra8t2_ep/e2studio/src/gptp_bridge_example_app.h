/***********************************************************************************************************************
 * File Name    : gptp_bridge_example_app.h
 * Description  : Public interface for the gPTP Bridge example application layer.
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
#ifndef GPTP_BRIDGE_EXAMPLE_APP_H_
#define GPTP_BRIDGE_EXAMPLE_APP_H_
...
#define GPTP_STATUS_INFO \
    "=====================================\n" \
    "GM Clock ID     : %02X:%02X:%02X:%02X:%02X:%02X:%02X:%02X\n" \
    "Timestamp       : %u,%03u s\n" \
    "Port %u          : %s\n" \
    "Port %u          : %s\n" \
    "Time Offset     : %s%u ns\n" \
...
#endif /* GPTP_BRIDGE_EXAMPLE_APP_H_ */
