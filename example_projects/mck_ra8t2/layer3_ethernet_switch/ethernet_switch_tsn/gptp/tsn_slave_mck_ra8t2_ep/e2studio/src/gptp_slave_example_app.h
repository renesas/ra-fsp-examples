/***********************************************************************************************************************
 * File Name    : gptp_slave_example_app.h
 * Description  : Public interface for the gPTP Slave example application layer.
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
#ifndef GPTP_SLAVE_EXAMPLE_APP_H_
#define GPTP_SLAVE_EXAMPLE_APP_H_
...
#endif /* GPTP_SLAVE_EXAMPLE_APP_H_ */
