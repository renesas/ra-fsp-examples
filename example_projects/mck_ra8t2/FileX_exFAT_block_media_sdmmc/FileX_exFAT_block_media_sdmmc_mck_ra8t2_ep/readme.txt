...
4. Hardware Connections:
	...
	For EK-RA8D1: The user must turn-off SW1-3, SW1-5, SW1-8 on board to use SDHI channel 1 (SDHI 4 bits width by default).
		1 Bit Width: 
...
5. Verifying Operation:
	...
	c) Insert MicroSD card to MicroSD socket.
	d) Debug or flash the example project to the RA board.
	e) Open the J-Link RTT Viewer.
	f) After the main menu is displayed on the RTT Viewer, the user selects options to perform file system management as desired.
