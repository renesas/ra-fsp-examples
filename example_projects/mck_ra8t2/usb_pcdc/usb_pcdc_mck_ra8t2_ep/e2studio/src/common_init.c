...
{
    {&g_gpt_1, GPT_IO_PIN_GTIOCA},
    {&g_gpt_2, GPT_IO_PIN_GTIOCB},
    {&g_gpt_3, GPT_IO_PIN_GTIOCA_AND_GTIOCB}
};
...
void button_irq31_callback(external_irq_callback_args_t *p_args)
{
...
void button_irq16_callback(external_irq_callback_args_t *p_args)
{
    FSP_PARAMETER_NOT_USED(p_args);
