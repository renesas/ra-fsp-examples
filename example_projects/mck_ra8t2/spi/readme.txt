...
1. Project Overview:
	...
	The project configures SPI module in Master and Slave mode. Once the modules are initialized and the SPI
	channel is configured, Master and Slave can transmit and receive data based on commands from user sent
	through J-Link RTT Viewer. SPI data transmission and reception are handled by the DTC module.

2. Hardware Requirements:
	Supported RA boards: EK-RA4L1, EK-RA2L2, FPB-RA2T1, MCK-RA8T2
...
3. Hardware Connections:
		...
		Board1 (Master)			Board2 (Slave)
     	...
     	For FPB-RA2T1:
		Board1 (Master)			Board2 (Slave)
     		MISO0  P100 (J4:12)	-->	MISO0  P100 (J4:12)
     		MOSI0  P101 (J4:11)	-->	MOSI0  P101 (J4:11)
     		RSPCK0 P102 (J4:10)	-->	RSPCK0 P102 (J4:10)

     	For MCK-RA8T2:
		Board1 (Master)			Board2 (Slave)
     		MISO0  P609 (CN2:7)	-->	MISO0  P609 (CN2:7)
     		MOSI0  P115 (CN2:6)	-->	MOSI0  P115 (CN2:6)
     		RSPCK0 P610 (CN2:5)	-->	RSPCK0 P610 (CN2:5)

4. Verifying Operation:
    	To run this example project, the user needs to import, build the spi_master and spi_slave EPs.
        Then, follow below instructions to observe the EP operation:
			
		a. Connect the Board1 and the Board2 to host PC via 2 Type-C USB cables.
...
Note:
1) By default, the user is expected to enter data of less than 40 bytes.
