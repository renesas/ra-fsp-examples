...
/*******************************************************************************************************************//**
 * @brief       This function initialize SPI Slave module.
 * @param[IN]   None
 ...
 * @retval      Any other error code apart from FSP_SUCCESS  Unsuccessful transfer.
 **********************************************************************************************************************/
...
#if (BSP_PERIPHERAL_SPI_B_PRESENT)
    err = R_SPI_B_Read(&g_spi_slave_ctrl, (uint8_t *)&received_size, ONE_BYTE, SPI_BIT_WIDTH_8_BITS);
#else
...
#if (BSP_PERIPHERAL_SPI_B_PRESENT)
    err = R_SPI_B_Write(&g_spi_slave_ctrl, (uint8_t *)&received_size, ONE_BYTE, SPI_BIT_WIDTH_8_BITS);
#else
...
#if (BSP_PERIPHERAL_SPI_B_PRESENT)
    err = R_SPI_B_Read(&g_spi_slave_ctrl, g_slave_rx_buff, received_size, SPI_BIT_WIDTH_32_BITS);
#else
...
#if (BSP_PERIPHERAL_SPI_B_PRESENT)
    err = R_SPI_B_Write(&g_spi_slave_ctrl, g_slave_rx_buff, received_size, SPI_BIT_WIDTH_32_BITS);
#else
...
#if (BSP_PERIPHERAL_SPI_B_PRESENT)
    err = R_SPI_B_Read(&g_spi_slave_ctrl,(uint8_t *)&validate_result, ONE_BYTE, SPI_BIT_WIDTH_8_BITS);
#else
...
/*******************************************************************************************************************//**
 * @brief       This function demos R_SPI_WriteRead()/R_SPI_B_WriteRead() for Slave simultaneously.
 * @param[IN]   None
 * @retval      FSP_SUCCESS     Upon successful Write and Read on Slave.
 * @retval      Any other error code apart from FSP_SUCCESS  Unsuccessful Write and Read on Slave.
 **********************************************************************************************************************/
...
#if (BSP_PERIPHERAL_SPI_B_PRESENT)
    err = R_SPI_B_WriteRead(&g_spi_slave_ctrl, slave_message_buff, g_slave_rx_buff, BUFF_LEN, SPI_BIT_WIDTH_32_BITS);
#else
...
#if (BSP_PERIPHERAL_SPI_B_PRESENT)
    err = R_SPI_B_WriteRead(&g_spi_slave_ctrl, g_slave_rx_buff, g_slave_rx_validate_buff, BUFF_LEN,
                            SPI_BIT_WIDTH_32_BITS);
#else
    err = R_SPI_WriteRead(&g_spi_slave_ctrl, g_slave_rx_buff, g_slave_rx_validate_buff, BUFF_LEN,
                          SPI_BIT_WIDTH_32_BITS);
#endif /* BSP_PERIPHERAL_SPI_B_PRESENT */
...
/*******************************************************************************************************************//**
 * @brief       This function closes SPI Slave module.
 * @param[IN]   None
