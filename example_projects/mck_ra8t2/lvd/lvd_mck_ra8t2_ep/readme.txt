...
1. Project Overview:
	...
	LVD0 is configured in OFS1 (or OFS1_SEC for EK-RA8P1, EK-RA8M2, MCK-RA8T2) register via the properties dialog
	of BSP tab of FSP configurator.
...
2. Hardware Requirements:
	...
	1 x External J-Link Segger with 9 pins (19 pins for MCK-RA8T1, FPB-RA0E1, MCK-RA8T2) connector and Type-B USB
	    to connect J-Link with PC.
...
3. Hardware Connections:
	...
	For MCK-RA8T1:
		Connect External J-Link connector ---> CN9 JTAG point.
		LVD1 generates an interrupt when input voltage raises above 3.08V.
		LVD0 resets the MCU when input voltage drops below 2.85V.
	...
	For MCK-RA8T2:
		Connect External J-Link connector ---> CN10 JTAG point.
		LVD1 generates an interrupt when input voltage raises above 3.08V.
		LVD0 resets the MCU when input voltage drops below 2.85V.
...
3) For EK-RA8M1, EK-RA8D1, MCK-RA8T1, FPB-RA8E1, EK-RA8E2, EK-RA8P1, EK-RA8M2, MCK-RA8T2 after changing input voltage
...
5) For EK-RA8P1, EK-RA8M2, MCK-RA8T2: When using SEGGER J-Flash Lite to program the hex file, select the correct flash
