 ...
 * This data will be transfer to IOPORT PCNTR1 register,
 * which specifies the input/output states transferred of a pin.
...
/* LED Port data array for EK-RA6M4, EK-RA4M3  */
uint32_t g_source_data[SOURCE_DATA_SIZE]=
{
...
/* LED Port data array for MCK_RA6T2 */
uint32_t g_source_data[SOURCE_DATA_SIZE]=
{
