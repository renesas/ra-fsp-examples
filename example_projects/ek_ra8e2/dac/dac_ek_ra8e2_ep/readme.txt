...
2. Hardware Connections:
     	...
     	For MCK-RA4T1, MCK-RA6T3:
       		Connect P014 (CN2:12) to P000 (CN2:5).
...
4) For RSSK-RA6T1 Board, the ADC value would be approx. Half of DAC value because there is resistive circuit connected between
