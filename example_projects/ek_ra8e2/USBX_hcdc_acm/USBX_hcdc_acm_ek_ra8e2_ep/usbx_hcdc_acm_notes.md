...
1. When the event UX_FSP_DEVICE_INSERTION is received the USBX_HCDC checks for the CDC class interface and sets the event flag to perform USBX_HCDC operations (i.e., write/read).
