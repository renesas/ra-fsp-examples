...
4. Configuration Settings: 
        ...
        i. Full-Speed (Default): (For EK-RA4M2, EK-RA4M3, EK-RA6M3, EK-RA6M3G, EK-RA6M4, EK-RA6M5, EK-RA8M1,
                                      EK-RA8D1, MCK-RA8T1, EK-RA4L1, EK-RA8E2)
...
5) If USB is removed without using "safely_eject" option, the user is recommended to perform "safely_eject" and "initialise USB" commands
   in sequence. This will make sure no USB operations fails after unexpected removal of USB.

6) The user is expected to enter J-Link RTT Viewer input data of size not exceeding 20 bytes.
