 ...
 * Description  : initialise adc stack, used for temprature sensor.
 * Return Value : See FSP for  possible return values.
 *********************************************************************************************************************/
 ...
 * Description  : Initialise interrupt cointroller stacks usde for switch IRQ's.
 * Return Value : See FSP for  possible return values.
 *********************************************************************************************************************/
 ...
 * Description  : Initialise general purpose timer stacks.
 * Return Value : See FSP for  possible return values.
 *********************************************************************************************************************/
 ...
 * Description  : Set duty cycle for the PWM used to control the BLue LED brightness.
 *                Uses common data structure g_board_status to derrive new value.
 * Return Value : None.
 *********************************************************************************************************************/
void led_duty_cycle_update(void)
{
    uint32_t required_intentity = 2 - g_board_status.led_intensity;

    R_GPT_DutyCycleSet (s_pwm_pins[0].p_timer->p_ctrl, 100 - g_pwm_dcs[required_intentity], s_pwm_pins[0].pin);
    s_duty = g_pwm_dcs[g_board_status.led_intensity];
}
/**********************************************************************************************************************
 ...
 * Description  : user callbaclk assigned to g_blinker_blue stack.
 * Argument     : p_args
 * Return Value : None.
 *********************************************************************************************************************/
