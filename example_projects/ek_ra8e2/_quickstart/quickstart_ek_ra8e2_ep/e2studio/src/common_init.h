...
#define SHORT_NAME                      ("RA8E2")
#define FULL_NAME                       ("EK-RA8E2")
#define PART_NUMBER                     ("RTK7EKA8E2S01001BE")
#define DEVICE_NUMBER                   ("R7FA8E2AFDCBD")

#define KIT_NAME                        ("EK-RA8E2")
#define EP_VERSION                      ("0.01")

#define LED_INTENSITY_10                (10)            /* 10 percent */
#define LED_INTENSITY_50                (40)            /* 50 percent 40 looks better */
#define LED_INTENSITY_90                (95)            /* 90 percent 95 looks better */
...
extern const st_full_image_rgb565_t g_ref_002_user_lcd_background;
