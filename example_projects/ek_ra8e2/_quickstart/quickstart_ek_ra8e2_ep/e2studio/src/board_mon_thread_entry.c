...
#define ADC_EXAMPLE_REFERENCE_CALIBRATION_TEMPERATURE    (127.0)    // Reference temperature at calibration
...
/**********************************************************************************************************************
 * Function Name: button_irq7_ds_callback
 * Description  : SW1 Interrupt handler.
 * Argument     : p_args
 * Return Value : None
 *********************************************************************************************************************/
void button_irq7_ds_callback(external_irq_callback_args_t *p_args)
{
    ...
    {
        /* Only update board status if switches are used OUTSIDE of LED DEMO */
...
/**********************************************************************************************************************
 End of function button_irq7_ds_callback
 *********************************************************************************************************************/
