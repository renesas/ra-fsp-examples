...
#define EP_SCREEN_MODE_TP                 (d2_mode_argb8888)
...
extern void menu_lcd_update_screen(d2_device *gp_d2_handle);
extern void menu_led_update_screen(d2_device *gp_d2_handle);
...
extern   uint8_t g_sdram_buffer_lcd[];
