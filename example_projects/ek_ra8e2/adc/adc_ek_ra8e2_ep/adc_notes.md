...
| configuration.xml -> Stacks -> g_adc ADC (r_adc) -> Properties > Settings > Property > Pins > AN000 | None | P004 | ADC input voltage supplied at available ADC channel (varies by MCU). |
