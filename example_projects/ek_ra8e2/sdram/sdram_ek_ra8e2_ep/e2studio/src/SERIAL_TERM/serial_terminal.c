...
/* Public global nocache region declaration */
unsigned char g_tx_buffer[BUFFER_SIZE_UP] BSP_ALIGN_VARIABLE(32) BSP_PLACE_IN_SECTION(".nocache") =  {RESET_VALUE};

/*******************************************************************************************************************//**
 *  @brief      This function is used to initialize the SCI UART module to transfer the EP log to the host PC
 *  @param      None
...
uint8_t serial_write_message (char * format, ...)
{
    ...
    /* Clean g_tx_buffer buffer */
    memset(g_tx_buffer, RESET_VALUE, sizeof(g_tx_buffer));
