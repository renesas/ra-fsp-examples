...
#define EP_INFO             "\r\nThis Example Project demonstrates the basic usage of SCI_SPI driver."\
                            ...
                            "\r\ncontinuously printed on the J-Link RTT Viewer.\r\n"

#define CONVERSION_TIME     (200U)                  /* Conversion time for 12-bit resolution */
#define PRINT_DELAY         (2U)                    /* Delay for RTT viewer prints */

/* Macros to define the type of SCI API being used based on the SCI version */
...
void hal_entry(void)
{
    ...
    /* Value for configuration register write. Set resolution as 12-bit */
