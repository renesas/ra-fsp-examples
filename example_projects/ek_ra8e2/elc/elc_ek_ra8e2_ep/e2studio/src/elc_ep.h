...
#else
#define EP_INFO                "\r\nThis Example Project demonstrates the basic usage of ELC driver."\
                               "\r\nELC Software Event, GPT4 and GPT0 events are linked using ELC."\
                               "\r\nThe start source for GPT4 and GPT0 is ELC Software Event and the "\
                               "\r\nstop source for GPT4 is GPT0 counter overflow."\
                               "\r\nGPT4 runs in PWM mode and GPT0 runs in one-shot mode."\
