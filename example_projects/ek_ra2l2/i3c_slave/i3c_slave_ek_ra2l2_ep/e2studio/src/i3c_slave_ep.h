...
#define EP_INFO                "\r\nThis example project demonstrates the typical use of the I3C Driver as a slave\r\n"\
                               "device on Renesas RA MCUs based on Renesas FSP. Once initialization is successful,\r\n"\
                               "the EP waits for DAA, or if DAA is not completed, it will initiate a hot "\
                               "join request.\r\n"\
                               "If the on-board switch is pressed, it will initiate an IBI transfer request.\r\n"\
