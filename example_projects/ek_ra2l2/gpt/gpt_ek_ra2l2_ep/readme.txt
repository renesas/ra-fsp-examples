...
1. Project Overview:
	...
	The user has the provision to input value as per displayed menu through J-Link RTT Viewer to select different GPT 
	supported modes (Periodic, PWM, One-Shot).
	In periodic mode, the user can enter the time period within the permitted ranges to change the frequency of the user LED.
	In PWM mode, the user can enter the duty cycle within the specified range to adjust the intensity of the user LED.
...
2) The user is expected to enter data of size not exceeding 15 bytes.
