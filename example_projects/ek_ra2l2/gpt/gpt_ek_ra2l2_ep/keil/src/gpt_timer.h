...
#if defined (BOARD_RA6E2_EK) || defined (BOARD_RA2E3_FPB)
...
#define TIMER_PIN                (GPT_IO_PIN_GTIOCB)
    ...
    || defined (BOARD_RA4T1_MCK) || defined (BOARD_RA6T3_MCK) || defined (BOARD_RA2L2_EK)
...
#define EP_INFO    "\r\nThe project initializes GPT module in Periodic, PWM or One-shot mode based on the user input " \
                   ...
                   "\r\nIn Periodic mode, the user can enter the time period within the permitted ranges to change "\
                   ...
                   "\r\nIn One-Shot mode, output will be displayed on J-link RTT Viewer when timer expires.\r\n "
