...
#define EP_INFO                "\r\nThis example project demonstrates the typical use of the I3C Driver as master\r\n"\
                               "on Renesas RA MCUs based on Renesas FSP. The I3C master demonstrates operation\r\n"\
                               "with an I3C slave connected on another RA board. Once initialization is\r\n"\
                               "successful, it will start assigning dynamic addresses to slave devices "\
                               "present on the bus.\r\n"\
                               "The EP performs write/read operations and displays device information based "\
                               "on user input.\r\n"\
