...
#define     EP_INFO     "\r\nThis example project demonstrates the typical use of the IWDT HAL module."\
						...
						"\r\nOn entering 2 from J-Link RTT Viewer, IWDT counter stops from refreshing and resets"\
						"\r\nthe MCU. \r\n"
...
/*******************************************************************************************************************//**
 * This function is called to read the user input from RTT Viewer using RTT API.
 * @brief       Read the user input from RTT Viewer. Handle the Error internally with Proper Message.
