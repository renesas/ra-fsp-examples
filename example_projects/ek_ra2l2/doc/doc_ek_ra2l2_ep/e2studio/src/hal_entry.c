...
void hal_entry(void)
{
    ...
    APP_PRINT("\r\nThis project demonstrates the basic functionality of DOC driver."
              ...
              "\r\nAddition Overflow & Subtraction Underflow) on reference data based on the user selection "
              "\r\nin RA configurator. Status and Result of the operation is printed on RTT Viewer. "
...
/*******************************************************************************************************************//**
 * @brief      This function is called at various points during the startup process. This implementation uses the event
