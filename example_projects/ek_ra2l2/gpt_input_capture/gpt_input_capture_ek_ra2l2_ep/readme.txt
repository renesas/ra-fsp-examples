...
1. Project Overview:
	The EP demonstrates the functionality of GPT Input capture module. GPT6 is used to generate periodic pulses 
	of 500msec duration and provided as input to GPT Input capture (GPT5). GPT5 counts the event pulse received 
	at its input. Based on the period and capture event, the time period of pulse is calculated and displayed on J-link RTT Viewer.
