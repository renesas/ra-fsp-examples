...
#if (BSP_PERIPHERAL_RTC_C_PRESENT == 1)
...
/*******************************************************************************************************************//**
 * @brief       This functions sets the alarm time provided by the user.
 * @param[IN]   None
...
/*******************************************************************************************************************//**
 * @brief       This functions sets the periodic interrupt rate provided by the user.
 * @param[IN]   None
...
static void rtc_date_time_conversion(rtc_time_t * time, unsigned char read_buffer[])
{
    /* The user is expected to enter Date and Time in DD:MM:YYYY HH:MM:SS format. This User input in the buffer is processed
     * using the following conversion, where ASCII value is converted to integer value 
