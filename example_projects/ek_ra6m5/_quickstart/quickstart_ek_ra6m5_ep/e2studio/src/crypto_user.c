...
static mbedtls_platform_context s_ctx = {RESET_VALUE};
...
static const uint8_t s_additional_data[] = {
 ...
 * Description  : Perform data dectyption, data processed from g_encrypted_data and decrypted into g_output_data
 * Return Value : .
 *********************************************************************************************************************/
