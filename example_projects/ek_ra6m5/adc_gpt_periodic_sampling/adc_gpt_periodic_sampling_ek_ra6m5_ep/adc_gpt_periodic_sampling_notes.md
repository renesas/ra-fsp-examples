...
|   configuration.xml -> g_adc0 ADC Driver on r_adc > Settings > Property > Module g_adc0 ADC Driver on R_ADC > Input > Channel Scan Mask  |   NULL  |   Channel 2, Channel 3  |   Configures Channel 2 and 3 for ADC 0 group B.   |
...
|   configuration.xml -> g_timer0 Timer Driver on r_gpt > Settings > Property > Module g_timer0 Timer Driver on R_GPT > Interrupt > Overflow/Crest Interrupt Priority |  Disable | Priority 2  | Select the timer overflow interrupt priority  |
...
|   configuration.xml -> g_timer0 Timer Driver on r_gpt > Settings > Property > Module g_timer0 Timer Driver on R_GPT > Extra Featues > ADC Trigger > ADC A Compare Match |  0  | 1260 | Compare match value that generates a GPTn AD TRIG A event |
|   configuration.xml -> g_timer0 Timer Driver on r_gpt > Settings > Property > Module g_timer0 Timer Driver on R_GPT > Extra Featues > ADC Trigger > ADC B Compare Match |  0  | 2495 | compare match value that generates a GPTn AD TRIG B event |
...
![ADC_Periodic_output](images/ADC0_group_A_channel0.jpg "Waveform Rendering of ADC Unit 0, Group A, Channel 0 Output")
