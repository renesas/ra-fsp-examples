 ...
 *  Description  : main() is generated by the RA Configuration editor and is used to generate threads
 *                 if an RTOS is used. This function is called by main() when no RTOS is used.
 *  Arguments    : None
 *  Return Value : None
 **********************************************************************************************************************/
void hal_entry(void)
