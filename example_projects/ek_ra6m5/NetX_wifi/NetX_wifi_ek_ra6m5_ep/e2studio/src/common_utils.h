...
typedef enum event_id
{
    ...
    RTT_OUTPUT_MESSAGE_MCU_IP_ADDRESS,
    RTT_OUTPUT_PRINT_INDEX,
    RTT_OUTPUT_PRINT_SECURITY_MENU,
    RTT_OUTPUT_MESSAGE_APP_GENERAL_STR,
    RTT_OUTPUT_MESSAGE_SECURITY,
    RTT_OUTPUT_TCP_RECV_LED_STATUS,
    RTT_OUTPUT_TCP_RECV_INVALID,
