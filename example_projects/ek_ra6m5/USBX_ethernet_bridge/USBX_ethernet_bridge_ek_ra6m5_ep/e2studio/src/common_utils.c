 ...
 **********************************************************************************************************************/
static uint8_t g_terminal_byte_pool_memory [TERMINAL_BYTE_POOL_SIZE] = {RESET_VALUE};
static uint8_t g_terminal_output_queue_memory [TERMINAL_OUTPUT_QUEUE_SIZE] = {RESET_VALUE};
static uint8_t g_terminal_input_queue_memory [TERMINAL_INPUT_QUEUE_SIZE] = {RESET_VALUE};

static TX_BYTE_POOL g_terminal_byte_pool = {RESET_VALUE};
static TX_QUEUE g_terminal_output_queue = {RESET_VALUE};
static TX_QUEUE g_terminal_input_queue = {RESET_VALUE};
