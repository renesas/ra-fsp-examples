 ...
 **********************************************************************************************************************/
static NX_TCP_SOCKET g_tcp_client_socket = {RESET_VALUE};
static NX_UDP_SOCKET g_udp_client_socket = {RESET_VALUE};
static NX_WEB_HTTP_SERVER g_web_http_server0 = {RESET_VALUE};
static FX_MEDIA g_fx_media0 = {RESET_VALUE};
static uint8_t g_fx_media0_media_memory[G_FX_MEDIA0_MEDIA_MEMORY_SIZE] = {RESET_VALUE};
static uint8_t g_web_http_server0_stack_memory[G_WEB_HTTP_SERVER0_STACK_SIZE] BSP_PLACE_IN_SECTION(".stack.g_web_http_server0")
               BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT) = {RESET_VALUE};
 ...
 * and performs the corresponding network operation (TCP client, UDP client, Web server).
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 * @brief Creates network application components, including TCP and UDP sockets, and a web HTTP server.
 *
...
static UINT server_callback_response_net_info (NX_WEB_HTTP_SERVER * p_server, CHAR * p_resource)
{
    ...
    length = snprintf(content_body, sizeof(content_body), JSON_NET_INFO,
                      g_usb_network_info.phy_addr.block.a, g_usb_network_info.phy_addr.block.b, g_usb_network_info.phy_addr.block.c,
                      g_usb_network_info.phy_addr.block.d, g_usb_network_info.phy_addr.block.e, g_usb_network_info.phy_addr.block.f,
                      g_usb_network_info.ipv4_addr.block.a, g_usb_network_info.ipv4_addr.block.b,
                      g_usb_network_info.ipv4_addr.block.c, g_usb_network_info.ipv4_addr.block.d,
                      g_usb_network_info.subnet_mask.block.a, g_usb_network_info.subnet_mask.block.b,
                      g_usb_network_info.subnet_mask.block.c, g_usb_network_info.subnet_mask.block.d);
