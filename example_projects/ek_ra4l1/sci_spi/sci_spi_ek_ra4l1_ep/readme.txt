...
3. Hardware Connections:
	...
	-----------
        	Temperature sensor(J1:1) to P301 (CN3:P8)
		Temperature sensor(J1:2) to P109 (CN5:P2)
		Temperature sensor(J1:3) to P110 (CN5:P3)
		Temperature sensor(J1:4) to P111 (CN3:P3)
		Temperature sensor(J1:5) to GND  (CN3:P32)
		Temperature sensor(J1:6) to Vcc  (CN2:P24)
	...
	-----------
        ...
        For EK-RA2A2:
	-----------
        	Temperature sensor(J1:1) to P503 (J1:P3)
        	Temperature sensor(J1:2) to P501 (J1:P1)
        	Temperature sensor(J1:3) to P500 (J4:P19)
        	Temperature sensor(J1:4) to P502 (J1:P2)
        	Temperature sensor(J1:5) to GND
        	Temperature sensor(J1:6) to Vcc  
	...
	-----------
        ...
        For EK-RA4L1:
	-----------
		Temperature sensor(J1:1) to P112 (J3:P18)
        	Temperature sensor(J1:2) to P109 (J3:P19)
        	Temperature sensor(J1:3) to P110 (J3:P20)
		Temperature sensor(J1:4) to P111 (J3:P17)
        	Temperature sensor(J1:5) to GND  (J3:P25)
        	Temperature sensor(J1:6) to Vcc  (J3:P1)
        	

Note:
1) Segger RTT block address may be needed to download and observe EP operation using a hex file with RTT-Viewer.
   RTT Block address for hex file committed in repository are as follows:
   a. e2studio: 0x20000734
