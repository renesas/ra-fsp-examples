...
{
    /* Verify all pointers are in non-secure memory. */
    rtc_error_adjustment_cfg_t const *const err_adj_cfg_checked = 
																						cmse_check_pointed_object((rtc_error_adjustment_cfg_t *)
																						err_adj_cfg, CMSE_AU_NONSECURE);
																														 ...
																														 rtc_callback_args_t *const p_callback_memory)
{
    ...
    void(*p_callback_checked)(rtc_callback_args_t *) = (void(*)(rtc_callback_args_t *))
																												cmse_check_address_range((void *)
																												p_callback, sizeof(void *), CMSE_AU_NONSECURE);
