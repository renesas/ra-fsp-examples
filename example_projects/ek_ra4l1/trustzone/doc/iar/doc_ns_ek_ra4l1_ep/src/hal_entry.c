...
void hal_entry(void) {
     ...
     APP_PRINT("\r\nThis project demonstrates the basic functionality of DOC driver."
             ...
             "\r\nAddition Overflow & Subtraction Underflow) on reference data based on"
             "\r\nthe user selection in RA configurator Status and Result of the operation is printed on RTT Viewer."
...
void R_BSP_WarmStart(bsp_warm_start_event_t event) {
	if (BSP_WARM_START_RESET == event) {
         ...
         * before clock and C runtime initialization, should negate the need for a delay since
