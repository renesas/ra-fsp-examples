...
#define LVD_INFO    "\r\nThe example project demonstrates the typical use of the LVD HAL module APIs."\
                    ...
                    "\r\nTo detect this, the user has to increase back the voltage value above LVD0 threshold value."\
                    "\r\nBy doing this, LED will turn ON indicating LVD0 reset detection."\
                    "\r\nEx: 2.8V is LVD0 threshold value, when input Voltage drops from 2.9V to 2.7V,"\
                    "\r\nLVD0 resets MCU."\
...
#define LVD_NOTE    "\r\nNote:"\
                    ...
                    "\r\nonce it is dropped below threshold value (Vdet0). This will turn ON LED and prints LVD0 reset"\
