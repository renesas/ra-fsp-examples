...
#define SHORT_NAME      "RA4L1"
#define FULL_NAME       ("EK-RA4L1")
#define PART_NUMBER     ("RTK7EKA4L1S01001BE")
#define DEVICE_NUMBER   ("R7FA4L1BD4CFP")
...
/* Un-comment the following define to enable segment function calls
 * NOTE in normal operation set_segment_icon_named() can be used specifying the segment.
 */
...
#define STATUS_DISPLAY_MENU_KIS     (1 << 0)    /* Mask for Kit Information Screen EVENT */
#define STATUS_UPDATE_KIS_INFO      (1 << 1)    /* Mask for Kit Information Screen data EVENT */
#define STATUS_UPDATE_TEMP_INFO     (1 << 2)    /* Mask for Kit Temperature EVENT */
#define STATUS_UPDATE_FREQ_INFO     (1 << 3)    /* Mask for Kit Blue LED Frequency EVENT */
#define STATUS_UPDATE_INTENSE_INFO  (1 << 4)    /* Mask for Kit Blue LED Intensity EVENT */
#define STATUS_WRITE_COMPLETE       (1 << 5)    /* Mask for USB Write EVENT */
#define STATUS_ENABLE_USB_MSC       (1 << 6)    /* Mask for USB MSC Detection is UP / Down */
#define STATUS_USB_READY            (1 << 7)    /* Mask for USB MSC Disk is Ready for Read/Write */
#define STATUS_USB_MSC_ERROR        (1 << 8)    /* Mask for USB MSC Generic Error ABORT */
#define STATUS_USB_REQUEST_READ     (1 << 9)    /* Mask for USB MSC Read request */
#define STATUS_USB_REQUEST_WRITE    (1 << 10)   /* Mask for USB MSC Write request */
#define STATUS_USB_REQUEST_RESET    (1 << 11)   /* Mask for USB MSC reset the driver */
#define STATUS_LPM_SWITCH           (1 << 12)   /* Mask for Low Power Mode Switch */
#define STATUS_LPM_DISABLE          (1 << 13)   /* Mask for Low Power Mode Disable */
