...
1. Project Overview:
   	...
   	The user can give input through J-Link RTT Viewer to start the WDT. WDT gets refreshed periodically through GPT timer.
   	The user can press push button to stop the GPT timer which in turn stops refreshing WDT timer.
   	Approximately after 2 seconds, WDT resets the MCU and turn LED ON until the user gives the input once again.

2. Hardware Connections:
	For EK-RA2A1, EK-RA2E1, EK-RA2L1, EK-RA4M1, EK-RA4M2, EK-RA4M3, EK-RA4W1, EK-RA6M1, EK-RA6M2, EK-RA6M4, EK-RA6M5,
	    EK-RA4E2, EK-RA6E2, FPB-RA4E1, FPB-RA6E1, MCK-RA4T1, MCK-RA6T3, FPB-RA8E1, EK-RA4L1 board:
