...
#define EP_INFO                       "\r\nThis Example Project demonstrates CAN FD operations on Renesas RA MCUs"\
                                      "\r\nusing 2 RA boards. On pressing any key on the J-Link RTT Viewer, data is"\
                                      "\r\ntransmitted from one board to other. On data reception, Board2 displays"\
                                      "\r\nthe received data on the J-Link RTT Viewer and transmits updated data to"\
                                      "\r\nBoard1. Board1 on reception of data, changes CAN frame to CANFD frame and"\
                                      "\r\nsends data to board2. On reception, board2 transmits updated data. On"\
                                      "\r\nsuccessful transmission, Board1 prints the data on to the J-Link RTT"\
                                      "\r\nViewer.\r\n\n"
