...
1. Project Overview:     
    	...
    	The user can enter DAC value within permitted range (0-4095) and the converted output 
...
2. Hardware Connections:
     	...
     	For MCK-RA4T1, MCK-RA6T3:
       		Connect P014 (CN2 Pin 12) to P000 (CN2 Pin 5).

     	For EK-RA8M1, EK-RA8D1:
       		Connect P014 (DAC Output) to P004(ADC Channel 0).

     	For MCK-RA8T1:
       		Connect P014 (CN1 Pin 17) (DAC Output) to P006 (CN1 Pin 9) (ADC Channel 2).

	For FPB-RA8E1:
		Connect P014 (J1 Pin 34) (DAC Output) to P004 (J1 Pin 20) (ADC Channel 0).
	
	For EK-RA4L1:
		Connect P004 (J1 pin 7) (DAC Output) to P003 (J1 Pin 6) (ADC Channel 1).

Note:
1) The user is expected to enter data of size not exceeding above 15 bytes.
   Operation is not guaranteed for any user input value other than integer (i.e. char, float, special char) 
...
4) For RSSK-RA6T1 Board, the ADC value would be approx. Half of DAC value because there is resistive ciruit connected between
   CNB->Pin 5 and P000 of MCU.
