...
#define EP_INFO     "\r\nThis example project demonstrates basic functionalities of USB Host Communication Device \r\n"\
                    ...
                    "running on it) communicates with Board 2 (with USB PCDC Example project running). Board 1 \r\n"\
                    "initiates the communication by sending commands to Board 2 and Board 2 responds by sending \r\n"\
                    "the data. Board 1 prints the received data on the RTT Viewer.\r\n\n\n"
