 ...
 * Description  : Contains macro used in EP
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
#define EP_INFO "\r\nThis project demonstrates the basic functionality of NetX secure crypto on Renesas\r\n"\
                "RA MCUs based on Renesas FSP supporting SCE7/SCE9/RSIP-E51A/RSIP-E11A Hardware acceleration using\r\n"\
                "AzureRTOS. The example project executes AES, ECC, RSA algorithms(including different chaining\r\n"\
                "modes) in multi-threaded environment using mutex to enable access to SCE/RSIP. The user can\r\n"\
                "enter any key to enable concurrent execution of the different algorithms and status of the\r\n"\
                "execution will be displayed on J-Link RTT Viewer.\r\n\n"
