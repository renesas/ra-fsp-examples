...
#if defined(BOARD_RA4L1_EK) // For Segment LCD Board (Part number: RTKLCDSEG1S00001BE)
...
{
 { 0xA, 0xF },    // 0 digit is display by writing 0xA and 0xF to the appropriate digit start address
 { 0x0, 0x6 },    // 1 digit is display by writing 0x0 and 0x6 to the appropriate digit start address
 { 0x6, 0xD },    // 2 digit is display by writing 0x6 and 0xD to the appropriate digit start address
 { 0x4, 0xF },    // 3 digit is display by writing 0x4 and 0xF to the appropriate digit start address
 { 0xC, 0x6 },    // 4 digit is display by writing 0xC and 0x6 to the appropriate digit start address
 { 0xC, 0xB },    // 5 digit is display by writing 0xC and 0xB to the appropriate digit start address
 { 0xE, 0xB },    // 6 digit is display by writing 0xE and 0xB to the appropriate digit start address
 { 0x0, 0xE },    // 7 digit is display by writing 0x0 and 0xE to the appropriate digit start address
 { 0xE, 0xF },    // 8 digit is display by writing 0xE and 0xF to the appropriate digit start address
 { 0xC, 0xF },    // 9 digit is display by writing 0xC and 0xF to the appropriate digit start address
};
