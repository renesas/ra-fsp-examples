...
#define EP_INFO "\r\nThis project demonstrates the basic functionality of USBx Device CDC-ACM Module\r\n"\
		        "running on Renesas RA MCUs based on Renesas FSP using AzureRTOS. The user will be able\r\n"\
                "to use the RA board as a CDC device by connecting through a COM port from the HOST pc.\r\n"\
                "Once the board is connected, the user can provide the input from the serial terminal.\r\n"\
                "The user input will be echoed on the serial terminal. Status of application will be displayed\r\n"\
