...
#define EP_INFO  "\r\nThe Example Project demonstrates the basic functionality of ADC GPT Periodic Sampling \r\n"\
                 "on Renesas RA MCUs based on FSP. On successful initialization of ADC, GPT, ELC and DTC module,\r\n"\
