...
#define STATUS_REG_PAYLOAD              {0x01,0x00}         /* Status register pay-load */
#define SET_SREG_VALUE                  (0x00)              /* data written to status register */
#define SREG_SIZE                       (0x02)              /* SREG pay-load size */
#else

#define QSPI_DEVICE_MX25L               (1)
#define STATUS_REG_PAYLOAD              {0x01,0x40,0x00}    /* Status register pay-load */
...
#define SREG_SIZE                       (0x03)              /* SREG pay-load size */
#endif
