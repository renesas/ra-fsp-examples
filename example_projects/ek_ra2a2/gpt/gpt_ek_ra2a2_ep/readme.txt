...
1. Project Overview:
        ...
        User has the provision to input value as per displayed menu through JLinkRTTViewer to select different GPT supported 
	modes(Periodic, PWM, One-Shot).
...
2. Hardware Settings:
    	...
    	For EK-RA2A2:
    	Connect P105(J4 Pin 16) --> P307(J3 Pin 16)

Note: 
1) Timer period range in millisecond as per EP configuration: 
        a. EK-RA6M1/EK-RA6M2/EK-RA6M3/EK-RA6M3G/RSSK-RA6T1/MCK-RA6T2/EK-RA8M1/EK-RA8D1   	--      (0 to 35791) ms 
