...
3. Hardware and software setups:
	...
	FPB-RA2E3:
	  1) Connect P200 (J3-Pin21)  <-------> IRQ0 P206 (J3-Pin18)
...
5. The steps to run LPM Example Projects are as follows:
	...
	2) Connect the PMOD USBUART module to the RA board according to the hardware connection instructions, and then connect the Pmod USBUART 
	   to the host PC via a micro-USB cable.
	...
	5) Press the user push-button S2 or wait 10 seconds to enter and cancel LPM mode. It will turn off LED1 before entering each LPM mode 
