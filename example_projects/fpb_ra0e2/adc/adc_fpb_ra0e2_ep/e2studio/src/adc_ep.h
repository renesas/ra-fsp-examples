...
/* Macro for storing the voltage value display string */
#define VOLT_STR_SIZE                   (0x05)

/* Macro for indexing buffer. Using to read the bytes received from RTT input */
...
#define BANNER_7    "\r\nThe project initializes the ADC in One-shot or Sequential mode \
                    \r\nbased on user selection in RA configurator. Once initialized, the user can start \
...
#define BANNER_7    "\r\nThe project initializes the ADC in single scan or continuous scan mode \
                    \r\nbased on the user selection in RA configurator. Once initialized, the user can start \
