...
1. Project Overview:
        ...
        Once initialized, the user can initiate the ADC scan and also stop the scan (in the case of continuous scan mode) using 
	J-Link RTT Viewer by sending commands. The user provides ADC channel input voltage from 0V to 3.3V with a voltage supply unit 
	...
	Note:
		FPB-RA0E1, FPB-RA0E2 does not support Window Compare Mode and operates with One-shot or Sequential mode.
...
4. Configuration Settings:
	...
	For FPB-RA0E1, FPB-RA0E2: By default the example project runs in Sequential mode on the board. 
