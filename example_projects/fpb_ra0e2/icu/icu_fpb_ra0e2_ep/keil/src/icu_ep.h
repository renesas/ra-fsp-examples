...
#elif defined (BOARD_RA6M2_EK) || defined (BOARD_RA4M1_EK) || defined (BOARD_RA2A2_EK) || \
      defined (BOARD_RA2E3_FPB) || defined (BOARD_RA0E1_FPB) || defined (BOARD_RA0E2_FPB)
...
#elif defined (BOARD_RA4E1_FPB) || defined (BOARD_RA6E1_FPB) || defined (BOARD_RA2E2_EK)
