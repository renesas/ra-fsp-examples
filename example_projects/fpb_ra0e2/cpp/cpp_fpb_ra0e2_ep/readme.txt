...
1. Project Overview:
        ...
        using J-Link RTT Viewer by sending commands. Result and ADC status are displayed on the J-Link RTT Viewer.
...
3. Configuration Settings:
	...
	In order to switch the scan mode, change the 'Conversion operation' field of ADC_D Driver in the RA configurator to One-shot.
	
Note: 
1) EK-RA2A1, EK-RA2E1, EK-RA2E2, EK-RA2L1, EK-RA4M1, EK-RA2A2, EK-RA4L1 support only Single Scan mode.
