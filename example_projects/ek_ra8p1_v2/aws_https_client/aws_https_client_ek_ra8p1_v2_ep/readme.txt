...
2. Hardware Requirements:
	Supported RA boards: EK-RA6M3, EK-RA6M5, EK-RA8M1, EK-RA8D1, MCK-RA8T1, EK-RA8P1, EK-RA8D2, EK-RA8M2,
			     EK-RA8T2, EK-RA8P1 V2.
...
3. Hardware Connections:
	...
	Note:
	- The Switch should have WAN connection to communicate the server over internet and connect to the router
...
4. Hardware Configurations:
	...
	- For EK-RA8P1 V2: The user must set the configuration switches (SW6 and SW4) as below to use the on-board
