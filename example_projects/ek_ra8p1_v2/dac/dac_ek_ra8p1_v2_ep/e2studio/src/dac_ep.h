...
#define EP_INFO                 "\r\nThe project initializes and demonstrates DAC module on Renesas RA MCUs"\
                                "\r\nusing ADC. The user can enter DAC value within permitted range (1-4095)"\
                                "\r\nand the converted output is given as input to ADC channel 1. ADC output"\
                                "\r\nvalue is printed on the J-Link RTT Viewer.\r\n"
...
#elif defined(BOARD_RA2A1_EK) || defined(BOARD_RA4L1_EK) || defined(BOARD_RA8P1_EK) || defined(BOARD_RA8D2_EK) ||\
      defined(BOARD_RA8M2_EK) || defined(BOARD_RA8P1_EK_V2)
#define ADC_CHANNEL             (ADC_CHANNEL_1)
#else
#define ADC_CHANNEL             (ADC_CHANNEL_0)
#endif /* Specific board */
...
#endif /* BOARD_RA2A1_EK || BOARD_RA6T2_MCK */
