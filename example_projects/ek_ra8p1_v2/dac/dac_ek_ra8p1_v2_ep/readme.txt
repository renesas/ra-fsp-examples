...
1. Project Overview:
	...
	is given as input to ADC channel 1. ADC output value is printed on the J-Link RTT Viewer.

2. Hardware Requirements:
	Supported RA boards: EK-RA2A1, EK-RA2L1, EK-RA4E2, EK-RA4L1, EK-RA4M1, EK-RA4M2, EK-RA4M3, EK-RA4W1, EK-RA6E2,
	                     EK-RA6M1, EK-RA6M2, EK-RA6M3, EK-RA6M4, EK-RA6M5, EK-RA8D1, EK-RA8D2, EK-RA8E2, EK-RA8M1,
	                     EK-RA8M2, EK-RA8P1, FPB-RA4E1, FPB-RA6E1, FPB-RA8E1, MCK-RA4T1, MCK-RA6T2, MCK-RA6T3,
	                     MCK-RA8T1, MCK-RA8T2, RSSK-RA6T1, EK-RA8P1 V2.
...
3. Hardware Connections:
	...
	For MCK-RA8T2:
		Connect P014 (CN2:28) (DAC Output) to P002 (CN3:5) (ADC Channel 2).
	...
	For EK-RA8M2:
		...
		Connect P014 (J3:20) (DAC Output) to P001 (J4:10) (ADC Channel 1).
	...
	For EK-RA8P1 V2:
		...
		+-------+-------+-------+-------+-------+-------+-------+-------+-------+--------+
		Connect P014 (J3:22) (DAC Output) to P001 (J3:14) (ADC Channel 1).
...
2) For DAC input as 0, ADC output will not be 0 because of offset correction value. Hence, 0 is not considered
   in the valid range.
