...
* For MCK-RA8T1, EK-RA8P1, EK-RA8D2, EK-RA8M2, EK-RA8P1 V2:
  * Connect ethernet port of the RA board to Ethernet switch/router via a LAN cable.
  * Connect ethernet port of the Linux machine/Raspberry Pi/Windows PC to Ethernet switch/router via a LAN cable.
...
* For MCK-RA8T2:
  * Connect ethernet port 0 (CN14) of the RA board to ethernet switch/router via a LAN cable.
  * Connect ethernet port of the Linux machine/Raspberry Pi/Windows PC to ethernet switch/router via a LAN cable.
...
The following documents can be referenced to enhance your understanding of the operation of this example project:
