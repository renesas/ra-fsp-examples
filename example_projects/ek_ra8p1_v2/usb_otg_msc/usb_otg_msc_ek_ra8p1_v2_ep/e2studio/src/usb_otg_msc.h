 ...
 **********************************************************************************************************************/
    ...
    defined(BOARD_RA8D2_EK) || defined(BOARD_RA8M2_EK) || defined(BOARD_RA8T2_MCK) || defined(BOARD_RA8P1_EK_V2)
...
#if defined(BOARD_RA8P1_EK) || defined(BOARD_RA8D2_EK) || defined(BOARD_RA8M2_EK) || defined(BOARD_RA8P1_EK_V2)
    #if USB_IP0
