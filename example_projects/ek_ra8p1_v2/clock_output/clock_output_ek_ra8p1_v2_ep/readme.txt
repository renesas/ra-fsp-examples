...
1. Project Overview:
	...
	For Terminal Application:
		...
		- RA boards supported for J-Link OB VCOM: EK-RA2A2, EK-RA4E2, EK-RA6E2, EK-RA8D1, EK-RA8M1, EK-RA8P1,
							  EK-RA4C1, EK-RA8D2, EK-RA8M2, EK-RA8T2, EK-RA8P1 V2.
...
5. Verifying Operation:
	...
	3. Connect the RA board USB debug port to the host PC using the appropriate USB cable for EP programming and
	   debugging.
