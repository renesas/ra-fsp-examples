...
5. Verifying Operation:
	...
	and then follow instructions below to observe the operation of the system.
		a. Connect the Master RA board and Slave RA board to host PC via two Type-C USB cables and connect
		...
		c. For Selecting Master Write - Slave Read operation, press "1" on both the EPs (Master and Slave
		   sequentially).
			- Master starts writing and Slave reads and both RA boards display the data transaction/messages
		...
		d. For Selecting Master Read - Slave Write operation, press "2" on both the EPs (Master and Slave
		   sequentially).
			- Master starts reading and Slave writes and both RA boards display the data transaction/messages
			  on J-Link RTT Viewer.
