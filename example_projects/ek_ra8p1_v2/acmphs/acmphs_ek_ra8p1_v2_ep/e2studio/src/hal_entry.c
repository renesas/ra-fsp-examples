...
#define LED_PIN             (BSP_IO_PORT_06_PIN_14)
...
void hal_entry(void)
{
    ...
    APP_PRINT("\r\nIn this project Internal Reference Voltage (Vref) is used as reference voltage source"
              "\r\nand AN000 is used as input voltage source for ACMPHS module, which is supplied"
              ...
              "\r\nAN000. When input voltage source is greater than reference voltage, Comparator output status"
