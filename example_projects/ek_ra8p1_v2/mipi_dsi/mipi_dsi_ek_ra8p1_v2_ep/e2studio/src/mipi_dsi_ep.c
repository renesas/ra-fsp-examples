...
void mipi_dsi_start_display(void)
{
    ...
    while (true)
    {
        ...
        /* The user selects time to enter ULPS */
        ...
        if (g_irq_state)
        {
            ...
            if (StatusRegister & GT911_BUFFER_STATUS_READY)
            {
                ...
                handle_error(err, "** R_GPT_Reset API failed **\r\n");
            }
        }
        if (g_ulps_flag)
        {
...
/*******************************************************************************************************************//**
 * @brief      This function is used to set the display time.
 * @param[in]  None.
...
/*******************************************************************************************************************//**
 * @brief      Touch IRQ callback function. This function will return to the highest priority available task.
