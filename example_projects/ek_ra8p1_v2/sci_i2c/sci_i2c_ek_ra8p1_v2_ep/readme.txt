...
1. Project Overview:
	This example project demonstrates SCI I2C Master operation through loopback with IIC Slave driver. 6 bytes of
...
2. Hardware Requirements:
	Supported RA boards: EK-RA6M3, EK-RA6M3G, EK-RA6M2, EK-RA6M1, EK-RA6M4, RSSK-RA6T1, EK-RA4W1, EK-RA4M1,
			     EK-RA2A1, EK-RA2L1, EK-RA4M3, EK-RA4M2, EK-RA2E1, EK-RA6M5, FPB-RA6E1, FPB-RA4E1,
			     MCK-RA6T2, EK-RA8M1, FPB-RA2E3, EK-RA8D1, MCK-RA8T1, EK-RA2A2, FPB-RA8E1, EK-RA4L1,
			     EK-RA8E2, EK-RA8P1, EK-RA8D2, FPB-RA2T1, EK-RA4C1, MCK-RA8T2, EK-RA8M2, EK-RA8P1 V2.
...
3. Hardware Connections:
	...
	--------
		Channel 0 has been used by SCI I2C Master and IIC Slave.
			SCI I2C Master pins     IIC Slave pins
	...
	For EK-RA6M4:
	--------
		Channel 7 has been used by SCI I2C Master and Channel 1 has been used by IIC Slave.
			SCI I2C Master pins     IIC Slave pins
	...
	For EK-RA4M3:
	--------
		Channel 9 has been used by SCI I2C Master and Channel 1 has been used by IIC Slave.
			SCI I2C Master pins     IIC Slave pins
	...
	For EK-RA4M2:
	---------
		Channel 9 has been used by SCI I2C Master and Channel 0 has been used by IIC Slave.
			SCI I2C Master pins     IIC Slave pins
	...
	For EK-RA2E1:
	---------
		Channel 2 has been used by SCI I2C Master and Channel 0 has been used by IIC Slave.
			SCI I2C Master pins      IIC Slave pins
	...
	For FPB-RA4E1:
	-----------
		Channel 4 has been used by SCI I2C Master and Channel 0 has been used by IIC Slave.
			SCI I2C Master pins     IIC Slave pins
	...
	For MCK-RA6T2:
	-----------
		Channel 1 has been used by SCI I2C Master and Channel 0 has been used by IIC Slave.
			SCI I2C Master pins     IIC Slave pins
	...
	For EK-RA8M1:
	-----------
		Remove Jumper J61 to disable I3C, use pin P401, P400 for SCI I2C.
		Channel 1 has been used by SCI I2C Master and Channel 0 has been used by IIC Slave.
			SCI I2C Master pins      IIC Slave pins
	...
	For FPB-RA2E3:
	-----------
		Channel 0 has been used by SCI I2C Master and Channel 0 has been used by IIC Slave.
			SCI I2C Master pins     IIC Slave pins
			SDA0 P100 (J4:12) ----> SDA0 P400 (J3:1)
			SCL0 P101 (J4:11) ----> SCL0 P401 (J3:2)
	...
	-----------
		...
		CAUTION: Do not enable SW1-3, SW1-5 and SW1-8, use pin P401, P400 for SCI I2C.
	...
	For FPB-RA8E1:
	-----------
		Channel 0 has been used by SCI I2C Master and Channel 1 has been used by IIC Slave.
			SCI I2C Master pins     IIC Slave pins
	...
	For EK-RA8E2:
	-----------
		Channel 1 has been used by SCI I2C Master and Channel 1 has been used by IIC Slave.
			SCI I2C Master pins    IIC Slave pins
	...
	For MCK-RA8T2:
	-----------
		Channel 0 has been used by SCI I2C Master and Channel 2 has been used by IIC Slave.
			SCI I2C Master pins      IIC Slave pins
	...
	-----------
		...
		Channel 0 has been used by SCI I2C Master and Channel 1 has been used by IIC Slave.
			SCI I2C Master pins     IIC Slave pins
			SDA0 P603 (J37:3) ----> SDA1 P511 (J4:14)
			SCL0 P602 (J3:40) ----> SCL1 P512 (J4:11)
	...
	-----------
		...
		Channel 0 has been used by SCI I2C Master and Channel 1 has been used by IIC Slave.
			SCI I2C Master pins      IIC Slave pins
			SDA0 P603 (J3:25)  ----> SDA1 P511 (J1:2)
			SCL0 P602 (J17:11) ----> SCL1 P512 (J1:4)

Note:
1) a. For the functioning of SCI I2C Master and IIC Slave on all the boards except for EK-RA6M3, EK-RA6M3G, FPB-RA6E1,
      FPB-RA4E1, FPB-RA2E3, MCK-RA8T1, EK-RA2A2, FPB-RA8E1, EK-RA4L1, EK-RA8E2, EK-RA8P1, FPB-RA2T1, EK-RA4C1,
      MCK-RA8T2, EK-RA8D2, EK-RA8M2, EK-RA8P1 V2 external pull up resistors of value 3.9 or 4.7k ohms are required to
      be connected on I2C (SDA/SCL) lines.
