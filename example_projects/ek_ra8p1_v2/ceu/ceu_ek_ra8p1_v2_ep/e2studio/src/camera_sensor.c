...
/* Image data in one line is exported from the e2 memory view of the EK-RA8P1, EK-RA8D2 boards */
const uint32_t g_cam_vga_color_one_line[] =
{
...
static fsp_err_t i2c_master_wait_event(const i2c_master_event_t i2c_event)
{
    ...
    while (i2c_event != g_i2c_event_for_cam)
    {
        ...
        else
        {
            ...
            {
                APP_ERR_RETURN(FSP_ERR_TIMEOUT, "** I2C Master Callback event not received **\r\n");
            }
        }
    }
    return err;
