...
void bsp_sdram_init (void)
{
    ...
    if(false == is_sdram_initialised())
    {
        ...
        {
            /* According to h/w maual, need to confirm that all the status bits in SDSR are
             * 0 before SDIR modification. */
        }
