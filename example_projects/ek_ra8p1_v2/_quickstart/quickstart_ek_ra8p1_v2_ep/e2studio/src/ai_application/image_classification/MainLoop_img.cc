...
extern int8_t g_model_buffer_int8[IMAGE_DATA_SIZE];
...
bool main_loop_image_classification()
{
    ...
    copy_data_to_mera((int8_t*)mera_input_ptr(), (uint8_t*)g_model_buffer_int8, (uint32_t)mera_input_size());
    ...
    g_application_processing_time.ai_inference_time_ms = TimeCounter_CountValueConvertToMs(old_counter, new_counter);
