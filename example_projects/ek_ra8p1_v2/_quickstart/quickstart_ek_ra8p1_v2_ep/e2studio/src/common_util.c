...
/** process_time report */
processing_time_info_t g_application_processing_time;
/***********************************************************************************************************************
 * Private global variables and functions
 **********************************************************************************************************************/
char g_sprintf_buffer[BUFFER_LINE_LENGTH] = {};



/**********************************************************************************************************************
 * Function Name: e_printf
 * Description  :  * This function is used by the AI for debugging output. Refer to log_macros.h.
...
{
	sprintf(g_sprintf_buffer, format);
	print_to_console(g_sprintf_buffer);
    return 0;
}
 ...
 * Description  : This function handle error if error occurred, closes all opened modules, print and traps error.
 * Argument     : err
 * Return Value : .
 *********************************************************************************************************************/
