...
#define FULL_NAME                       ("EK-RA8P1 v2")
#define PART_NUMBER                     ("RTK7EKA8P1S01002BE")
...
#define DISPLY_PRODUCT_NAME_LENGTH_CFG  (23)
...
} st_board_eeprom_mac_data_t;


typedef struct
{
    bool_t populated;
    char_t *p_identity_str;
    char_t *p_serial_str;
    st_board_eeprom_mac_data_t mac_t;
} st_board_eeprom_data_t;
...
extern char_t g_product_full_name[DISPLY_PRODUCT_NAME_LENGTH_CFG];
...
extern st_board_eeprom_data_t g_eeprom_data;
...
extern fsp_err_t board_cfg_read_eeprom(void);
...
extern const st_overlay_image_rgb565_t g_ref_menu_overlay_image;
