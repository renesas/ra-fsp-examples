...
1. Project Overview:
	...
	The project initializes the OSPI, MIPI CSI, GLCD and GPIO modules along with various supporting stacks to
	create an interactive user demo.
	...
	updated board configuration on the kit information screen using the serial console. 
	Attaching the LCD panel (supplied) a user can interact with the application using the screen.
	Attach OV5640 camera module in addition to the panel to allow 'AI Display' demo on application menu or 
	option 4 on console to show live image, please read the following document for full description of the 
	application:
	r20qs0051eg Evaluation Kit for RA8P1 Microcontroller Group EK-RA8P1 v2 Quick Start Guide.
...
3. Hardware settings for the project:
	Link to access Quick Start Guide - https://www.renesas.com/en/document/qsg/ek-ra8p1-v2-quick-start-guide
