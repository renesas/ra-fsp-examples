...
static fsp_err_t crc_operation(void)
{
     ...
     * from TX to RX */
    /* Perform SAU UART (FPB-RA0E1, FPB-RA0E2, FPB-RA0L1) loop-back transmission from TX to RX */
...
#endif /* BSP_FEATURE_CRC_HAS_SNOOP */
    return err;
}
...
/*******************************************************************************************************************//**
 * @brief     This function is used to toggle the on-board LED, which is connected and supported by the BSP.
 * @param[in] None.
 * @retval    None.
 **********************************************************************************************************************/
...
/*******************************************************************************************************************//**
 *  @brief       This function is used to turn the on-board LED ON or OFF.
