...
### Hardware ###
* Supported RA boards: EK-RA2A1, EK-RA2L1, EK-RA4M2, EK-RA6M4, EK-RA4E2, EK-RA6E2, MCK-RA4T1, MCK-RA6T3, EK-RA8M1, EK-RA8D1, MCK-RA8T1, FPB-RA8E1, EK-RA4L1, EK-RA8E2, EK-RA8P1, EK-RA8D2, EK-RA8M2, MCK-RA8T2, EK-RA8P1 V2.
...
## Verifying Operation ##
1. Import, build and debug the EP (see section Starting Development of **FSP User Manual**). Before running the example project, follow the steps below to set up the hardware connections:
