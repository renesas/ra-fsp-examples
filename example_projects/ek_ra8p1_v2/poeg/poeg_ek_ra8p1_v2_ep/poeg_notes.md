...
**Note:**
* EK-RA4L1, EK-RA2L2, EK-RA4C1 boards do not support disabling GPT output pins based on comparator (ACMPHS) crossing events.
* The user can refer the [Verifying Operation](#verifying-operation) section to run the example project properly.
...
### Hardware ###
Supported RA boards: EK-RA6M1, EK-RA6M2, EK-RA6M3, RSSK-RA6T1, MCK-RA4T1, MCK-RA6T2, MCK-RA6T3, EK-RA8D1, EK-RA8M1, MCK-RA8T1, FPB-RA8E1, EK-RA4L1, EK-RA8E2, EK-RA2L2, FPB-RA2T1, EK-RA8P1, EK-RA4C1, MCK-RA8T2, EK-RA8M2, EK-RA8D2, EK-RA8P1 V2.
...
* After selecting option 1, the user needs to give active LOW for GTETRG pin by:
  ...
  * For EK-RA8P1 V2:
    ...
    * Connect GTETRG P614 (J14:17) to GND.

* Before selecting Option "Disable GPT output pins based on comparator (ACMPHS) crossing events", the user needs to set up as shown below:
  * For MCK-RA6T2:
...
* Connect GPT output pins to Logic Analyzer to verify operations:
  ...
  * EK-RA8P1 V2:
    * Connect GTIOC0A P415 (J2:8) to Logic Analyzer Channel 0.
    * Connect GTIOC0B P414 (J17:15) to Logic Analyzer Channel 1.
    * Connect GTIOC5B P609 (J14:24) to Logic Analyzer Channel 2.
    * Connect GND (J2:27) to Logic Analyzer GND.
...
**For EK-RA8P1, MCK-RA8T2, EK-RA8M2, EK-RA8D2, EK-RA8P1 V2:**
| Module Name | Usage | Searchable Keyword (using New Stack > Search) |
|-------------|-----------------------------------------------|-----------------------------------------------|
| Port output enable for GPT | Port output enable for GPT channel 0. | r_poeg |
| Port output enable for GPT | Port output enable for GPT channel 1. | r_poeg |
| General PWM | General PWM channel x (The value x is specific to each board). | r_gpt |
| General PWM | General PWM channel y (The value y is specific to each board). | r_gpt |
| Comparator | Comparator High- Speed. | r_acmphs |
...
## Verifying Operation ##
To run this example project, follow instructions below to observe the EP operation:
1. Import, generate and build the example project.
2. Connect the RA board USB debug port to the host PC using the appropriate USB cable for EP programming and debugging.
...
![banner_ep_info](images/banner_ep_info_log.jpg "Banner with the EP information")
...
**POEG Output Disable On Input Pin Trigger**

![output_disable_on_input_pin_trigger](images/output_disable_on_input_pin_trigger_log.jpg "Output Disable On Input Pin Trigger")
  
**POEG Output Disable On Software API**

![output_disable_on_software_api](images/output_disable_on_software_api_log.jpg "Output Disable On Software API")
  
**POEG Output Disable On GPT Output Level**

![output_disable_on_gpt_output_level](images/output_disable_on_gpt_output_level_log.jpg "Output Disable On GPT Output Level")
  
**POEG Output Disable On ACMPHS Events**

![output_disable_on_acmphs_events](images/output_disable_on_acmphs_events_log.jpg "Output Disable On ACMPHS Events")
  
**POEG Reset Channel 0**

![poeg_reset_channel0](images/poeg_reset_channel0_log.jpg "POEG Reset Channel0")

**POEG Reset Channel 1**

![poeg_reset_channel1](images/poeg_reset_channel1_log.jpg "POEG Reset Channel1")
