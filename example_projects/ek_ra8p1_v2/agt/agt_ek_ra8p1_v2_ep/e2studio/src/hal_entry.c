...
void hal_entry(void)
{
    ...
    /* Depend on the user selected clock source, raw counts value can be calculated
 ...
 * @param[in]   None.
 * @retval      FSP_SUCCESS     Upon successful status checking.
 * @retval      Any other error code apart from FSP_SUCCESS  Unsuccessful status checking.
 **********************************************************************************************************************/
static fsp_err_t timer_status_check(void)
{
    fsp_err_t err = FSP_SUCCESS;
