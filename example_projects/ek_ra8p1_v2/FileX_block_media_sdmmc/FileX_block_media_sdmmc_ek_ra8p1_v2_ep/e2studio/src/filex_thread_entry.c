...
void filex_thread_entry(void)
{
    ...
    g_set_time.date = (UINT) atoi(&read_time[4]);
    g_set_time.year = (UINT) atoi(&read_time[7]);
    g_set_time.hour = (UINT) atoi(&read_time[12]);
    g_set_time.min  = (UINT) atoi(&read_time[15]);
    g_set_time.sec  = (UINT) atoi(&read_time[18]);
