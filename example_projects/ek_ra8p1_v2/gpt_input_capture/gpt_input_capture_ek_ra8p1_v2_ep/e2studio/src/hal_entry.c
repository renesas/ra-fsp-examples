...
#define EP_INFO         "\r\nThe example project demonstrates the functionality of GPT input capture"\
                        "\r\nmodule. GPT3 is used to generate periodic pulses of 500 milliseconds duration"\
                        "\r\nand provided as input to GPT input capture (GPT5). GPT5 counts the event pulse"\
                        "\r\nreceived at its input. Based on the period and capture event, the time period"\
                        "\r\nof pulse is calculated and displayed on J-Link RTT Viewer.\r\n"
