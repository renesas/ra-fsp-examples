...
### Hardware ###
* Supported RA boards: CK-RA6M5, EK-RA2E2, EK-RA2L2, EK-RA4C1, EK-RA4E2, EK-RA4L1, EK-RA6E2, EK-RA8D2, EK-RA8E2, EK-RA8M2, EK-RA8P1, FPB-RA2T1, FPB-RA8E1, MCK-RA4T1, MCK-RA6T3, MCK-RA8T1, MCK-RA8T2, EK-RA8P1 V2.
...
| SCL9 P113 <br> (CN1:33)  | ---->  | SCL  ( J2 - Pin 1/5 )  |
...
| EK-RA4C1                 |        |    Pmod ACL   |
|:------------------------:|:------:|:-------------:|
| IRQ15 P513 <br> (J3:12)  | ---->  | INT1 ( J1 - Pin 8 )    |
| SCL1 P608 <br> (J2:37)   | ---->  | SCL  ( J2 - Pin 1/5 )  |
| SDA1 P115 <br> (J2:35)   | ---->  | SDA  ( J2 - Pin 2/6 )  |
...
| EK-RA8P1 V2              |        |    Pmod ACL   |
|:------------------------:|:------:|:-------------:|
| IRQ15 P012 <br> (J4:8)   | ---->  | INT1 ( J1 - Pin 8 )    |
| SCL0 P602 <br> (J17:11)  | ---->  | SCL  ( J2 - Pin 1/5 )  |
| SDA0 P603 <br> (J3:25)   | ---->  | SDA  ( J2 - Pin 2/6 )  |
|  GND pin  <br> (J4:21)   | ---->  | GND  ( J2 - Pin 3/7 )  |
|  VCC pin  <br> (J4:1)    | ---->  | VCC  ( J2 - Pin 4/8 )  |
...
* For the functioning of the SCI I2C Master:
  * SDA pin and SCL pin must configure output type as n-ch open drain.
  * SDA pin and SCL pin must be connected to external pull-up resistors.
  * The value of the external pull-up resistor depends on the I2C bus speed. In this EP, the I2C bus is configured at standard speed, so the recommended external pull-up resistor value is from 1k to 4.7k ohms.
