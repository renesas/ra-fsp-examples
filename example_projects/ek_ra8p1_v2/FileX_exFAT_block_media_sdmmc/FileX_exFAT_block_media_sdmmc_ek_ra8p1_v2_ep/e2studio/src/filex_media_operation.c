...
static rm_block_media_info_t g_block_media_info =
{
 .sector_size_bytes = RESET_VALUE,
 .num_sectors       = RESET_VALUE,
 .reentrant         = false,
...
UINT media_verify(void)
{
    ...
    {
        PRINT_INFO_STR(""CARD_TYPE" card not inserted, please insert "CARD_TYPE" card\r\n");
...
UINT media_get_property(void)
{
    ...
    /* Get the physical size of the SD/MicroSD card */
    ...
    /* Calculate the total physical size of the SD/MicroSD card */
...
/*******************************************************************************************************************//**
 * @brief       This function performs media closing.
 * @param[in]   None.
 * @retval      FX_SUCCESS   Upon successful operation.
 * @retval      Any other error code apart from FX_SUCCESS.
 **********************************************************************************************************************/
