...
3. Hardware Requirements:
	Supported RA boards: CK-RA6M5, EK-RA2A1, EK-RA2A2, EK-RA2E1, EK-RA2E2, EK-RA2L1, EK-RA4E2, EK-RA4M1, EK-RA4M2, 
	                     ...
	                     EK-RA4C1, MCK-RA8T2, EK-RA8D2, EK-RA8M2, EK-RA8P1 V2.
	...
	Some jumper wires used to connect the Pmod USBUART to the RA board.
...
4. Hardware Connections:
	...
	- Connect the Pmod USBUART to the RA board as shown below:
		...
		For EK-RA8P1 V2:
			...
			+-------+-------+-------+-------+-------+-------+-------+-------+-------+--------+
			RXD0 P602  (J17:11)	---> TXD Pin of Pmod USBUART (J2:3)
			TXD0 P603  (J3:25)	---> RXD Pin of Pmod USBUART (J2:2)
			Common GND (J2:27)	---> GND Pin of Pmod USBUART (J2:5)
...
1) For Serial terminal application:
   ...
   1.2) The configuration parameters of the serial port on the terminal application are as follows:
	Port: Virtual COM Port (Pmod USBUART)
	Speed: 115200
	Data: 8 bit
	Parity: none
	Stop bits: 1 bit
