...
|   configuration.xml -> g_adc0 ADC Driver on r_adc > Settings > Property > Module g_adc0 ADC Driver on R_ADC > Input > Channel Scan Mask  |   NULL  |   Channel 9, Channel 10  |   Configures Channel 9 and 10 for ADC 0 group A.   |
|   configuration.xml -> g_adc0 ADC Driver on r_adc > Settings > Property > Module g_adc0 ADC Driver on R_ADC > Input > Channel Scan Mask  |   NULL  |   Channel 19, Channel 20  |   Configures Channel 19 and 20 for ADC 0 group B.   |
...
![ADC_Periodic_output](images/ADC0_Unit_A_channel0_ra2e1.jpg "Waveform Rendering of ADC Unit 0, Group A, Channel 0 Output")

 ![ADC_Periodic_output](images/ADC0_UnitA_channel1_ra2e1.jpg "Waveform Rendering of ADC Unit 0, Group A, Channel 1 Output")


* ADC Unit 0 Group B channel 0 (g_buffer_adc[0][1][0]) and channel 1 (g_buffer_adc[0][1][1]):
![ADC_Periodic_output](images/ADC0_UnitB_channel0_ra2e1.jpg "Waveform Rendering of ADC Unit 0, Group B, Channel 0 Output")

 ![ADC_Periodic_output](images/ADC0_UnitB_channel1_ra2e1.jpg "Waveform Rendering of ADC Unit 0, Group B, Channel 1 Output")
