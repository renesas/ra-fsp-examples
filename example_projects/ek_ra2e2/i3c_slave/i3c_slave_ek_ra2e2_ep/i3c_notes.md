...
The sample code accompanying this file shows the operation of the I3C Driver on Renesas RA2E2 MCUs based on Renesas FSP.  
The I3C master on EK-RA2E2 demonstrates operations associated with an I3C slave running on another EK-RA2E2 board. Once initialization is successful,
...
### Hardware ###
* Renesas EK-RA2E2 kit - 2x
* USB A to USB Micro B Cable - 2x
* Jumper wires to link EK-RA2E2 kits - 5x
...
|-------------|-----------------------------------------------|-----------------------------------------------|
|I3C | Driver for the I3C peripheral to demonstrate Master and Slave mode on RA2E2 MCUs | i3c|
...
2. Download i3c_master EP to one EK-RA2E2 kit and run the project.
3. Download i3c_slave EP to another EK-RA2E2 kit and run the project.
