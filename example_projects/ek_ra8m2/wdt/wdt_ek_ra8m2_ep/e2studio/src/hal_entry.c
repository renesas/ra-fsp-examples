...
void hal_entry(void)
{
    ...
    || defined (BOARD_RA4C1_EK) || defined (BOARD_RA8M2_EK)
    APP_PRINT("\r\nOn pressing the push button SW1, the WDT counter stops from refreshing.");
...
#else
    APP_PRINT("\r\nOn pressing the push button S1, the WDT counter stops from refreshing.");
#endif
