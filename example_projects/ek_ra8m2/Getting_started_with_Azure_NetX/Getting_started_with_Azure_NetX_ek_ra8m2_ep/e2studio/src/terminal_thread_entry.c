 ...
 **********************************************************************************************************************/
/*******************************************************************************************************************//**
 * @brief     This function initializes the terminal communication, starts the network link thread, and
...
/*******************************************************************************************************************//**
 * @brief     This function checks if there is any data input from the terminal, reads it,
 *            and sends it to the input queue.
 * @param[in] None.
...
/*******************************************************************************************************************//**
 * @brief     This function retrieves messages from the output queue and prints them to the terminal. It handles
        ...
        if (TX_SUCCESS == status)
        {
            switch (p_term_msg->id)
            {
                case TERMINAL_OUTPUT_EP_BANNER:
                {
                    ...
                    TERM_PRINTF(BANNER_INFO, EP_VERSION, version.version_id_b.major, version.version_id_b.minor,
                ...
                case TERMINAL_OUTPUT_DNS_HOST_ADDR:
                {
                    ...
                    TERM_PRINTF("\r\nThe Host IPv4 Address: %d.%d.%d.%d", ip.block.a,\
                                ip.block.b, ip.block.c, ip.block.d);
                    break;
                }
