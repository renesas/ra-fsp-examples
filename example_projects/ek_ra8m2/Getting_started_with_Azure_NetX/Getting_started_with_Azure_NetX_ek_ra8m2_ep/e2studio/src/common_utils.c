...
/*******************************************************************************************************************//**
 * @brief      This function waits until the terminal framework is initialized before sending data to it.
 * @retval     None.
 **********************************************************************************************************************/
...
/*******************************************************************************************************************//**
 * @brief      This function initializes the terminal framework by creating necessary queues and memory pools.
...
/*******************************************************************************************************************//**
 * @brief      This function receives and converts data from the input queue into a character buffer.
...
/*******************************************************************************************************************//**
 * @brief      This function receives and converts data from the output queue.
 *             To be called by the User/Application Thread.
...
/*******************************************************************************************************************//**
 * @brief      This function sends data to the terminal input queue and
...
/*******************************************************************************************************************//**
 * @brief     This function sends data to the terminal output queue and
 *            allocates memory for the message and queues it for transmission.
 * @param[in] id        Message ID.
 * @param[in] p_data    Pointer to the data buffer to be sent.
 * @param[in] size      Size of the data to be sent.
