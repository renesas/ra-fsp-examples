...
/*******************************************************************************************************************//**
 * @brief      This function initializes the terminal module, prepares necessary resources, and enters a loop to
 *             process terminal input and output.
...
/*******************************************************************************************************************//**
 * @brief      Handles terminal output by retrieving messages from the output queue, processing them,
