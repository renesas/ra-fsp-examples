...
5) If USB is removed without using "safely_eject" option, the user is recommended to re-insert USB, perform
   "safely_eject" and "initialise USB" commands in sequence. This will make sure no USB operations fail after
   unexpected removal of USB.
