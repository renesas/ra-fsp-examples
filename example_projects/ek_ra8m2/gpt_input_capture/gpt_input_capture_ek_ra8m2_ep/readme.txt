...
1. Project Overview:
	The EP demonstrates the functionality of GPT Input capture module. GPT5 is used to generate periodic pulses
	of 500msec duration and provided as input to GPT Input capture (GPT3). GPT3 counts the event pulse received
...
3. Hardware Connections:
	...
	For MCK-RA8T2:
		Connect P203 (CN3:29) <--> P300 (CN2:14)
