...
#define EP_INFO    "\r\nThis EP demonstrates IIC Slave operation using two I2C channels. It performs"\
                   "\r\nSlave read and write operations continuously once initialization is successful."\
                   "\r\nOn successful I2C transaction (6 bytes), the transmitted and received data are"\
                   "\r\ncompared. LEDs blink sequentially when the data matches; otherwise, they are"\
                   "\r\nturned ON as a sign of failure. For both cases, a corresponding Slave operation"\
                   "\r\nmessage is displayed on RTT Viewer. Any API/event failure message is also displayed.\r\n\r\n"
