...
#elif defined (BOARD_RA4L1_EK) || defined (BOARD_RA8P1_EK) || defined (BOARD_RA4C1_EK) ||\
      defined (BOARD_RA8T2_MCK) || defined (BOARD_RA8M2_EK)
...
void transfer_led_blink_operation(void)
{
    ...
    APP_PRINT("\r\nDMAC g_transfer_led_blink transfer in progress. Wait for 6 seconds\r\n");
...
void transfer_write_ioport_operation(void)
{
     ...
     * DMAC g_transfer_write_ioport is configured to transfer in repeat mode,
     * from g_source_data to the IOPORT PCNTR1 register.
     * This is similar to DMAC g_transfer_led_blink, however
     * g_transfer_led_blink was triggered by a peripheral interrupt (AGT0).
     * Here, g_transfer_write_ioport is configured for software activation. */
