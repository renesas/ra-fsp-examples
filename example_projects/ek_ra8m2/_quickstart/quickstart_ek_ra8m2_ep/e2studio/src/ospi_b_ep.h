 ...
 * Version      : 1.0
 * Description  : Contains Macro defintions and function interface used in ospi_ep.c.
 **********************************************************************************************************************/
/**********************************************************************************************************************
...
/* Calculate the application address for the specified sector number.
   Cast to uint8_t* ensures the result is treated as a byte pointer for memory access. */
...
extern fsp_err_t ospi_b_init (void);
extern fsp_err_t ospi_b_set_protocol_to_spi (void);
extern fsp_err_t ospi_b_set_protocol_to_opi (void);
extern fsp_err_t ospi_b_operation (uint8_t * p_address);
