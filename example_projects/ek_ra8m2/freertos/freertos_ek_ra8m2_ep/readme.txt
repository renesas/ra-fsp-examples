...
1. Project Overview:
	...
	Task, and the GPT msgq (Message Queue) ISR. The Receiver Task pends on Message Queue, receives messages, and
	displays them on RTT Viewer every 500 milliseconds. For the next few seconds, the Semaphore Task waits for a
