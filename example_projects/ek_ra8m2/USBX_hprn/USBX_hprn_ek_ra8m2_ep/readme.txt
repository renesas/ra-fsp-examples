...
3. Hardware Connections:
	...
	For EK-RA8P1, EK-RA8M2 (High Speed):
		1. For EK-RA8M2: The user must place jumper J6 on pins 2-3, J8 on pins 1-2, J9 on pins 2-3, and J29
		                 on pins 1-2, 3-4, 5-6, 7-8 to use the on-board debug functionality.
		2. Connect debug port of the RA MCU board to the Host PC using a Type-C USB cable.
		3. Connect the Type-C USB end of the Type-C USB device cable to Type-C USB High Speed
