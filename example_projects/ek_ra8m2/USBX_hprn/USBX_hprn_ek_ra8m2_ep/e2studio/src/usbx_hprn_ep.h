...
#define EP_INFO        "\r\nThis project demonstrates the basic functionality of USBX Host Printer driver"\
                       "\r\non Renesas RA MCUs based on Renesas FSP using Azure RTOS. An RA MCU board will"\
                       "\r\nbe connected to the PC where the RA board will act as a host device and the printer"\
                       "\r\nwill act as a peripheral device. A print command for a test page will be sent from"\
                       "\r\nthe RA board, and printing data will be transferred from the host device to the printer."\
                       "\r\nPrinter information and error messages will be displayed on J-Link RTT Viewer.\r\n"
