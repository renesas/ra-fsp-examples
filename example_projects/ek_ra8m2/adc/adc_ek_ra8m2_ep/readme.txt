...
1. Project Overview:
	...
	limit, it triggers an event and notifies the user to act accordingly. Result and ADC status are displayed on
	the J-Link RTT Viewer.

	Note:
	      FPB-RA0E1, FPB-RA0E2, FPB-RA0L1 do not support Window Compare Mode and operate with One-shot or
	      Sequential mode.
...
2. Hardware Requirements:
	Supported RA boards: EK-RA2A1, EK-RA2E1, EK-RA2E2, EK-RA2L1, EK-RA4E2, EK-RA4M1, EK-RA4M2, EK-RA4M3, EK-RA4W1,
	                     ...
	                     EK-RA8P1, FPB-RA2T1, EK-RA4C1, FPB-RA0L1, MCK-RA8T2, EK-RA8M2
...
3) For GCC ARM Embedded Toolchain: To enable printing floats to the RTT Viewer, edit the project settings and ensure
