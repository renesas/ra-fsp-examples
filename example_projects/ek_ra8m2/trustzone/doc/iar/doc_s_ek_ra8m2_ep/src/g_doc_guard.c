...
BSP_CMSE_NONSECURE_ENTRY fsp_err_t g_doc_callback_set_guard(doc_ctrl_t *const p_api_ctrl,
        void(*p_callback)(doc_callback_args_t*), void *const p_context, doc_callback_args_t *const p_callback_memory)
{
    /* Verify all pointers are in non-secure memory */
    void(*p_callback_checked)(
            doc_callback_args_t*) = (void(*)(doc_callback_args_t *)) cmse_check_address_range((void *) p_callback,\
