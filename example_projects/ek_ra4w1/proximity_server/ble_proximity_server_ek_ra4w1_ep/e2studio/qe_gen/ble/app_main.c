...
*******************************************************************************/
/* GAP Service UUID */
static uint8_t GAPC_UUID[] = { 0x7e, 0x76, 0x10, 0x96, 0xd6, 0x87, 0x39, 0x99, 0xe1, 0x4e, 0x11, 0x13, 0x62, 0x34, 0xf0, 0x27 };
...
static uint8_t gs_advertising_data[] =
{
    ...
    0x09, /**< Data Size */
    0x03, /**< Data Type */
    0x03, 0x18, 0x04, 0x18, 0x01, 0x18, 0x02, 0x18, /**< Data Value */

    /* Complete Local Name */
    0x0A, /**< Data Size */
    0x09, /**< Data Type */
    0x52, 0x41, 0x34, 0x57, 0x31, 0x5f, 0x53, 0x52, 0x56, /**< Data Value */
...
/* Start user code for GATT Server callback function event process. Do not edit comment generated here */
        ...
        case BLE_GATTS_EVENT_DISCONN_IND:
        {
            ...
            /* LED1 turn off and the messages will be printed on disconnection */
...
/*Add*/    FSP_PARAMETER_NOT_USED(*p_data);
/*Add*/    FSP_PARAMETER_NOT_USED(result);
...
/* Start user code for Link Loss Service Server callback function event process. Do not edit comment generated here */
    ...
    case BLE_LLS_EVENT_ALERT_LEVEL_WRITE_REQ:
    {
          ...
          if( p_data_enter != NULL)
            {
              app_value = *p_data_enter;
              APP_PRINT("\nBLE_LLS_EVENT_ALERT_LEVEL_WRITE_REQ is: %d", app_value);
              e_ble_lls_alert_level_level_t lls_alert_level = app_value;

                switch(lls_alert_level)
                {
                    case BLE_LLS_ALERT_LEVEL_LEVEL_NO_ALERT:          /*BLE_LLS_ALERT_LEVEL_LEVEL_NO_ALERT */
                    {
                        /* Messages will be printed on RTT Viewer */
                    ...
                    case BLE_LLS_ALERT_LEVEL_LEVEL_MILD_ALERT:        /* BLE_LLS_ALERT_LEVEL_LEVEL_MILD_ALERT */
                    {
                        /* Messages will be printed on RTT Viewer */
                    ...
                    case BLE_LLS_ALERT_LEVEL_LEVEL_HIGH_ALERT:         /* BLE_LLS_ALERT_LEVEL_LEVEL_HIGH_ALERT */
                    {
                        /* Messages will be printed on RTT Viewer */
      ...
      case BLE_LLS_EVENT_ALERT_LEVEL_READ_REQ:
      {
          ...
          if( p_data_enter != NULL)
          {
              /* Failed message will be print on RTT Viewer */
              app_value = *p_data_enter;
              APP_PRINT("\nBLE_LLS_EVENT_ALERT_LEVEL_READ_REQ Failed %d\n", app_value);
          }
...
/* Start user code for Link Loss Service Server callback function closing process. Do not edit comment generated here */
/* End user code. Do not edit comment generated here */
}
...
/* End user code. Do not edit comment generated here */
    ...
    /* Initialize VS call back */
    status = R_BLE_VS_Init(vs_cb);
    if(BLE_SUCCESS != status)
    {
        return BLE_ERR_INVALID_OPERATION;
    }
