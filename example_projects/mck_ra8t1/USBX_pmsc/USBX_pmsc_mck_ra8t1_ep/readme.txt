...
2. Hardware Requirements:
    ...
    2x USB A to USB Micro B Cable or 2x USB A to USB Type C Cable (For MCK-RA8T1).(One for onboard debugger and other for USB MSC connection)
...
3. Hardware Connections:
	...
	*Note: User must turn-off SW1-6 to use USBHS.
    ...
    Full Speed:(For MCK-RA8T1 boards)
        - Jumper jp9: Connect pins 2-3
        - Connect Jumper jp10 pins
        - Connect the type C USB end of the type C USB device cable to type C USB Full Speed 
	  port (CN14) of the board.  Connect the other end of this cable to USB port of the host PC.
        - Connect the type C USB end of the type C USB device cable to type C USB (DEBUG USB) 
