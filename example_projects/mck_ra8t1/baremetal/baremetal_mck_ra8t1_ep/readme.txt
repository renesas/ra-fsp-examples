...
1. Project Overview:
    ...
    LED1 is turned ON if there is an expected error encountered during operation.
    LED2 is turned ON only while program control waits for the User Defined ISR to execute.
    LED3 is turned ON only to indicate the successful conclusion of application execution.
