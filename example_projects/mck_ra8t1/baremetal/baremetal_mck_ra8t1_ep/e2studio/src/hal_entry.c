...
void hal_entry(void)
{
    ...
    APP_PRINT("\r\nLED2 is turned ON while program control waits for the User Defined ISR to execute.");
    APP_PRINT("\r\nLED3 is turned ON to indicate the successful conclusion of application execution.");
