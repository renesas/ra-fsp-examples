...
Configuration changes to switch Bus Width in configurator: (Same for EK-RA6M1, EK-RA6M2, EK-RA6M3, EK-RA6M3G, EK-RA6M4, EK-RA8M1 and EK-RA8D1 boards)
...
1. Regarding the power supply pin: By default, Users can use PMOD SD Pin5(GND) and PMOD SD Pin6(VCC) as shown in the hardware connection, 
