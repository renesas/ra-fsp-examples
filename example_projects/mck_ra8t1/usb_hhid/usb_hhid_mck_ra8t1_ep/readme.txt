...
3. Hardware Connections:
    EK-RA6M5, EK-RA6M4, EK-RA4M3, EK-RA4M2, EK-RA6M3, EK-RA6M3G, EK-RA8M1, EK-RA8D1 & MCK-RA8T1 (Only supported on these boards & with Full Speed mode)
...
Note : 
1) User is requested to enter key from a to z, A to Z, 0 to 9 and any special character on keyboard.

2) Segger RTT block address may be needed to download and observe EP operation using a hex file with RTT-Viewer.
   RTT Block address for hex file committed in repository are as follows:
   a. e2studio: 0x22001148
