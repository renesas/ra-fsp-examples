...
2. Hardware Requirement:
	...
	1. RA MCU board
	2. 1 x Micro USB cable for programming and debugging or 1x Type C USB cable (For MCK-RA8T1)
	3. 1 x Micro USB-OTG cable for connecting printer 1x Type C USB-OTG cable (For MCK-RA8T1)
...
3. Hardware Connections:
	...
	Supported Board (Full Speed)- MCK-RA8T1:	
	1.Connect DEBUG port of the RA MCU board to the Host PC using a type C USB cable.
	2.Connect the USB FullSpeed USB port of the RA MCU board to the Printer device using another type C USB cable.
