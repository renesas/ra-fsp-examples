...
#if !(defined (BOARD_RA6M5_EK) || defined (BOARD_RA6M4_EK) || defined(BOARD_RA4M3_EK)||defined(BOARD_RA4M2_EK)||defined(BOARD_RA6E1_FPB)||defined(BOARD_RA6T2_MCK)||defined(BOARD_RA4E1_FPB)||defined(BOARD_RA8D1_EK)||defined(BOARD_RA8M1_EK)||defined (BOARD_RA8T1_MCK)) //Not supported for this MCU
    /* Set Access window.
