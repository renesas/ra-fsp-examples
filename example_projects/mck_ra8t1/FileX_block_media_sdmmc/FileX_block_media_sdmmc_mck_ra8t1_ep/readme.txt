...
For EK-RA8M1
    1 Bit Width
       ...
       P811(CMD)(J57 Pin9) 	---> PMOD SD Pin2(MOSI)
       P812(DAT0)(J57 Pin17) 	---> PMOD SD Pin3(MISO)
       P810(CLK)(J57 Pin16) 	---> PMOD SD Pin4(SCLK)
       GND 			---> PMOD SD Pin5(GND)
       +3V3(VCC) 		---> PMOD SD Pin6(VCC)
       P503(CD)(J3 Pin35) 	---> PMOD SD Pin9(CD)
       P504(WP)(J3 Pin36) 	---> PMOD SD Pin10(WP)

    4 Bit Width
       Above mentioned connections for 1 Bit Width. In addition below connections

       P500(DAT1)(J57 Pin18) ---> PMOD SD Pin7(DAT1)
       P501(DAT2)(J57 Pin19) ---> PMOD SD Pin8(DAT2)
       P502(DAT3)(J57 Pin20) ---> PMOD SD Pin1(CS)
