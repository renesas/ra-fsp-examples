...
9. Convert the Certificate into a C Hex array, with command : **openssl.exe x509 -outform der -in GeoTrustRSACA2018.crt.pem -out GeoTrustRSACA2018.der; xxd -i GeoTrustRSACA2018.der > GeoTrustRSACA2018.crt.h**.
