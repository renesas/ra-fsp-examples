...
2. Hardware and Software Requirements:
    External Hardware : 
        ...
        External JLink Segger with 9 pin (19 pin for MCK-RA8T1) connector and USB Type B to connect JLink with PC.
...
3. Hardware settings for the project:
    ...
    For EK-RA2E2 LVD1 generates an interrupt when input Voltage raises above 2.9V.
    LVD0 resets the MCU when input Voltage drops below 2.51V.
    ...
    For MCK-RA8T1 board, LVD1 generates an interrupt when input Voltage raises above 3.08V.
    LVD0 resets the MCU when input Voltage drops below 2.85V.
...
2) For EK-RA2E2, FPB-RA2E3 boards, use external debugger for flashing the code, disconnect debugging mode,
