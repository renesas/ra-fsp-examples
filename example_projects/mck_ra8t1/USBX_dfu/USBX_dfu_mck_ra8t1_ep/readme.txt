...
4. Hardware Connections:
        ...
        Supported Board(Full Speed) - EK-RA6M3,EK-RA6M5,EK-RA6M1,EK-RA4M2,MCK-RA8T1.		
		...
		1. Jumper Settings:
			...
			a. Jumper JP9: Connect pins 2-3
			b. Connect jumper JP10 pins
		...
		2. Connect the micro USB end of the micro USB device cable to micro-AB USB Full Speed port of the board.
			...
			MCK-RA8T1: USB Full Speed port(CN14)
