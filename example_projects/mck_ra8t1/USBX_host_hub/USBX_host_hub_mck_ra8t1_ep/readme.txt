...
2. Supported Boards:
    EK-RA4M2, EK-RA4M3, EK-RA6M3, EK-RA6M4, EK-RA6M5, MCK-RA8T1

3. Hardware Requirements:
        1. 1 x RA MCU board
        2. 1 x Micro USB cable for programming and debugging or 1 x Type C USB cable (For MCK-RA8T1)
        3. 1 x Micro USB 2.0 OTG cable or 1 x Type C USB 2.0 OTG cable (For MCK-RA8T1)
        4. 1 x USB Hub
...
4. Hardware Connections:
    ...
    Note: - EP does not support high speed as USBX HHID does not support it.
          - Do not use this HP brand keyboard for testing (HP PN: 803181-001)

1) Segger RTT block address may needed to download and observe EP operation using a hex file with RTT-Viewer.
   RTT Block address for hex file committed in repository are as follows:
   a. e2studio: 0x22001320
