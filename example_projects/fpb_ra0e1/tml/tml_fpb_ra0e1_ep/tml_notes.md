...
* For using the Serial Terminal (UART): Terminal Console Application (Tera Term or a similar application)
* For using the SEGGER J-Link RTT Viewer: SEGGER J-Link® RTT Viewer: Version 7.96a
