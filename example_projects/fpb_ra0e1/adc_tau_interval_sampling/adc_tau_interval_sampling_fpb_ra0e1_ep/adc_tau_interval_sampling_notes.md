...
![adc_tau_smapling](images/adc_tau_high_level.jpg "ADC TAU Sampling Block Diagram") 
...
Below images showcases the output on waveform rendering of ADC for each channel of group:
