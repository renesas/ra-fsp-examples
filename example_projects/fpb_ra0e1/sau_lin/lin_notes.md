...
In this example, there are key differences between SCI LIN, SCI B LIN and SAU LIN simplementations:

- **ID Filtering:**  
  This feature is supported only on **SCI LIN and SCI B LIN**. ID filtering, applicable only to LIN Slave devices, enables the system to accept or reject LIN messages based on their frame identifier (ID), thereby optimizing message processing and reducing unnecessary load on the Slave node.
...
| Module name | Supported RA boards                                                                          |
|-------------|----------------------------------------------------------------------------------------------|
| SAU LIN     | FPB-RA0E2, FPB-RA0E1                                                                         |
| SCI B LIN   | EK-RA8M1, EK-RA8D1, EK-RA8D2, EK-RA8E2, EK-RA8M2, FPB-RA8E1, MCK-RA6T2, MCK-RA8T1, MCK-RA8T2 |
| SCI LIN     | EK-RA4C1, EK-RA4L1                                                                           |

- 2 × RA boards.
- 2 × USB cables for programming and debugging (USB cable type varies by board model).
- 2 × LIN transceivers.
  - Link Product: <https://www.mikroe.com/lin-click>
    - Manufacturer Product Number: MIKROE-3816
- 1 × 12V DC Power Supply.
- 3 × cables for LIN bus connection.
...
| Board    | Pin Name | Pin Number        |
|----------|----------|-------------------|
| EK-RA4C1 | RX_PIN   | P401 (J1, Pin 4)  |
|          | TX_PIN   | P400 (J1, Pin 3)  |
|          | P3V3     | VCC  (J1, Pin 1)  |
|          | GND      | VSS  (J1, pin 25) |

**Note**: For EK-RA4C1, the user must place jumper J6 on pins 2-3, J8 on pins 1-2, J9 on pins 2-3 and turn OFF SW4-4 to use the on-board debug functionality.

| Board    | Pin Name | Pin Number        |
|----------|----------|-------------------|
| EK-RA4L1 | RX_PIN   | P401 (J4, Pin 5)  |
|          | TX_PIN   | P400 (J4, Pin 6)  |
|          | P3V3     | VCC  (J4, Pin 1)  |
|          | GND      | VSS  (J4, Pin 25) |

| Board     | Pin Name | Pin Number        |
|-----------|----------|-------------------|
| FPB-RA0E1 | RX_PIN   | P110 (J2, Pin 19) |
|           | TX_PIN   | P109 (J2, Pin 18) |
|           | P3V3     | 3V3  (J3, Pin 4)  |
|           | GND      | GND  (J3, Pin 6)  |

| Board    | Pin Name | Pin Number         |
|----------|----------|--------------------|
| EK-RA8D1 | RX_PIN   | P610 (J55, Pin 3)  |
|          | TX_PIN   | P609 (J55, Pin 1)  |
|          | P3V3     | 3V3  (J55, Pin 2)  |
|          | GND      | GND  (J55, Pin 20) |

**Note**: For EK-RA8D1, user need to turn ON SW1-1 to use P609 and P610 in UART mode.
Please note that SW1‑7 must remain OFF when SW1‑1 is set to ON.

| Board    | Pin Name | Pin Number        |
|----------|----------|-------------------|
| EK-RA8D2 | RX_PIN   | P602 (J4, Pin 8)  |
|          | TX_PIN   | P603 (J4, Pin 4)  |
|          | P3V3     | 3V3  (J4, Pin 1)  |
|          | GND      | GND  (J4, Pin 19) |

| Board    | Pin Name | Pin Number         |
|----------|----------|--------------------|
| EK-RA8E2 | RX_PIN   | P610 (J14, Pin 9)  |
|          | TX_PIN   | P609 (J14, Pin 11) |
|          | P3V3     | 3V3  (J14, Pin 1)  |
|          | GND      | GND  (J14, Pin 26) |

| Board    | Pin Name | Pin Number        |
|----------|----------|-------------------|
| EK-RA8M2 | RX_PIN   | P602 (J3, Pin 40) |
|          | TX_PIN   | P603 (J37, Pin 3) |
|          | P3V3     | 3V3  (J3, Pin 1)  |
|          | GND      | GND  (J3, Pin 39) |

| Board     | Pin Name | Pin Number        |
|-----------|----------|-------------------|
| FPB-RA8E1 | RX_PIN   | P610 (J3, Pin 14) |
|           | TX_PIN   | P609 (J3, Pin 13) |
|           | P3V3     | 3V3  (J3, Pin 1)  |
|           | GND      | GND  (J3, Pin 20) |

| Board     | Pin Name | Pin Number         |
|-----------|----------|--------------------|
| MCK-RA6T2 | RX_PIN   | PA10 (CN6, Pin 3)  |
|           | TX_PIN   | PA09 (CN7, Pin 31) |
|           | P3V3     | VCC  (CN7, pin 23) |
|           | GND      | VSS  (CN7, pin 25) |

| Board     | Pin Name | Pin Number         |
|-----------|----------|--------------------|
| MCK-RA8T1 | RX_PIN   | P610 (CN4, Pin 27) |
|           | TX_PIN   | P609 (CN1, Pin 27) |
|           | P3V3     | VCC  (CN1, Pin 23) |
|           | GND      | VSS  (CN1, Pin 25) |

| Board     | Pin Name | Pin Number         |
|-----------|----------|--------------------|
| MCK-RA8T2 | RX_PIN   | P602 (CN1, Pin 31) |
|           | TX_PIN   | P603 (CN1, Pin 33) |
|           | P3V3     | 3V3  (CN1, Pin 23) |
|           | GND      | GND  (CN1, Pin 25) |
...
| Module Name | Usage                                                                                                | Searchable Keyword |
|-------------|------------------------------------------------------------------------------------------------------|--------------------|
| r_sci_lin   | The Simple LIN on SCI HAL module supports Local Interface Network (LIN) transactions in master mode. | r_sci_lin          |
| r_gpt       | The GPT module can be used to measure LIN transaction timing in master mode.                         | r_gpt              |

#### Slave mode ####
| Module Name | Usage                                                                                               | Searchable Keyword |
|-------------|-----------------------------------------------------------------------------------------------------|--------------------|
| r_sci_lin   | The Simple LIN on SCI HAL module supports Local Interface Network (LIN) transactions in slave mode. | r_sci_lin          |
...
### SCI LIN Configuration ###

#### Master Mode

| Module Property Path and Identifier                                                                                                                    | Default Value     | Used Value                   | Reason                                        |
|--------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------|------------------------------|-----------------------------------------------|
| `configuration.xml > Stacks > r_sci_lin > Properties > Settings > Property > Common > Auto Synchronization Support`                                    | Disabled          | Enabled                      | Enable the auto synchronization for LIN       |
| `configuration.xml > Stacks > r_sci_lin > Properties > Settings > Property > Module g_master LIN (r_sci_lin) > General > Mode`                         | Master            | Master                       | Select the LIN operating in master mode       |
| `configuration.xml > Stacks > r_sci_lin > Properties > Settings > Property > Module g_master LIN (r_sci_lin) > Baud > Baud Rate`                       | 19200             | 19200                        | Select the LIN baudrate                       |
| `configuration.xml > Stacks > r_sci_lin > Properties > Settings > Property > Module g_master LIN (r_sci_lin) > Interrupts > Callback`                  | sci_lin0_callback | lin_master_callback          | Set user-defined callback for SCI LIN module  |
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|--------------------|--------------------------------------------------------------------------------------------------------------------------------|
| `configuration.xml > Stacks > r_sci_lin > Properties > Settings > Property > Common > Auto Synchronization Support`                                                             | Disabled         | Enabled            | Enable the auto synchronization for LIN                                                                                        |
| `configuration.xml > Stacks > r_sci_lin > Properties > Settings > Property > Module g_slave LIN (r_sci_lin) > General > Mode`                                                   | Master           | Slave              | Select the LIN operating in slave mode                                                                                         |
| `configuration.xml > Stacks > r_sci_lin > Properties > Settings > Property > Module g_slave LIN (r_sci_lin) > Baud > Baud Rate`                                                 | 19200            | 19200              | Select the LIN baudrate                                                                                                        |
| `configuration.xml > Stacks > r_sci_lin > Properties > Settings > Property > Module g_slave LIN (r_sci_lin) > Framing > ID Filter (Slave Mode) > Compare Data Mask`             | 0                | 0xFF               | All bits of the received PID are considered during comparison                                                                  |
| `configuration.xml > Stacks > r_sci_lin > Properties > Settings > Property > Module g_slave LIN (r_sci_lin) > Framing > ID Filter (Slave Mode) > Priority Compare Data`         | 0                | 0x20               | Select the priority compare filter data                                                                                        |
| `configuration.xml > Stacks > r_sci_lin > Properties > Settings > Property > Module g_slave LIN (r_sci_lin) > Framing > ID Filter (Slave Mode) > Secondary Compare Data`        | 0                | 0x50               | Select the secondary compare filter data                                                                                       |
| `configuration.xml > Stacks > r_sci_lin > Properties > Settings > Property > Module g_slave LIN (r_sci_lin) > Framing > ID Filter (Slave Mode) > Compare Data Select`           | Priority         | Both               | Select the compare data to use                                                                                                 |
| `configuration.xml > Stacks > r_sci_lin > Properties > Settings > Property > Module g_slave LIN (r_sci_lin) > Framing > ID Filter (Slave Mode) > Priority Interrupt Bit Enable` | Disabled         | Enabled            | Enable the Priority Interrupt Bit filter                                                                                       |
| `configuration.xml > Stacks > r_sci_lin > Properties > Settings > Property > Module g_slave LIN (r_sci_lin) > Framing > ID Filter (Slave Mode) > Priority Interrupt Bit`        | 0                | 3                  | This is the bit position used for an additional check                                                                          |
| `configuration.xml > Stacks > r_sci_lin > Properties > Settings > Property > Module g_slave LIN (r_sci_lin) > Framing > Break Field Bits/Break Detection Threshold (bits)`      | 13               | 11                 | When configuring this setting in slave mode, take care to set the detection threshold less than the master break field length. |
| `configuration.xml > Stacks > r_sci_lin > Properties > Settings > Property > Module g_slave LIN (r_sci_lin) > Framing > LIN Timer Divider`                                      | 1                | 4                  | Set the LIN timer divider.                                                                                                     |
| `configuration.xml > Stacks > r_sci_lin > Properties > Settings > Property > Module g_slave LIN (r_sci_lin) > Interrupts > Callback`                                            | sci_lin_callback | lin_slave_callback | Set user-defined callback for SCI LIN module                                                                                   |

## API Usage ##
The table below lists the FSP provided API used at the application layer in this example project.

| #  | SAU LIN API Name             | SCI B LIN API Name             | SCI LIN API Name             | Usage in Approach                                               |
|----|------------------------------|--------------------------------|------------------------------|-----------------------------------------------------------------|
| 1  | R_SAU_LIN_Open               | R_SCI_B_LIN_Open               | R_SCI_LIN_Open               | Configure the LIN driver                                        |
| 2  | R_SAU_LIN_Close              | R_SCI_B_LIN_Close              | R_SCI_LIN_Close              | Close the LIN driver                                            |
| 3  | R_SAU_LIN_Write              | R_SCI_B_LIN_Write              | R_SCI_LIN_Write              | Begin non-blocking transmission of a LIN frame                  |
| 4  | R_SAU_LIN_Read               | R_SCI_B_LIN_Read               | R_SCI_LIN_Read               | Begin non-blocking reception of a LIN frame to receive LIN data |
| 5  | R_SAU_LIN_CommunicationAbort | R_SCI_B_LIN_CommunicationAbort | R_SCI_LIN_CommunicationAbort | Cancel in progress data read or write, or header read or write  |
| 6  | R_SAU_UART_BaudCalculate     | R_SCI_B_LIN_BaudCalculate      | R_SCI_LIN_BaudCalculate      | Calculate baud rate register settings                           |
| 7  | R_SAU_LIN_SleepEnter         | Not supported                  | Not supported                | Place the LIN node in bus sleep mode                            |
| 8  | R_SAU_LIN_SleepExit          | Not supported                  | Not supported                | Exit the bus sleep mode for LIN device                          |
| 9  | R_SAU_LIN_WakeupSend         | Not supported                  | Not supported                | Begin non-blocking transmission of the LIN wakeup signal        |
| 10 | R_LPM_LowPowerModeEnter      | Not used                       | Not used                     | Enter to LPM mode                                               |
| 11 | R_TAU_Open                   | R_GPT_Open                     | R_GPT_Open                   | Initialize the timer module                                     |
| 12 | R_TAU_Reset                  | R_GPT_Reset                    | R_GPT_Reset                  | Reset the counter value to the period minus one                 |
| 13 | R_TAU_PeriodSet              | R_GPT_PeriodSet                | R_GPT_PeriodSet              | Set period value provided                                       |
| 14 | R_TAU_InfoGet                | R_GPT_InfoGet                  | R_GPT_InfoGet                | Get timer information                                           |
| 15 | R_TAU_Start                  | R_GPT_Start                    | R_GPT_Start                  | Start timer                                                     |
| 16 | R_TAU_Stop                   | R_GPT_Stop                     | R_GPT_Stop                   | Stop timer                                                      |
| 17 | R_TAU_Close                  | R_GPT_Close                    | R_GPT_Close                  | Close timer module                                              |
...
The board supports J-Link OB VCOM: EK-RA8M1, FPB-RA0E2, EK-RA8D1, EK-RA8D2, EK-RA8E2, EK-RA8M2, FPB-RA8E1, MCK-RA8T1, MCK-RA8T2, FPB-RA0E1, EK-RA4C1, EK-RA4L1.
...
### ID Filter Configuration for SCI LIN EP
