...
[TWO] =
{
 ...
 .p_src = (void const*) &R_ADC1->ADDR[NINETEEN],
 .num_blocks = ZERO,
 .length = NUM_SAMPLES_PER_CHANNEL,
},
...
[THREE] =
{
 ...
 .p_src = (void const*) &R_ADC1->ADDR[TWENTY],
 .num_blocks = ZERO,
 .length = NUM_SAMPLES_PER_CHANNEL,
},
#endif
...
[TWO] =
{
 ...
 .p_src = (void const*) &R_ADC1->ADDR[TWENTY_ONE],
 .num_blocks = ZERO,
 .length = NUM_SAMPLES_PER_CHANNEL,
},
...
[THREE] =
{
 ...
 .p_src = (void const*) &R_ADC1->ADDR[TWENTY_TWO],
 .num_blocks = ZERO,
 .length = NUM_SAMPLES_PER_CHANNEL,
},
#endif
