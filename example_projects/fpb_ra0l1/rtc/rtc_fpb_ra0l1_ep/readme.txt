...
2) The user is expected to set RTC calendar Date and Time (option 1) before other operations.
...
5) As per the HW manual, the Year value ranges from 0 to 99, and the RTC supports a 100-year calendar
   from 2000 to 2099.
