...
2. Hardware Requirements:
	...
	1 x USB cable for programming and debugging.
		- Type-C USB cable: MCK-RA6T2, MCK-RA4T1, MCK-RA6T3, MCK-RA8T1, FPB-RA0E1, FPB-RA8E1, EK-RA4L1, FPB-RA0E2,
		                    EK-RA8E2, FPB-RA2T1, EK-RA8P1, EK-RA4C1, FPB-RA0L1
...
5. The hardware modifications required for measuring the MCU's current.
	...
	For EK-RA2L1, EK-RA2E1, EK-RA2E2, EK-RA4M2, EK-RA4M3, EK-RA6M3, EK-RA6M3G, EK-RA6M4, EK-RA4E2, EK-RA6E2, EK-RA6M5, EK-RA8M1, 
		EK-RA8D1, EK-RA4L1, EK-RA8E2, EK-RA8P1:
	...
	For FPB-RA2E3, FPB-RA2T1, EK-RA4C1:
		1) Measure the voltage drops across R3 and calculate MCU's current (Icc); replace R3 by a bigger resistor if needed.
...
6. Verifying Operation:
	1) Download the example project to the RA board using the USB debug port. J-Link may be disconnected when MCU enters LPM mode.
