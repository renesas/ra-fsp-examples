...
#define UART_INTERFACE  "Pmod USBUART"
#else
#define UART_INTERFACE  "J-Link OB VCOM"
#endif

#define EP_MESSAGE  "\r\nPlease open the Tera Term application on the PC and set up the serial connection to:"\
                    "\r\nThe COM port is facilitated by the "UART_INTERFACE", operating at a baud rate of %d bps,"\
...
#if defined(BOARD_RA4C1_EK)
#define UARTA_BAUD_ERROR_SCALING_1      (180)
#else
