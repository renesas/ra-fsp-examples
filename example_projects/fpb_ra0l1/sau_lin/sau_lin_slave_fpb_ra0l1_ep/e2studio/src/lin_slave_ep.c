...
#if BSP_PERIPHERAL_SAU_PRESENT
/***********************************************************************************************************************
 * @brief       This function puts the LIN slave into sleep mode and enters low-power mode.
 * @param[IN]   None.
...
/***********************************************************************************************************************
 * @brief       This function exits the bus sleep mode for LIN device.
 * @param[IN]   None.
 * @retval      FSP_SUCCESS if the operation was successful; otherwise, an error code is returned.
 **********************************************************************************************************************/
static fsp_err_t lin_slave_sleep_exit(void)
...
/***********************************************************************************************************************
 * @brief       This function closes all modules and performs error trapping if an error occurs.
