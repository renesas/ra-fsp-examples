...
#define MEASURE_PAYLOAD_SIZE    (0x03)       /* Number of bytes to enable measurement mode in Pmod ACL */
#define ACCELERO_DELAY          (0xC8)
#define SENSOR_READ_DELAY       (0x03)
#define ENABLE_BIT              (0x08)
#define DATA_REGISTERS          (0x06)

/* Internal accelerometer registers used in this application */
