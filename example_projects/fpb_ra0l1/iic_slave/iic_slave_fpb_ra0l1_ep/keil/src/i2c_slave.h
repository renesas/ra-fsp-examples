...
#define EP_INFO    "\r\nThis EP demonstrates IIC Slave operation using two I2C channels."\
                   "\r\nIt performs Slave read and write operations continuously once initialization"\
                   "\r\nis successful. On successful I2C transaction (6 bytes), the transmitted and"\
                   "\r\nreceived data are compared. LED blinks when data matches; otherwise, it is"\
                   "\r\nturned ON as sign of failure. For both cases, a corresponding Slave operation"\
