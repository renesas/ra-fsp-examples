 ...
 * @param[IN]   p_cfg          TAU instance configure structure.
 * @retval      FSP_SUCCESS    TAU instance opened successfully.
 * @retval      Any other error code apart from FSP_SUCCESS on unsuccessful opening of tau instance.
 ****************************************************************************************************************/
...
/*******************************************************************************************************************//**
 * @brief       This function closes TAU instance.
 * @param[IN]   p_ctrl_time     TAU control instance.
...
/*******************************************************************************************************************//**
 * @brief       This function starts TAU timer.
