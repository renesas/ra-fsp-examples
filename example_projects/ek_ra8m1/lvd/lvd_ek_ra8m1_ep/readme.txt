...
3. Hardware settings for the project:
    ...
    RA6M3-EK, RA6M3G-EK, EK-RA6M4, EK-RA4M3 and EK-RA6M5:
    ...
    For RA6M3-EK, RA6M3G-EK, RA6M4-EK, EK-RA4M3 and EK-RA6M5 boards, LVD1 generates an interrupt when input Voltage raises above 2.99V.
    LVD0 resets the MCU when input Voltage drops below 2.8V.
    ...
    For RA8M1-EK, LVD1 generates an interrupt when input Voltage raises above 3.08V.
