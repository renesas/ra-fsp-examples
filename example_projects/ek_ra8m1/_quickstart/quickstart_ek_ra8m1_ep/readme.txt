...
1. Project Overview:
        ...
        The project initializes the USB, ADC and GPIO modules to create a simple web server, web client with control 
        via a USB Comm Device class Terminal.
...
3. Hardware settings for the project:
        ...
        Link to access Quick Start Guide -  https://www.renesas.com/us/en/document/qsg/ek-ra8m1-quick-start-guide
