...
#elif (defined (BOARD_RA8D1_EK) || defined (BOARD_RA8M1_EK))

#define FLASH_HP_DF_BLOCK_0               (0x27000000U) /*   64 B:  0x40100000 - 0x4010003F */
#define FLASH_HP_DF_BLOCK_1               (0x27000040U) /*   64 B:  0x40100040 - 0x4010007F */
#define FLASH_HP_DF_BLOCK_2               (0x27000080U) /*   64 B:  0x40100080 - 0x401000BF */
#define FLASH_HP_DF_BLOCK_3               (0x270000C0U) /*   64 B:  0x401000C0 - 0x401000FF */
