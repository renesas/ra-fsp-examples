...
({                                                                                      \
    ...
    R_IOPORT_PinWrite(&g_ioport_ctrl, g_bsp_leds.p_leds[LED_GREEN], BSP_IO_LEVEL_LOW);  \
    R_IOPORT_PinWrite(&g_ioport_ctrl, g_bsp_leds.p_leds[LED_RED], BSP_IO_LEVEL_LOW);    \
    R_IOPORT_PinWrite(&g_ioport_ctrl, g_bsp_leds.p_leds[(x)], BSP_IO_LEVEL_HIGH);       \
})                                                                                      \
