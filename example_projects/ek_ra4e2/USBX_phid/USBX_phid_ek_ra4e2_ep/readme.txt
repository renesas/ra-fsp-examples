...
1. Project Overview:
	...
	the Host PC. Once the board is connected, user can provide any input from RTT Viewer to send character 
...
3. Hardware connection :
	...
	EK-RA6M3,EK-RA6M4,EK-RA6M5,EK-RA4M3,EK-RA4M2:(support only full speed)
	...
	EK-RA4E2: (support only full speed)
 	Connect the micro USB end of the micro USB cable to micro-AB USB Full Speed
	port (J11) of the board.  Connect the other end of this cable to USB port of the
	host PC. 
...
2. Lower case a - z and numbers 0 - 9 are sent from MCU to the host PC.﻿
1) Segger RTT block address may needed to download and observe EP operation using a hex file with RTT-Viewer.
   RTT Block address for hex file committed in repository are as follows:
   a. e2studio: 0x200009cc
