...
#else
	static volatile uint32_t *p_ioport_pnctrl_register = &R_PORT1->PCNTR1; // @suppress("Symbol is not resolved") // @suppress("Field cannot be resolved")
#endif

/* GPT counter register */
static volatile uint32_t *p_gpt_counter_register = &R_GPT0->GTCNT; // @suppress("Symbol is not resolved") // @suppress("Field cannot be resolved")
